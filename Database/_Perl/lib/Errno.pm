...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAETOOMANYREFS WSAEPFNOSUPPORT WSAEDESTADDRREQ WSAEDQUOT WSAEALREADY
	WSAENETDOWN WSAENOTSOCK WSAENAMETOOLONG WSAENOTEMPTY WSAENETUNREACH
	WSAEREFUSED WSAECONNREFUSED WSAEINVALIDPROVIDER WSAECONNRESET
	WSAEADDRINUSE WSAEPROTONOSUPPORT WSAEINTR WSAEADDRNOTAVAIL WSAEISCONN
	WSAENOBUFS WSAEMSGSIZE WSAECONNABORTED WSAEINPROGRESS
	WSAESOCKTNOSUPPORT WSAECANCELLED WSAESHUTDOWN WSAEWOULDBLOCK WSAEACCES
	WSAEFAULT WSAENOMORE WSAENOPROTOOPT WSAEREMOTE WSAELOOP WSAENETRESET
	WSAETIMEDOUT WSAEBADF WSAEINVALIDPROCTABLE WSAEHOSTUNREACH WSAEUSERS
	WSAENOTCONN WSAEPROVIDERFAILEDINIT WSAEAFNOSUPPORT WSAEPROCLIM
	WSAEPROTOTYPE WSAEMFILE WSAEDISCON WSAEHOSTDOWN WSAEOPNOTSUPP
	WSAEINVAL WSAESTALE
    )],
);
