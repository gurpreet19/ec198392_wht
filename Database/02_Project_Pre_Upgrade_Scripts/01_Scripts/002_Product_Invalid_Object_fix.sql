...
EXECUTE ec_generate.basicIUTriggers('STOR_FCST_LIFT_NOM');
execute EC_GENERATE.GENERATEPACKAGES('STOR_FCST_LIFT_NOM');
EXECUTE ec_generate.journalTriggers('STOR_FCST_LIFT_NOM');
