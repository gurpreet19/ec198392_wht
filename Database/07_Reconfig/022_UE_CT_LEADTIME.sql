create or replace PACKAGE UE_CT_LEADTIME IS
/****************************************************************
...
** 29-DEC-3017   wvic   Item_125159: Added function validateETA and validateETD
*****************************************************************/
...
FUNCTION calc_ETA_LT(p_storage_id VARCHAR2, p_parcel_no NUMBER, p_forecast_no VARCHAR2 DEFAULT NULL, p_type VARCHAR2 DEFAULT 'FCST') RETURN NUMBER;

FUNCTION calc_Combine_ETD_LT(p_storage_id VARCHAR2, p_parcel_no NUMBER, p_forecast_no VARCHAR2 DEFAULT NULL, p_cargo_no VARCHAR2 DEFAULT NULL, p_type VARCHAR2 DEFAULT 'FCST') RETURN DATE;

FUNCTION calc_Sched_Carrier_RTT(p_parcel_no NUMBER, p_forecast_no VARCHAR2 DEFAULT NULL) RETURN NUMBER;

FUNCTION getFirstNomDateTime(p_cargo_no NUMBER, p_forecast_id VARCHAR2 DEFAULT NULL) RETURN DATE;

FUNCTION getLastTimesheetEntry(p_cargo_no NUMBER, p_timeline_code VARCHAR2, p_product_id VARCHAR2) RETURN DATE;

FUNCTION convert_cargo_timeline(p_cargo_no NUMBER, p_timeline_code VARCHAR2, p_nom_date_time DATE DEFAULT NULL, p_primary_parcel NUMBER DEFAULT NULL) RETURN DATE;

FUNCTION convert_cargo_duration(p_cargo_no NUMBER, p_duration_code VARCHAR2, p_nom_date_time DATE DEFAULT NULL, p_primary_parcel NUMBER DEFAULT NULL) RETURN NUMBER;

--FUNCTION getPrimaryLifting(p_cargo_no NUMBER) RETURN NUMBER;
-- Item_125159: Begin
FUNCTION validateETA(p_storage_id VARCHAR2, p_parcel_no NUMBER, p_forecast_no VARCHAR2 DEFAULT NULL, p_type VARCHAR2 DEFAULT 'FCST') RETURN VARCHAR2;

FUNCTION validateETD(p_storage_id VARCHAR2, p_parcel_no NUMBER, p_forecast_no VARCHAR2 DEFAULT NULL, p_type VARCHAR2 DEFAULT 'FCST') RETURN VARCHAR2;
-- Item_125159: End
END UE_CT_LEADTIME;
/
...
*/
  ...
  IS
    ...
    IS
      ...
      AND REQUESTED_DATE = (SELECT MAX(REQUESTED_DATE) FROM STOR_FCST_LIFT_NOM WHERE CARGO_NO = p_cargo_no
      AND FORECAST_ID =  p_forecast_no);
    /*End Work Item 94809*/
