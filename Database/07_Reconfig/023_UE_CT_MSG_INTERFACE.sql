create or replace PACKAGE UE_CT_MSG_INTERFACE IS
/****************************************************************
** Package        :  UE_CT_MSG_INTERFACE, header part
**
...
** 24-JUL-2013    swgn  Added LoadProductionForecasts
** 07-Nov-2014	  tlxt  Added LoadDataFromCPP
** 16-OCT-2015	  tlxt  Added LoadCapForecasts
*****************************************************************/

-- Handles the call-back from the OIC workflows
PROCEDURE InformMessageStatus(p_message_id NUMBER, p_status VARCHAR2);

-- Routes various "Data Ready" messages to the appropriate locations
...
-- Creates a "Data Ready" message and drops it into the EC messaging system
...
-- Handles the loading of Capapacity forecast data
PROCEDURE LoadCapForecasts(p_datastage_code VARCHAR2);

-- Handles the loading of production forecast data
PROCEDURE LoadProductionForecasts(p_datastage_code VARCHAR2);

-- Handles the loading of Other production forecast data than ADP/SDS
...
-- Handles the MANUAL/Backup loading of production forecast data
...
-- Handles the MANUAL/Backup loading of production restriction forecast data
...
IS
    ...
    SELECT daytime, forecast_type, probability_type, UPG AS PROFIT_CENTRE_CODE,
           EcDp_Unit.ConvertValue(LNG_DENSITY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_DENSITY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_DENSITY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_DENSITY,
           EcDp_Unit.ConvertValue(COND_DENSITY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_DENSITY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_DENSITY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as COND_DENSITY,
           EcDp_Unit.ConvertValue(LNG_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_RATE','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_VOL_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_VOL_RATE,
           EcDp_Unit.ConvertValue(LNG_EXCESS_PROD, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_EXCESS_PROD','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_EXCESS_PROD','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_EXCESS_PROD,
           EcDp_Unit.ConvertValue(LNG_REGAS_REQ_LNG, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_REGAS_REQ_LNG','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_REGAS_REQ_LNG','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_REGAS_REQ_LNG,
           EcDp_Unit.ConvertValue(CONFIRMED_EXCESS_QTY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','CONFIRMED_EXCESS_QTY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','CONFIRMED_EXCESS_QTY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as CONFIRMED_EXCESS_QTY,
           EcDp_Unit.ConvertValue(LNG_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_HHV','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_HHV','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_HHV,
           EcDp_Unit.ConvertValue(LNG_MASS_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_MASS_RATE','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_MASS_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_MASS_RATE,
           EcDp_Unit.ConvertValue(LNG_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_MASS_SMPP,
           EcDp_Unit.ConvertValue(COND_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_RATE','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_VOL_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as COND_VOL_RATE,
           EcDp_Unit.ConvertValue(COND_MASS_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_MASS_RATE','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_MASS_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as COND_MASS_RATE,
           EcDp_Unit.ConvertValue(COND_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as COND_MASS_SMPP,
           EcDp_Unit.ConvertValue(DOMGAS_MASS, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_MASS','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_MASS_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_MASS_RATE,
           EcDp_Unit.ConvertValue(DOMGAS_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_ENERGY,
           EcDp_Unit.ConvertValue(DOMGAS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_SMPP,
            --Added Nomination attributes
            EcDp_Unit.ConvertValue(PLATFORM_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','PLATFORM_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','PLATFORM_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as PLATFORM_MASS_SMPP,
            EcDp_Unit.ConvertValue(DOMGAS_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_HHV','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_HHV','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_HHV,
            EcDp_Unit.ConvertValue(DOMGAS_MIN_RATE_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_MIN_RATE_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_MIN_RATE_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_MIN_RATE_ENERGY,
            EcDp_Unit.ConvertValue(DOMGAS_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_VOL_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_VOL_RATE,
            EcDp_Unit.ConvertValue(LNG_HHV_GJSM3, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_HHV_GJSM3','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_HHV_STD','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_HHV_STD,
            EcDp_Unit.ConvertValue(LNG_BL_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_BL_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_BL_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_BL_VOLUME,
            EcDp_Unit.ConvertValue(LNG_BL_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_BL_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_BL_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_BL_ENERGY,
            EcDp_Unit.ConvertValue(LNG_EXCESS_PROD_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_EXCESS_PROD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_EXCESS_PROD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_EXCESS_PROD_VOLUME,
            EcDp_Unit.ConvertValue(LNG_EXCESS_PROD_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_EXCESS_PROD_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_EXCESS_PROD_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_EXCESS_PROD_ENERGY,
            EcDp_Unit.ConvertValue(ADP_LNG_REQ_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','ADP_LNG_REQ_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','ADP_LNG_REQ_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as ADP_LNG_REQ_VOLUME,
            EcDp_Unit.ConvertValue(ADP_LNG_REQ_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','ADP_LNG_REQ_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','ADP_LNG_REQ_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as ADP_LNG_REQ_ENERGY,
            EcDp_Unit.ConvertValue(LNG_REGAS_REQ_GAS, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_REGAS_REQ_GAS','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_REGAS_REQ_GAS','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_REGAS_REQ_GAS,
            EcDp_Unit.ConvertValue(LNG_NET_RUNDOWN_CAP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_NET_RUNDOWN_CAP','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_NET_RUNDOWN_CAP','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_NET_RUNDOWN_CAP,
            EcDp_Unit.ConvertValue(LNG_REGAS_REQ_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_REGAS_REQ_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_REGAS_REQ_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_REGAS_REQ_ENERGY,
            WPT_GU_FACTOR_VOLUME,--EcDp_Unit.ConvertValue(WPT_GU_FACTOR_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','WPT_GU_FACTOR_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','WPT_GU_FACTOR_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as WPT_GU_FACTOR_VOLUME,
            WPT_GU_FACTOR_ENERGY,--EcDp_Unit.ConvertValue(WPT_GU_FACTOR_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','WPT_GU_FACTOR_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','WPT_GU_FACTOR_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as WPT_GU_FACTOR_ENERGY,
            DOMGAS_GU_FACTOR_VOLUME,--EcDp_Unit.ConvertValue(DOMGAS_GU_FACTOR_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_GU_FACTOR_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_GU_FACTOR_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_GU_FACTOR_VOLUME,
            DOMGAS_GU_FACTOR_ENERGY,--EcDp_Unit.ConvertValue(DOMGAS_GU_FACTOR_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_GU_FACTOR_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_GU_FACTOR_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_GU_FACTOR_ENERGY,
            TRAIN_GU_FACTOR_VOLUME,--EcDp_Unit.ConvertValue(TRAIN_GU_FACTOR_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','TRAIN_GU_FACTOR_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','TRAIN_GU_FACTOR_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as TRAIN_GU_FACTOR_VOLUME,
            TRAIN_GU_FACTOR_ENERGY,--EcDp_Unit.ConvertValue(TRAIN_GU_FACTOR_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','TRAIN_GU_FACTOR_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','TRAIN_GU_FACTOR_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as TRAIN_GU_FACTOR_ENERGY,
            EcDp_Unit.ConvertValue(CONFIRMED_EXCESS_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','CONFIRMED_EXCESS_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','CONFIRMED_EXCESS_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as CONFIRMED_EXCESS_VOLUME,
            EcDp_Unit.ConvertValue(CONFIRMED_EXCESS_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','CONFIRMED_EXCESS_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','CONFIRMED_EXCESS_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as CONFIRMED_EXCESS_ENERGY,
            EcDp_Unit.ConvertValue(REF_PROD_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','REF_PROD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','REF_PROD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as REF_PROD_VOLUME,
            EcDp_Unit.ConvertValue(REF_PROD_STD_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','REF_PROD_STD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','REF_PROD_STD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as REF_PROD_STD_VOLUME,
            EcDp_Unit.ConvertValue(REF_PROD_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','REF_PROD_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','REF_PROD_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as REF_PROD_ENERGY,
            EcDp_Unit.ConvertValue(FORECAST_FEED_N2, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','FORECAST_FEED_N2','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','FORECAST_FEED_N2','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as FORECAST_FEED_N2,
            EcDp_Unit.ConvertValue(FORECAST_FEED_CO2, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','FORECAST_FEED_CO2','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','FORECAST_FEED_CO2','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as FORECAST_FEED_CO2,
            EcDp_Unit.ConvertValue(AGRD_CAP_LNG_EXPORT, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','AGRD_CAP_LNG_EXPORT','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','AGRD_CAP_LNG_EXPORT','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as AGRD_CAP_LNG_EXPORT,
            EcDp_Unit.ConvertValue(WPT_NG_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','WPT_NG_HHV','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','WPT_NG_HHV','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as WPT_NG_HHV,
            EcDp_Unit.ConvertValue(TRAIN_NG_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','TRAIN_NG_HHV','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','TRAIN_NG_HHV','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as TRAIN_NG_HHV,
            EcDp_Unit.ConvertValue(DG_NG_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DG_NG_HHV','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DG_NG_HHV','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DG_NG_HHV,
            EcDp_Unit.ConvertValue(DOMGAS_REGAS, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_REGAS','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_REGAS','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_REGAS,
            EcDp_Unit.ConvertValue(IMBALANCE_ADJ_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','IMBALANCE_ADJ_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','IMBALANCE_ADJ_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as IMBALANCE_ADJ_VOLUME,
            EcDp_Unit.ConvertValue(IMBALANCE_ADJ_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','IMBALANCE_ADJ_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','IMBALANCE_ADJ_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as IMBALANCE_ADJ_ENERGY,
            EcDp_Unit.ConvertValue(UNMET_AMOUNT_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','UNMET_AMOUNT_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','UNMET_AMOUNT_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as UNMET_AMOUNT_VOLUME,
            EcDp_Unit.ConvertValue(UNMET_AMOUNT_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','UNMET_AMOUNT_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','UNMET_AMOUNT_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as UNMET_AMOUNT_ENERGY
            ...
            v_UPG_id := ECDP_OBJECTS.GETOBJIDFROMCODE('FIELD',v_UPG);
                IF v_UPG = 'ALL' THEN
                    ...
                    (
                        ...
                        EcDp_Unit.ConvertValue(LNG_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_RATE','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_VOL_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_RATE,
                        EcDp_Unit.ConvertValue(LNG_EXCESS_PROD, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_EXCESS_PROD','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_EXCESS_PROD','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_EXCESS_PROD,
                        EcDp_Unit.ConvertValue(LNG_REGAS_REQ_LNG, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_REGAS_REQ_LNG','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_REGAS_REQ_LNG','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_REGAS_REQ_LNG,
                        EcDp_Unit.ConvertValue(CONFIRMED_EXCESS_QTY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','CONFIRMED_EXCESS_QTY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','CONFIRMED_EXCESS_QTY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as CONFIRMED_EXCESS_QTY,
                        EcDp_Unit.ConvertValue(LNG_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_HHV','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_HHV','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_HHV,
                        ...
                        EcDp_Unit.ConvertValue(LNG_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_MASS_SMPP,
                        EcDp_Unit.ConvertValue(COND_DENSITY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_DENSITY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_DENSITY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as COND_DENSITY,
                        EcDp_Unit.ConvertValue(COND_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_RATE','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as COND_RATE,
                        EcDp_Unit.ConvertValue(COND_MASS_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_MASS_RATE','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_MASS_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as COND_MASS_RATE,
                        EcDp_Unit.ConvertValue(PLATFORM_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','PLATFORM_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','PLATFORM_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as PLATFORM_MASS_SMPP,
                        EcDp_Unit.ConvertValue(COND_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as COND_MASS_SMPP,
                        EcDp_Unit.ConvertValue(DOMGAS_MASS, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_MASS','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_MASS_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_MASS,
                        EcDp_Unit.ConvertValue(DOMGAS_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_ENERGY,
                        EcDp_Unit.ConvertValue(DOMGAS_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_HHV','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_HHV','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_HHV,
                        EcDp_Unit.ConvertValue(DOMGAS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_SMPP,
                        EcDp_Unit.ConvertValue(DOMGAS_MIN_RATE_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_MIN_RATE_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_MIN_RATE_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_MIN_RATE_ENERGY,
                        --EcDp_Unit.ConvertValue(DOMGAS_VOL, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_VOL','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_VOL')), DAYTIME) as DOMGAS_VOL,
                        EcDp_Unit.ConvertValue(LNG_HHV_GJSM3, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_HHV_GJSM3','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_HHV_STD','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_HHV_GJSM3,
                        EcDp_Unit.ConvertValue(DOMGAS_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_VOL_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_VOLUME,
                        EcDp_Unit.ConvertValue(LNG_BL_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_BL_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_BL_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_BL_VOLUME,
                        EcDp_Unit.ConvertValue(LNG_BL_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_BL_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_BL_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_BL_ENERGY,
                        EcDp_Unit.ConvertValue(LNG_EXCESS_PROD_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_EXCESS_PROD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_EXCESS_PROD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_EXCESS_PROD_VOLUME,
                        EcDp_Unit.ConvertValue(LNG_EXCESS_PROD_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_EXCESS_PROD_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_EXCESS_PROD_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_EXCESS_PROD_ENERGY,
                        ...
                        EcDp_Unit.ConvertValue(LNG_NET_RUNDOWN_CAP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_NET_RUNDOWN_CAP','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_NET_RUNDOWN_CAP','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_NET_RUNDOWN_CAP,
                        EcDp_Unit.ConvertValue(LNG_REGAS_REQ_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_REGAS_REQ_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_REGAS_REQ_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_REGAS_REQ_ENERGY,
                        WPT_GU_FACTOR_VOLUME,--EcDp_Unit.ConvertValue(WPT_GU_FACTOR_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','WPT_GU_FACTOR_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','WPT_GU_FACTOR_VOLUME')), DAYTIME) as WPT_GU_FACTOR_VOLUME,
                        WPT_GU_FACTOR_ENERGY,--EcDp_Unit.ConvertValue(WPT_GU_FACTOR_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','WPT_GU_FACTOR_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','WPT_GU_FACTOR_ENERGY')), DAYTIME) as WPT_GU_FACTOR_ENERGY,
                        DOMGAS_GU_FACTOR_VOLUME,--EcDp_Unit.ConvertValue(DOMGAS_GU_FACTOR_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_GU_FACTOR_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_GU_FACTOR_VOLUME')), DAYTIME) as DOMGAS_GU_FACTOR_VOLUME,
                        DOMGAS_GU_FACTOR_ENERGY,--EcDp_Unit.ConvertValue(DOMGAS_GU_FACTOR_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_GU_FACTOR_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_GU_FACTOR_ENERGY')), DAYTIME) as DOMGAS_GU_FACTOR_ENERGY,
                        TRAIN_GU_FACTOR_VOLUME,--EcDp_Unit.ConvertValue(TRAIN_GU_FACTOR_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','TRAIN_GU_FACTOR_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','TRAIN_GU_FACTOR_VOLUME')), DAYTIME) as TRAIN_GU_FACTOR_VOLUME,
                        TRAIN_GU_FACTOR_ENERGY,--EcDp_Unit.ConvertValue(TRAIN_GU_FACTOR_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','TRAIN_GU_FACTOR_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','TRAIN_GU_FACTOR_ENERGY')), DAYTIME) as TRAIN_GU_FACTOR_ENERGY,
                        EcDp_Unit.ConvertValue(CONFIRMED_EXCESS_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','CONFIRMED_EXCESS_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','CONFIRMED_EXCESS_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as CONFIRMED_EXCESS_VOLUME,
                        EcDp_Unit.ConvertValue(CONFIRMED_EXCESS_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','CONFIRMED_EXCESS_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','CONFIRMED_EXCESS_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as CONFIRMED_EXCESS_ENERGY,
                        EcDp_Unit.ConvertValue(REF_PROD_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','REF_PROD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','REF_PROD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as REF_PROD_VOLUME,
                        EcDp_Unit.ConvertValue(REF_PROD_STD_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','REF_PROD_STD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','REF_PROD_STD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as REF_PROD_STD_VOLUME,
                    ...
                    (
                        SELECT daytime, forecast_type, probability_type,UPG,DATA_STAGE_CODE,
                        EcDp_Unit.ConvertValue(COND_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_RATE','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_VOL_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as COND_RATE,
                        EcDp_Unit.ConvertValue(COND_DENSITY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_DENSITY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_DENSITY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as COND_DENSITY,
                        EcDp_Unit.ConvertValue(COND_MASS_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_MASS_RATE','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_MASS_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as COND_MASS_RATE,
                        --Added Nomination attributes
                        EcDp_Unit.ConvertValue(LNG_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_MASS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_MASS_SMPP,
                        ...
                        EcDp_Unit.ConvertValue(DOMGAS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_SMPP','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_SMPP,
                        EcDp_Unit.ConvertValue(DOMGAS_MIN_RATE_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_MIN_RATE_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_MIN_RATE_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_MIN_RATE_ENERGY,
                        --EcDp_Unit.ConvertValue(DOMGAS_VOL, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_VOL')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_VOL')), DAYTIME) as DOMGAS_VOL,
                        EcDp_Unit.ConvertValue(LNG_HHV_GJSM3, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_HHV_GJSM3','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_HHV_VOL_MTH','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_HHV_VOL_MTH,
                        EcDp_Unit.ConvertValue(DOMGAS_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_VOL_RATE','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as DOMGAS_VOLUME,
                        EcDp_Unit.ConvertValue(LNG_BL_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_BL_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_BL_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_BL_VOLUME,
                        EcDp_Unit.ConvertValue(LNG_BL_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_BL_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_BL_ENERGY','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_BL_ENERGY,
                        EcDp_Unit.ConvertValue(LNG_EXCESS_PROD_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_EXCESS_PROD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_EXCESS_PROD_VOLUME','UOM_CODE','VIEWLAYER',2500,'/')), DAYTIME) as LNG_EXCESS_PROD_VOLUME,
                    ...
                    (
                        ...
                        EcDp_Unit.ConvertValue(DOMGAS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_SMPP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_SMPP')), DAYTIME) as DOMGAS_SMPP,
                        EcDp_Unit.ConvertValue(DOMGAS_MASS, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_MASS')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_MASS_RATE')), DAYTIME) as DOMGAS_MASS,
                        EcDp_Unit.ConvertValue(DOMGAS_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_ENERGY')), DAYTIME) as DOMGAS_ENERGY,
                        EcDp_Unit.ConvertValue(DOMGAS_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_HHV')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_HHV')), DAYTIME) as DOMGAS_HHV,
                        EcDp_Unit.ConvertValue(DOMGAS_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_VOL_RATE')), DAYTIME) as DOMGAS_VOL_RATE,
                        DOMGAS_GU_FACTOR_VOLUME,--EcDp_Unit.ConvertValue(DOMGAS_GU_FACTOR_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_GU_FACTOR_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_GU_FACTOR_VOLUME')), DAYTIME) as DOMGAS_GU_FACTOR_VOLUME,
                        DOMGAS_GU_FACTOR_ENERGY,--EcDp_Unit.ConvertValue(DOMGAS_GU_FACTOR_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_GU_FACTOR_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_GU_FACTOR_ENERGY')), DAYTIME) as DOMGAS_GU_FACTOR_ENERGY,
                        EcDp_Unit.ConvertValue(REF_PROD_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','REF_PROD_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','REF_PROD_VOLUME')), DAYTIME) as REF_PROD_VOLUME,
                        EcDp_Unit.ConvertValue(REF_PROD_STD_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','REF_PROD_STD_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','REF_PROD_STD_VOLUME')), DAYTIME) as REF_PROD_STD_VOLUME,
                        EcDp_Unit.ConvertValue(REF_PROD_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','REF_PROD_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','REF_PROD_ENERGY')), DAYTIME) as REF_PROD_ENERGY,
                        EcDp_Unit.ConvertValue(DG_NG_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DG_NG_HHV')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DG_NG_HHV')), DAYTIME) as DG_NG_HHV,
                        EcDp_Unit.ConvertValue(DOMGAS_REGAS, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_REGAS')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_REGAS')), DAYTIME) as DOMGAS_REGAS
                        FROM TV_CT_STAGE_PROD_PC_FCST
                        WHERE data_stage_code = p_datastage_code
                        AND forecast_type = type_item.forecast_type
                        AND probability_type = type_item.probability_type
                    ...
                    (
                        SELECT daytime, forecast_type, probability_type,UPG,DATA_STAGE_CODE,
                        EcDp_Unit.ConvertValue(PLATFORM_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','PLATFORM_MASS_SMPP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','PLATFORM_MASS_SMPP')), DAYTIME) as PLATFORM_MASS_SMPP,
                        WPT_GU_FACTOR_VOLUME,--EcDp_Unit.ConvertValue(WPT_GU_FACTOR_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','WPT_GU_FACTOR_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','WPT_GU_FACTOR_VOLUME')), DAYTIME) as WPT_GU_FACTOR_VOLUME,
                        WPT_GU_FACTOR_ENERGY,--EcDp_Unit.ConvertValue(WPT_GU_FACTOR_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','WPT_GU_FACTOR_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','WPT_GU_FACTOR_ENERGY')), DAYTIME) as WPT_GU_FACTOR_ENERGY,
                        EcDp_Unit.ConvertValue(FORECAST_FEED_N2, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','FORECAST_FEED_N2')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','FORECAST_FEED_N2')), DAYTIME) as FORECAST_FEED_N2,
                        EcDp_Unit.ConvertValue(FORECAST_FEED_CO2, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','FORECAST_FEED_CO2')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','FORECAST_FEED_CO2')), DAYTIME) as FORECAST_FEED_CO2,
                        EcDp_Unit.ConvertValue(WPT_NG_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','WPT_NG_HHV')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','WPT_NG_HHV')), DAYTIME) as WPT_NG_HHV
                        FROM TV_CT_STAGE_PROD_PC_FCST
                        WHERE data_stage_code = p_datastage_code
                        AND forecast_type = type_item.forecast_type
                        AND probability_type = type_item.probability_type
                ...
                -- Merge LNG data into stream forecast BASE TABLE BY PC:
                    ...
                    (
                        SELECT daytime, forecast_type, probability_type,UPG,DATA_STAGE_CODE,
                        EcDp_Unit.ConvertValue(LNG_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_RATE')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_VOL_RATE')), DAYTIME) as LNG_RATE,
                        EcDp_Unit.ConvertValue(LNG_EXCESS_PROD, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_EXCESS_PROD')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_EXCESS_PROD')), DAYTIME) as LNG_EXCESS_PROD,
                        EcDp_Unit.ConvertValue(LNG_REGAS_REQ_LNG, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_REGAS_REQ_LNG')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_REGAS_REQ_LNG')), DAYTIME) as LNG_REGAS_REQ_LNG,
                        EcDp_Unit.ConvertValue(CONFIRMED_EXCESS_QTY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','CONFIRMED_EXCESS_QTY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','CONFIRMED_EXCESS_QTY')), DAYTIME) as CONFIRMED_EXCESS_QTY,
                        EcDp_Unit.ConvertValue(LNG_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_HHV')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_HHV')), DAYTIME) as LNG_HHV,
                        EcDp_Unit.ConvertValue(LNG_MASS_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_MASS_RATE')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_MASS_RATE')), DAYTIME) as LNG_MASS_RATE,
                        EcDp_Unit.ConvertValue(LNG_DENSITY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_DENSITY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_DENSITY')), DAYTIME) as LNG_DENSITY,
                        --Added Nomination attributes
                        EcDp_Unit.ConvertValue(LNG_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_MASS_SMPP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_MASS_SMPP')), DAYTIME) as LNG_MASS_SMPP,
                        EcDp_Unit.ConvertValue(COND_DENSITY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_DENSITY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_DENSITY')), DAYTIME) as COND_DENSITY,
                        EcDp_Unit.ConvertValue(COND_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_RATE')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_RATE')), DAYTIME) as COND_RATE,
                        EcDp_Unit.ConvertValue(COND_MASS_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_MASS_RATE')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_MASS_RATE')), DAYTIME) as COND_MASS_RATE,
                        EcDp_Unit.ConvertValue(PLATFORM_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','PLATFORM_MASS_SMPP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','PLATFORM_MASS_SMPP')), DAYTIME) as PLATFORM_MASS_SMPP,
                        EcDp_Unit.ConvertValue(COND_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_MASS_SMPP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_MASS_SMPP')), DAYTIME) as COND_MASS_SMPP,
                        EcDp_Unit.ConvertValue(DOMGAS_MASS, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_MASS')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_MASS_RATE')), DAYTIME) as DOMGAS_MASS,
                        EcDp_Unit.ConvertValue(DOMGAS_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_ENERGY')), DAYTIME) as DOMGAS_ENERGY,
                        EcDp_Unit.ConvertValue(DOMGAS_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_HHV')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_HHV')), DAYTIME) as DOMGAS_HHV,
                        EcDp_Unit.ConvertValue(DOMGAS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_SMPP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_SMPP')), DAYTIME) as DOMGAS_SMPP,
                        EcDp_Unit.ConvertValue(DOMGAS_MIN_RATE_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_MIN_RATE_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_MIN_RATE_ENERGY')), DAYTIME) as DOMGAS_MIN_RATE_ENERGY,
                        --EcDp_Unit.ConvertValue(DOMGAS_VOL, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_VOL')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_VOL')), DAYTIME) as DOMGAS_VOL,
                        EcDp_Unit.ConvertValue(LNG_HHV_GJSM3, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_HHV_GJSM3')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_HHV_STD')), DAYTIME) as LNG_HHV_GJSM3,
                        EcDp_Unit.ConvertValue(DOMGAS_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_VOL_RATE')), DAYTIME) as DOMGAS_VOLUME,
                        EcDp_Unit.ConvertValue(LNG_BL_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_BL_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_BL_VOLUME')), DAYTIME) as LNG_BL_VOLUME,
                        EcDp_Unit.ConvertValue(LNG_BL_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_BL_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_BL_ENERGY')), DAYTIME) as LNG_BL_ENERGY,
                        EcDp_Unit.ConvertValue(LNG_EXCESS_PROD_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_EXCESS_PROD_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_EXCESS_PROD_VOLUME')), DAYTIME) as LNG_EXCESS_PROD_VOLUME,
                        EcDp_Unit.ConvertValue(LNG_EXCESS_PROD_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_EXCESS_PROD_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_EXCESS_PROD_ENERGY')), DAYTIME) as LNG_EXCESS_PROD_ENERGY,
                        EcDp_Unit.ConvertValue(ADP_LNG_REQ_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','ADP_LNG_REQ_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','ADP_LNG_REQ_VOLUME')), DAYTIME) as ADP_LNG_REQ_VOLUME,
                        EcDp_Unit.ConvertValue(ADP_LNG_REQ_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','ADP_LNG_REQ_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','ADP_LNG_REQ_ENERGY')), DAYTIME) as ADP_LNG_REQ_ENERGY,
                        EcDp_Unit.ConvertValue(LNG_REGAS_REQ_GAS, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_REGAS_REQ_GAS')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_REGAS_REQ_GAS')), DAYTIME) as LNG_REGAS_REQ_GAS,
                        EcDp_Unit.ConvertValue(LNG_NET_RUNDOWN_CAP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_NET_RUNDOWN_CAP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_NET_RUNDOWN_CAP')), DAYTIME) as LNG_NET_RUNDOWN_CAP,
                        EcDp_Unit.ConvertValue(LNG_REGAS_REQ_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_REGAS_REQ_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_REGAS_REQ_ENERGY')), DAYTIME) as LNG_REGAS_REQ_ENERGY,
                        WPT_GU_FACTOR_VOLUME,--EcDp_Unit.ConvertValue(WPT_GU_FACTOR_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','WPT_GU_FACTOR_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','WPT_GU_FACTOR_VOLUME')), DAYTIME) as WPT_GU_FACTOR_VOLUME,
                        WPT_GU_FACTOR_ENERGY,--EcDp_Unit.ConvertValue(WPT_GU_FACTOR_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','WPT_GU_FACTOR_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','WPT_GU_FACTOR_ENERGY')), DAYTIME) as WPT_GU_FACTOR_ENERGY,
                        DOMGAS_GU_FACTOR_VOLUME,--EcDp_Unit.ConvertValue(DOMGAS_GU_FACTOR_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_GU_FACTOR_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_GU_FACTOR_VOLUME')), DAYTIME) as DOMGAS_GU_FACTOR_VOLUME,
                        DOMGAS_GU_FACTOR_ENERGY,--EcDp_Unit.ConvertValue(DOMGAS_GU_FACTOR_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_GU_FACTOR_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_GU_FACTOR_ENERGY')), DAYTIME) as DOMGAS_GU_FACTOR_ENERGY,
                        TRAIN_GU_FACTOR_VOLUME,--EcDp_Unit.ConvertValue(TRAIN_GU_FACTOR_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','TRAIN_GU_FACTOR_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','TRAIN_GU_FACTOR_VOLUME')), DAYTIME) as TRAIN_GU_FACTOR_VOLUME,
                        TRAIN_GU_FACTOR_ENERGY,--EcDp_Unit.ConvertValue(TRAIN_GU_FACTOR_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','TRAIN_GU_FACTOR_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','TRAIN_GU_FACTOR_ENERGY')), DAYTIME) as TRAIN_GU_FACTOR_ENERGY,
                        EcDp_Unit.ConvertValue(CONFIRMED_EXCESS_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','CONFIRMED_EXCESS_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','CONFIRMED_EXCESS_VOLUME')), DAYTIME) as CONFIRMED_EXCESS_VOLUME,
                        EcDp_Unit.ConvertValue(CONFIRMED_EXCESS_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','CONFIRMED_EXCESS_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','CONFIRMED_EXCESS_ENERGY')), DAYTIME) as CONFIRMED_EXCESS_ENERGY,
                        EcDp_Unit.ConvertValue(REF_PROD_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','REF_PROD_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','REF_PROD_VOLUME')), DAYTIME) as REF_PROD_VOLUME,
                        EcDp_Unit.ConvertValue(REF_PROD_STD_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','REF_PROD_STD_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','REF_PROD_STD_VOLUME')), DAYTIME) as REF_PROD_STD_VOLUME,
                        EcDp_Unit.ConvertValue(REF_PROD_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','REF_PROD_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','REF_PROD_ENERGY')), DAYTIME) as REF_PROD_ENERGY,
                        EcDp_Unit.ConvertValue(FORECAST_FEED_N2, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','FORECAST_FEED_N2')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','FORECAST_FEED_N2')), DAYTIME) as FORECAST_FEED_N2,
                        EcDp_Unit.ConvertValue(FORECAST_FEED_CO2, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','FORECAST_FEED_CO2')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','FORECAST_FEED_CO2')), DAYTIME) as FORECAST_FEED_CO2,
                        EcDp_Unit.ConvertValue(AGRD_CAP_LNG_EXPORT, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','AGRD_CAP_LNG_EXPORT')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','AGRD_CAP_LNG_EXPORT')), DAYTIME) as AGRD_CAP_LNG_EXPORT,
                        EcDp_Unit.ConvertValue(WPT_NG_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','WPT_NG_HHV')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','WPT_NG_HHV')), DAYTIME) as WPT_NG_HHV,
                        EcDp_Unit.ConvertValue(TRAIN_NG_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','TRAIN_NG_HHV')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','TRAIN_NG_HHV')), DAYTIME) as TRAIN_NG_HHV,
                        EcDp_Unit.ConvertValue(DG_NG_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DG_NG_HHV')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DG_NG_HHV')), DAYTIME) as DG_NG_HHV,
                        EcDp_Unit.ConvertValue(DOMGAS_REGAS, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_REGAS')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_REGAS')), DAYTIME) as DOMGAS_REGAS,
                        EcDp_Unit.ConvertValue(IMBALANCE_ADJ_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','IMBALANCE_ADJ_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','IMBALANCE_ADJ_VOLUME')), DAYTIME) as IMBALANCE_ADJ_VOLUME,
                        EcDp_Unit.ConvertValue(IMBALANCE_ADJ_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','IMBALANCE_ADJ_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','IMBALANCE_ADJ_ENERGY')), DAYTIME) as IMBALANCE_ADJ_ENERGY,
                        EcDp_Unit.ConvertValue(UNMET_AMOUNT_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','UNMET_AMOUNT_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','UNMET_AMOUNT_VOLUME')), DAYTIME) as UNMET_AMOUNT_VOLUME,
                        EcDp_Unit.ConvertValue(UNMET_AMOUNT_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','UNMET_AMOUNT_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','UNMET_AMOUNT_ENERGY')), DAYTIME) as UNMET_AMOUNT_ENERGY
                        FROM TV_CT_STAGE_PROD_PC_FCST
                        WHERE data_stage_code = p_datastage_code
                        AND forecast_type = type_item.forecast_type
                        AND probability_type = type_item.probability_type
                    ...
                    (
                        SELECT daytime, forecast_type, probability_type,UPG,DATA_STAGE_CODE,
                        EcDp_Unit.ConvertValue(COND_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_RATE')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_VOL_RATE')), DAYTIME) as COND_RATE,
                        EcDp_Unit.ConvertValue(COND_DENSITY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_DENSITY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_DENSITY')), DAYTIME) as COND_DENSITY,
                        EcDp_Unit.ConvertValue(COND_MASS_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_MASS_RATE')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_MASS_RATE')), DAYTIME) as COND_MASS_RATE,
                        --Added Nomination attributes
                        EcDp_Unit.ConvertValue(LNG_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_MASS_SMPP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_MASS_SMPP')), DAYTIME) as LNG_MASS_SMPP,
                        ...
                        EcDp_Unit.ConvertValue(DOMGAS_MIN_RATE_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_MIN_RATE_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_MIN_RATE_ENERGY')), DAYTIME) as DOMGAS_MIN_RATE_ENERGY,
                        --EcDp_Unit.ConvertValue(DOMGAS_VOL, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_VOL')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_VOL')), DAYTIME) as DOMGAS_VOL,
                        EcDp_Unit.ConvertValue(LNG_HHV_GJSM3, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_HHV_GJSM3')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_HHV_VOL_MTH')), DAYTIME) as LNG_HHV_VOL_MTH,
                        EcDp_Unit.ConvertValue(DOMGAS_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_VOL_RATE')), DAYTIME) as DOMGAS_VOLUME,
                        EcDp_Unit.ConvertValue(LNG_BL_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_BL_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_BL_VOLUME')), DAYTIME) as LNG_BL_VOLUME,
                        EcDp_Unit.ConvertValue(LNG_BL_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_BL_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_BL_ENERGY')), DAYTIME) as LNG_BL_ENERGY,
                        EcDp_Unit.ConvertValue(LNG_EXCESS_PROD_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_EXCESS_PROD_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_EXCESS_PROD_VOLUME')), DAYTIME) as LNG_EXCESS_PROD_VOLUME,
...
IS
    ...
    SELECT fcst_scen_no,FCST_DS_ID
    FROM dv_prod_forecast
    WHERE daytime = p_effective_daytime
    AND forecast_type = p_forecast_type
    AND scenario = p_scenario_type;

BEGIN

    FOR item IN get_forecast LOOP
        DELETE FROM dv_prod_stream_forecast WHERE fcst_scen_no = item.fcst_scen_no;
        DELETE FROM DV_CT_PROD_STRM_PC_FORECAST WHERE fcst_scen_no = item.fcst_scen_no;
    END LOOP;

    DELETE FROM dv_prod_forecast
    WHERE daytime = p_effective_daytime
    AND forecast_type = p_forecast_type
    AND scenario = p_scenario_type;
...
IS
    ...
    SELECT daytime, forecast_type, probability_type, UPG AS PROFIT_CENTRE_CODE,
        ...
        EcDp_Unit.ConvertValue(LNG_DENSITY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_DENSITY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_DENSITY')), DAYTIME) as LNG_DENSITY,
        EcDp_Unit.ConvertValue(COND_DENSITY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_DENSITY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_DENSITY')), DAYTIME) as COND_DENSITY,
        EcDp_Unit.ConvertValue(LNG_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_RATE')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_VOL_RATE')), DAYTIME) as LNG_VOL_RATE,
        EcDp_Unit.ConvertValue(LNG_EXCESS_PROD, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_EXCESS_PROD')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_EXCESS_PROD')), DAYTIME) as LNG_EXCESS_PROD,
        EcDp_Unit.ConvertValue(LNG_REGAS_REQ_LNG, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_REGAS_REQ_LNG')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_REGAS_REQ_LNG')), DAYTIME) as LNG_REGAS_REQ_LNG,
        EcDp_Unit.ConvertValue(CONFIRMED_EXCESS_QTY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','CONFIRMED_EXCESS_QTY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','CONFIRMED_EXCESS_QTY')), DAYTIME) as CONFIRMED_EXCESS_QTY,
        EcDp_Unit.ConvertValue(LNG_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_HHV')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_HHV')), DAYTIME) as LNG_HHV,
        EcDp_Unit.ConvertValue(LNG_HHV_GJSM3, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_HHV_GJSM3')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_HHV_STD')), DAYTIME) as LNG_HHV_STD,
        EcDp_Unit.ConvertValue(LNG_MASS_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_MASS_RATE')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_MASS_RATE')), DAYTIME) as LNG_MASS_RATE,
        EcDp_Unit.ConvertValue(LNG_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_MASS_SMPP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_MASS_SMPP')), DAYTIME) as LNG_MASS_SMPP,
        EcDp_Unit.ConvertValue(COND_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_RATE')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_VOL_RATE')), DAYTIME) as COND_VOL_RATE,
        EcDp_Unit.ConvertValue(COND_MASS_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_MASS_RATE')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_MASS_RATE')), DAYTIME) as COND_MASS_RATE,
        EcDp_Unit.ConvertValue(COND_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_MASS_SMPP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_MASS_SMPP')), DAYTIME) as COND_MASS_SMPP,
        EcDp_Unit.ConvertValue(DOMGAS_MASS, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_MASS')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_MASS_RATE')), DAYTIME) as DOMGAS_MASS_RATE,
        EcDp_Unit.ConvertValue(DOMGAS_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_ENERGY')), DAYTIME) as DOMGAS_ENERGY,
        EcDp_Unit.ConvertValue(DOMGAS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_SMPP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_SMPP')), DAYTIME) as DOMGAS_SMPP,
        EcDp_Unit.ConvertValue(DOMGAS_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_HHV')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_HHV')), DAYTIME) as DOMGAS_HHV,
        EcDp_Unit.ConvertValue(DOMGAS_MIN_RATE_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_MIN_RATE_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_MIN_RATE_ENERGY')), DAYTIME) as DOMGAS_MIN_RATE_ENERGY,
        EcDp_Unit.ConvertValue(DOMGAS_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_VOL_RATE')), DAYTIME) as DOMGAS_VOL_RATE,
        EcDp_Unit.ConvertValue(DOMGAS_REGAS, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_REGAS')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_REGAS')), DAYTIME) as DOMGAS_REGAS,
        ...
        IF type_item.forecast_type = 'SDS_PLAN' or type_item.forecast_type = 'ADP_PLAN' THEN
            ...
            v_UPG_id := ECDP_OBJECTS.GETOBJIDFROMCODE('FIELD',v_UPG);
                IF v_UPG = 'ALL' THEN
                    ...
                    (
                        SELECT daytime, forecast_type, probability_type,UPG,DATA_STAGE_CODE,
                        EcDp_Unit.ConvertValue(LNG_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_MASS_SMPP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_FORECAST','LNG_MASS_SMPP')), DAYTIME) as LNG_MASS_SMPP,
                        EcDp_Unit.ConvertValue(LNG_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_RATE')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_VOL_RATE')), DAYTIME) as LNG_VOL_RATE,
                        EcDp_Unit.ConvertValue(LNG_EXCESS_PROD, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_EXCESS_PROD')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_EXCESS_PROD')), DAYTIME) as LNG_EXCESS_PROD,
                        EcDp_Unit.ConvertValue(LNG_REGAS_REQ_LNG, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','LNG_REGAS_REQ_LNG')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','LNG_REGAS_REQ_LNG')), DAYTIME) as LNG_REGAS_REQ_LNG,
                        EcDp_Unit.ConvertValue(CONFIRMED_EXCESS_QTY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','CONFIRMED_EXCESS_QTY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','CONFIRMED_EXCESS_QTY')), DAYTIME) as CONFIRMED_EXCESS_QTY,
                    ...
                    (
                        SELECT daytime, forecast_type, probability_type,UPG,DATA_STAGE_CODE,
                        EcDp_Unit.ConvertValue(COND_MASS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_MASS_SMPP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_FORECAST','COND_MASS_SMPP')), DAYTIME) as COND_MASS_SMPP,
                        EcDp_Unit.ConvertValue(COND_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_RATE')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_VOL_RATE')), DAYTIME) as COND_VOL_RATE,
                        EcDp_Unit.ConvertValue(COND_DENSITY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_DENSITY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_DENSITY')), DAYTIME) as COND_DENSITY,
                        EcDp_Unit.ConvertValue(COND_MASS_RATE, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','COND_MASS_RATE')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','COND_MASS_RATE')), DAYTIME) as COND_MASS_RATE
                        FROM TV_CT_STAGE_PROD_PC_FCST
                    ...
                    (
                        SELECT daytime, forecast_type, probability_type,UPG,DATA_STAGE_CODE,
                        DOMGAS_MIN_RATE_ENERGY,
                        EcDp_Unit.ConvertValue(DOMGAS_SMPP, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_SMPP')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_FORECAST','DOMGAS_SMPP')), DAYTIME) as DOMGAS_SMPP,
                        EcDp_Unit.ConvertValue(DOMGAS_MASS, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_MASS')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_MASS_RATE')), DAYTIME) as DOMGAS_MASS,
                        EcDp_Unit.ConvertValue(DOMGAS_ENERGY, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_ENERGY')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_ENERGY')), DAYTIME) as DOMGAS_ENERGY,
                        EcDp_Unit.ConvertValue(DOMGAS_HHV, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_HHV')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_HHV')), DAYTIME) as DOMGAS_HHV,
                        EcDp_Unit.ConvertValue(DOMGAS_VOLUME, EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_STAGE_PROD_PC_FCST','DOMGAS_VOLUME')), EcDp_Unit.GetUnitFromLogical(ec_class_attr_property_cnfg.property_value('CT_PROD_STRM_PC_FORECAST','DOMGAS_VOL_RATE')), DAYTIME) as DOMGAS_VOL_RATE,
