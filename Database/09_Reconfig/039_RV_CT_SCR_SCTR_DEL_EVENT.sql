...
-- Generated by EcDp_GenClassCode 
 ...
 ,cntr_dp_event.DAYTIME AS DAYTIME
 ,cntr_dp_event.END_DATE AS END_DATE
 ,cntr_dp_event.EVENT_TYPE AS EVENT_TYPE
 ,cntr_dp_event.RECORD_STATUS
 ,cntr_dp_event.CREATED_BY
 ,cntr_dp_event.CREATED_DATE
 ,cntr_dp_event.LAST_UPDATED_BY
 ,cntr_dp_event.LAST_UPDATED_DATE
 ,cntr_dp_event.REV_NO
 ,cntr_dp_event.REV_TEXT
,cntr_dp_event.APPROVAL_STATE AS APPROVAL_STATE
,cntr_dp_event.APPROVAL_BY AS APPROVAL_BY
,cntr_dp_event.APPROVAL_DATE AS APPROVAL_DATE
,cntr_dp_event.REC_ID AS REC_ID
FROM CONTRACT_VERSION oa, CONTRACT o, cntr_dp_event
WHERE oa.object_id = cntr_dp_event.object_id
AND cntr_dp_event.object_id =   o.object_id
AND cntr_dp_event.DAYTIME >= oa.daytime
AND cntr_dp_event.DAYTIME < nvl(oa.end_date,cntr_dp_event.DAYTIME + 1)
AND o.sale_ind = 'Y' and EVENT_TYPE != 'RENOMINATION'
;
/