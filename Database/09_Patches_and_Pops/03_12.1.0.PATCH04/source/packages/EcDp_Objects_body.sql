...
BEGIN
  ...
  --
  OPEN cur FOR lv2_cursor_direct USING p_cascaded_class_name, p_cascaded_class_name, lv2_class_name, p_object_id, p_daytime, p_daytime, p_daytime, p_daytime;
  LOOP
  ...
  --
  OPEN cur FOR lv2_cursor_indirect USING p_cascaded_class_name, lv2_class_name, p_object_id, p_daytime, p_daytime, p_daytime, p_daytime;
  LOOP
...
IS
  ...
  lv2_cursor VARCHAR2(2000) := q'[
      ...
      AND    nvl(from_end_date, daytime + 1) <> daytime
  ]';
