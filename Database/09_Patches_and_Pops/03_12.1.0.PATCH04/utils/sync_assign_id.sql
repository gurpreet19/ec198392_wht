/* The following query can be used to create the procedure calls used in this file .
   The procedure calls in the current file are to be directly replaced by output of the query.
