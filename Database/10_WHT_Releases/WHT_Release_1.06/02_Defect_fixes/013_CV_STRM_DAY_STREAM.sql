SET LINESIZE 10000;
CREATE OR REPLACE VIEW "CV_STRM_DAY_STREAM" ("DAYTIME", "OBJECT_ID", "ON_STREAM_HRS", "BS_W", "GRS_LNG_MASS","GRS_LNG_MASS_MTD",
 "GRS_LNG_MASS_QTD", "GRS_LNG_MASS_YTD","GRS_LNG_VOL", "GRS_LNG_VOL_MTD", "GRS_LNG_VOL_QTD", "GRS_LNG_VOL_YTD","NET_LNG_MASS", 
 "NET_LNG_MASS_MTD", "NET_LNG_MASS_QTD", "NET_LNG_MASS_YTD","NET_LNG_VOL","NET_LNG_VOL_MTD","NET_LNG_VOL_QTD","NET_LNG_VOL_YTD",
 "GRS_CO2_VOL", "GRS_CO2_VOL_MTD", "GRS_CO2_VOL_QTD", "GRS_CO2_VOL_YTD", "NET_CO2_VOL", "NET_CO2_VOL_MTD", "NET_CO2_VOL_QTD",
 "NET_CO2_VOL_YTD", "GRS_CO2_MASS", "GRS_CO2_MASS_MTD", "GRS_CO2_MASS_QTD", "GRS_CO2_MASS_YTD", "NET_CO2_MASS",
 "NET_CO2_MASS_MTD", "NET_CO2_MASS_QTD", "NET_CO2_MASS_YTD", "CALC_CO2_DENS", "GRS_OIL_VOL", "GRS_OIL_VOL_MTD", 
 "GRS_OIL_VOL_QTD", "GRS_OIL_VOL_YTD", "NET_OIL_VOL", "NET_OIL_VOL_MTD", "NET_OIL_VOL_QTD", "NET_OIL_VOL_YTD",
 "GRS_OIL_MASS", "GRS_OIL_MASS_MTD", "GRS_OIL_MASS_QTD", "GRS_OIL_MASS_YTD", "NET_OIL_MASS", "NET_OIL_MASS_MTD", 
 "NET_OIL_MASS_QTD", "NET_OIL_MASS_YTD", "CALC_OIL_DENS", "GRS_GAS_VOL", "GRS_GAS_VOL_MTD", "GRS_GAS_VOL_QTD",
 "GRS_GAS_VOL_YTD", "NET_GAS_VOL", "NET_GAS_VOL_MTD", "NET_GAS_VOL_QTD", "NET_GAS_VOL_YTD", "GRS_GAS_MASS",
 "GRS_GAS_MASS_MTD", "GRS_GAS_MASS_QTD", "GRS_GAS_MASS_YTD", "NET_GAS_MASS", "NET_GAS_MASS_MTD", "NET_GAS_MASS_QTD",
 "NET_GAS_MASS_YTD", "CALC_GAS_DENS", "GRS_WATER_VOL", "GRS_WATER_VOL_MTD", "GRS_WATER_VOL_QTD", "GRS_WATER_VOL_YTD",
 "NET_WATER_VOL", "NET_WATER_VOL_MTD", "NET_WATER_VOL_QTD", "NET_WATER_VOL_YTD", "GRS_WATER_MASS", "GRS_WATER_MASS_MTD",
 "GRS_WATER_MASS_QTD", "GRS_WATER_MASS_YTD", "NET_WATER_MASS", "NET_WATER_MASS_MTD", "NET_WATER_MASS_QTD", "NET_WATER_MASS_YTD",
 "CALC_WATER_DENS", "GRS_COND_VOL", "GRS_COND_VOL_MTD", "GRS_COND_VOL_QTD", "GRS_COND_VOL_YTD", "NET_COND_VOL",
 "NET_COND_VOL_MTD", "NET_COND_VOL_QTD", "NET_COND_VOL_YTD", "GRS_COND_MASS", "GRS_COND_MASS_MTD", "GRS_COND_MASS_QTD",
 "GRS_COND_MASS_YTD", "NET_COND_MASS", "NET_COND_MASS_MTD", "NET_COND_MASS_QTD", "NET_COND_MASS_YTD", "CALC_COND_DENS",
 "GRS_NGL_VOL", "GRS_NGL_VOL_MTD", "GRS_NGL_VOL_QTD", "GRS_NGL_VOL_YTD", "NET_NGL_VOL", "NET_NGL_VOL_MTD", "NET_NGL_VOL_QTD",
 "NET_NGL_VOL_YTD", "GRS_NGL_MASS", "GRS_NGL_MASS_MTD", "GRS_NGL_MASS_QTD", "GRS_NGL_MASS_YTD", "NET_NGL_MASS",
 "NET_NGL_MASS_MTD", "NET_NGL_MASS_QTD", "NET_NGL_MASS_YTD", "CALC_NGL_DENS", "CALC_ENERGY", "CALC_ENERGY_MTD",
 "CALC_ENERGY_QTD", "CALC_ENERGY_YTD", "GRS_STEAM_VOL", "GRS_STEAM_VOL_MTD", "GRS_STEAM_VOL_QTD", "GRS_STEAM_VOL_YTD",
 "NET_STEAM_VOL", "NET_STEAM_VOL_MTD", "NET_STEAM_VOL_QTD", "NET_STEAM_VOL_YTD", "GRS_ELEC_VOL", "GRS_ELEC_VOL_MTD",
 "GRS_ELEC_VOL_QTD", "GRS_ELEC_VOL_YTD", "NET_ELEC_VOL", "NET_ELEC_VOL_MTD", "NET_ELEC_VOL_QTD", "NET_ELEC_VOL_YTD",
 "AVG_TEMP", "AVG_PRESS", "MIN_PRESS", "AVG_PL_PRESS", "DENSITY", "DENSITY_KGM3", "AVG_DIFF_PRESS", "RUN_SIZE", "ENERGY",
 "ENERGY_2", "ENERGY_CONTENT", "BS_W_WT", "WATER_WT", "H2S", "H2S_2", "CO2", "SALT", "SALT_MASS", "RVP", "TVP", "WDP",
 "TOTALIZER", "SP_GRAV", "BOTTOM_STRIP_TEMP", "K_FACTOR", "ORIFICE_SIZE", "AVG_RATE_HR", "EGM_IND", "TOTALIZER_RESET_IND",
 "METER_PROVED_IND", "COMMENTS", "VALUE_1", "VALUE_2", "VALUE_3", "VALUE_4", "VALUE_5", "VALUE_6", "VALUE_7", "VALUE_8",
 "VALUE_9", "VALUE_10", "TEXT_1", "TEXT_2", "TEXT_3", "TEXT_4", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE",
 "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  SELECT sd.DAYTIME,
          s.OBJECT_ID,
