...
** 02-aug-2018 WVIC 128753 Modified copyToOriginal to prevent overwriting of Documentary Instruction data
** 25-oct-2017 KAWF 129600 Modified copyToOriginal, update only attributes by LC on screen for storage_lift_nomination  cargo transport
** 05-may-2019 KAWF 132136 Modified copyToOriginal, copyToOriginal(), add missing attribute in update storage_lift_nomination
** 05-jul-2019 HQEP Item_132632 WST: ISWR03202: 1 : Changes needed to UE_CT_FCAST_CARGO_PLANNING to ensure that both date_8 and lifting_account _id are added into these for stor_fcst_lift_nom and storage_lift_nomination   
********************************************************************/
...
BEGIN
    ...
    -- start -- hqep -- Item_132632- add date_8 column for LDR Start Overide 
    ...
    SELECT p_new_forecast_id,parcel_no,object_id,cargo_no,lifting_account_id,carrier_id,consignor_id,consignee_id,requested_date,requested_date_range,requested_tolerance_type,grs_vol_requested,nom_firm_date,nom_firm_date_range,nom_sequence,grs_vol_nominated,lifting_split_pct,lifting_split_vol,lifting_code,incoterm,contract_id,telex_ref,graph_value,balance_ind,grs_vol_schedule,schedule_tolerance_type,bl_number,bl_date,unload_date,port_id,doc_instr_received_ind,fixed_ind,bol_comments,charter_party,comments,START_LIFTING_DATE,date_9,grs_vol_requested2,grs_vol_nominated2,grs_vol_scheduled2,grs_vol_requested3,grs_vol_nominated3,grs_vol_scheduled3,
        ...
        text_16,text_17,text_18,text_19,text_20,
    ecdp_context.getAppUser, date_8
    FROM  storage_lift_nomination n
    WHERE n.nom_firm_date >= p_start_date
          AND n.nom_firm_date < p_end_date
          AND n.object_id = nvl(p_storage_id, n.object_id);
    -- end -- hqep --Item_132632 - add date_8 column for LDR Start Overide
...
BEGIN
    ...
    INSERT INTO stor_fcst_lift_nom (forecast_id,parcel_no,object_id,cargo_no,lifting_account_id,carrier_id,consignor_id,consignee_id,requested_date,requested_date_range,requested_tolerance_type,grs_vol_requested,nom_firm_date,nom_firm_date_range,nom_sequence,grs_vol_nominated,lifting_split_pct,lifting_split_vol,lifting_code,incoterm,contract_id,telex_ref,graph_value,balance_ind,grs_vol_schedule,schedule_tolerance_type,bl_number,bl_date,unload_date,port_id,doc_instr_received_ind,fixed_ind,bol_comments,charter_party,comments,
        ...
        text_16,text_17,text_18,text_19,text_20,
    created_by, START_LIFTING_DATE, date_9, grs_vol_requested2, grs_vol_nominated2, grs_vol_scheduled2, grs_vol_requested3, grs_vol_nominated3, grs_vol_scheduled3, date_8)
    SELECT p_new_forecast_id,parcel_no,object_id,cargo_no,lifting_account_id,carrier_id,consignor_id,consignee_id,requested_date,requested_date_range,requested_tolerance_type,grs_vol_requested,nom_firm_date,nom_firm_date_range,nom_sequence,grs_vol_nominated,lifting_split_pct,lifting_split_vol,lifting_code,incoterm,contract_id,telex_ref,graph_value,balance_ind,grs_vol_schedule,schedule_tolerance_type,bl_number,bl_date,unload_date,port_id,doc_instr_received_ind,fixed_ind,bol_comments,charter_party,comments,
        text_1,text_2,text_3,text_4,text_5,text_6,text_7,text_8,text_9,text_10,text_11,text_12,text_13,text_14,text_15,value_1,value_2,value_3,value_4,value_5,value_6,value_7,value_8,value_9,value_10,value_11,date_1,date_2,date_3,date_4,date_5,date_6,date_7,ref_object_id_1,ref_object_id_2,ref_object_id_3,ref_object_id_4,ref_object_id_5,cooldown_ind,cooldown_qty,purge_ind,purge_qty,
        text_16,text_17,text_18,text_19,text_20,
    ecdp_context.getAppUser, START_LIFTING_DATE, date_9, grs_vol_requested2, grs_vol_nominated2, grs_vol_scheduled2, grs_vol_requested3, grs_vol_nominated3, grs_vol_scheduled3, date_8
    FROM  stor_fcst_lift_nom n
    WHERE n.forecast_id = p_forecast_id
        AND n.nom_firm_date >= p_start_date
        AND n.nom_firm_date < p_end_date
...
BEGIN
    ...
    -- cargo transport
    -- 129600 Update only fields available for LC on screen
    ...
    WHEN MATCHED THEN
        /* 129600-Start
        UPDATE SET o.cargo_name = f.cargo_name, o.carrier_id = f.carrier_id, o.agent = f.agent,
		-- Item 128753 Begin
		--o.surveyor = f.surveyor,
		o.surveyor = o.surveyor,
		-- Item 128753 End
		o.laytime = f.laytime,o.EST_ARRIVAL = f.EST_ARRIVAL,o.EST_DEPARTURE = f.EST_DEPARTURE,o.CARGO_STATUS = f.CARGO_STATUS,
        o.PROD_FCTY_ID = f.PROD_FCTY_ID,
		-- Item 128753 Begin
		--o.MASTER = f.MASTER,
		o.MASTER = o.MASTER,
		-- Item 128753 End
		o.PILOT = f.PILOT,o.TUGS_ARR = f.TUGS_ARR,o.TUGS_DEP = f.TUGS_DEP,o.DRAUGHT_MARK_ARR_AFT = f.DRAUGHT_MARK_ARR_AFT,o.DRAUGHT_MARK_ARR_CENTER = f.DRAUGHT_MARK_ARR_CENTER,o.DRAUGHT_MARK_ARR_FORWARD = f.DRAUGHT_MARK_ARR_FORWARD,o.DRAUGHT_MARK_DEP_AFT = f.DRAUGHT_MARK_DEP_AFT,o.DRAUGHT_MARK_DEP_CENTER = f.DRAUGHT_MARK_DEP_CENTER,o.DRAUGHT_MARK_DEP_FORWARD = f.DRAUGHT_MARK_DEP_FORWARD,o.VOYAGE_NO = f.VOYAGE_NO,o.BERTH_ID = f.BERTH_ID,
        o.value_1 = f.value_1, o.value_2 = f.value_2, o.value_3 = f.value_3, o.value_4 = f.value_4, o.value_5 = f.value_5, o.value_6 = f.value_6,
		-- Item 128753 Begin (Postloading Time[h]Bottom of Form, Outbound Channel Time[h]Bottom of Form, Preloading Time[h]Bottom of Form, Inbound Channel Time[h]Bottom of Form)
		--o.value_7 = f.value_7, o.value_8 = f.value_8, o.value_9 = f.value_9, o.value_10 = f.value_10,
		o.value_7 = o.value_7, o.value_8 = o.value_8, o.value_9 = o.value_9, o.value_10 = o.value_10,
		-- Item 128753 End
        o.text_1 = f.text_1, o.text_2 = f.text_2, o.text_3 = f.text_3,
		-- Item 128753 Begin (1 Day Notice)
		--o.text_4 = f.text_4,
		o.text_4 = o.text_4,
		-- Item 128753 End
        o.date_1 = f.date_1, o.date_2 =f.date_2, o.date_3 = f.date_3,o.date_4 = f.date_4, o.date_5 = f.date_5,o.date_6 = f.date_6,
		-- Item 128753 Begin (Best ETA)
		--o.date_7 =f.date_7,
		o.date_7 = o.date_7,
		-- Item 128753 End
		last_updated_by = ecdp_context.getAppUser
        */
        UPDATE SET o.carrier_id = f.carrier_id, o.BERTH_ID = f.BERTH_ID, last_updated_by = ecdp_context.getAppUser
        --129600-End
    WHEN NOT MATCHED THEN
    ...
    -- 129600 Update only fields available for LC on screen
    -- start -- hqep -- Item_132632 - added date_8 column for LDR Start Override
    ...
    USING (SELECT n.parcel_no,n.object_id,n.cargo_no,n.lifting_account_id,n.carrier_id,n.consignor_id,n.consignee_id,n.requested_date,n.requested_date_range,n.requested_tolerance_type,n.grs_vol_requested,n.nom_firm_date,n.nom_firm_date_range,n.nom_sequence,n.grs_vol_nominated,
        ...
        n.value_11,n.text_16,n.text_17,n.text_18,n.text_19,n.text_20,
            ...
            n.date_1,n.date_2,n.date_3,n.date_4,n.date_5,n.date_6,n.date_7,n.grs_vol_scheduled2, n.grs_vol_requested2, n.grs_vol_nominated2, n.grs_vol_scheduled3, n.grs_vol_requested3, n.grs_vol_nominated3, n.START_LIFTING_DATE, n.date_8
        FROM  stor_fcst_lift_nom n,
             forecast c
        WHERE n.forecast_id = p_forecast_id
            AND Nvl(n.DELETED_IND, 'N') <> 'Y'
    ...
    WHEN MATCHED THEN
        -- end -- hqep -- Item_132632 - added date_8 column for LDR Start Override 
    -- 129600 Update only fields available for LC on screen
        /* 129600-Start
        UPDATE SET o.object_id = f.object_id,o.cargo_no = f.cargo_no,o.lifting_account_id = f.lifting_account_id,o.carrier_id = f.carrier_id,
		    -- Item 128753 Begin
		    --o.consignor_id = f.consignor_id,
		    o.consignor_id = o.consignor_id,
		    -- Item 128753 End
			o.consignee_id = f.consignee_id,o.requested_date = f.requested_date,o.requested_date_range = f.requested_date_range,o.requested_tolerance_type = f.requested_tolerance_type,o.grs_vol_requested = f.grs_vol_requested,o.nom_firm_date = f.nom_firm_date,o.nom_firm_date_range = f.nom_firm_date_range,o.nom_sequence = f.nom_sequence,o.grs_vol_nominated = f.grs_vol_nominated,
            o.lifting_split_pct = f.lifting_split_pct,o.lifting_split_vol = f.lifting_split_vol,o.lifting_code = f.lifting_code,o.incoterm = f.incoterm,o.contract_id = f.contract_id,o.telex_ref = f.telex_ref,o.graph_value = f.graph_value,o.balance_ind = f.balance_ind,o.grs_vol_schedule = f.grs_vol_schedule,o.schedule_tolerance_type = f.schedule_tolerance_type,
		    -- Item 128753 Begin (BOL Data)
			--o.bl_number = f.bl_number,o.bl_date = f.bl_date,
			o.bl_number = o.bl_number,o.bl_date = o.bl_date,
		    -- Item 128753 End
			o.unload_date = f.unload_date,o.port_id = f.port_id,o.doc_instr_received_ind = f.doc_instr_received_ind,o.fixed_ind = f.fixed_ind,o.bol_comments = f.bol_comments,o.charter_party = f.charter_party,
		    -- Item 128753 Begin (BOL Data)
			--o.comments = f.comments,o.bl_date_time = f.bl_date_time,
			o.comments = o.comments,o.bl_date_time = o.bl_date_time,
		    -- Item 128753 End
            ...
            o.text_1 = f.text_1, o.text_2 = f.text_2,
		    -- Item 128753 Begin (Notify Party)
			--o.text_3 = f.text_3,
			o.text_3 = o.text_3,
		    -- Item 128753 End
			-- Item 128753 Begin (Consignee)
            --o.text_4 = f.text_4,
            o.text_4 = o.text_4,
		    -- Item 128753 End
			o.text_5 = f.text_5, o.text_6 = f.text_6, o.text_7 = f.text_7, o.text_8 = f.text_8, o.text_9 = f.text_9, o.text_10 = f.text_10,
		    ...
		    -- Item 128753 Begin (Receiving Port Name)
            --o.text_16 = f.text_16,
            o.text_16 = o.text_16,
		    -- Item 128753 End
			o.text_17 = f.text_17,
		    -- Item 128753 Begin (EDN)
			--o.text_18 = f.text_18,
			o.text_18 = o.text_18,
		    -- Item 128753 End
			o.text_19 = f.text_19, o.text_20 = f.text_20,
            o.date_1 = f.date_1, o.date_2 =f.date_2, o.date_3 = f.date_3, o.date_4 = f.date_4, o.date_5 = f.date_5,o.date_6 = f.date_6,o.date_7 = f.date_7, o.grs_vol_scheduled2 = f.grs_vol_scheduled2, o.grs_vol_requested2 = f.grs_vol_requested2, o.grs_vol_nominated2 = f.grs_vol_nominated2, o.grs_vol_scheduled3 = f.grs_vol_scheduled3, o.grs_vol_requested3 = f.grs_vol_requested3, o.grs_vol_nominated3 = f.grs_vol_nominated3, o.nom_firm_date_time = f.nom_firm_date_time,
        */
        --132136: add nom_firm_date, carrier_id
        -- start -- hqep --Item_132632 - added lifting_account_id, date_8 column
        UPDATE SET
            o.value_7 = f.value_8, o.value_8 = f.value_7,
            o.requested_date = f.requested_date, o.grs_vol_nominated = f.grs_vol_nominated,
            o.text_8 = f.text_8, o.text_12 = f.text_12, o.text_13 = f.text_13,
            o.date_3 = f.date_3, o.date_4 = f.date_4, o.grs_vol_requested = f.grs_vol_requested, o.nom_firm_date_range = f.nom_firm_date_range, o.START_LIFTING_DATE = f.START_LIFTING_DATE, o.nom_firm_date = f.nom_firm_date, o.carrier_id = f.carrier_id,
            o.date_5 = f.date_5,o.date_6 = f.date_6,o.date_7 = f.date_7, o.grs_vol_scheduled2 = f.grs_vol_scheduled2, o.grs_vol_requested2 = f.grs_vol_requested2, o.grs_vol_nominated2 = f.grs_vol_nominated2, o.grs_vol_scheduled3 = f.grs_vol_scheduled3, o.grs_vol_requested3 = f.grs_vol_requested3, o.grs_vol_nominated3 = f.grs_vol_nominated3,
            o.last_updated_by = ecdp_context.getAppUser, o.lifting_account_id = f.lifting_account_id, o.date_8 = f.date_8
            -- end -- hqep -- Item_132632 - added lifting_account_id, date_8 column
        --129600-End
    WHEN NOT MATCHED THEN
        -- start -- hqep --Item_132632 -  added date_8 column for LDR Start Override
        ...
        f.date_1,f.date_2,f.date_3,f.date_4,f.date_5,f.date_6,f.date_7, f.grs_vol_scheduled2, f.grs_vol_requested2, f.grs_vol_nominated2, f.grs_vol_scheduled3, f.grs_vol_requested3, f.grs_vol_nominated3, f.START_LIFTING_DATE,
            ecdp_context.getAppUser, f.date_8);
        -- end -- hqep -- Item_132632 - added date_8 column for LDR Start Override
