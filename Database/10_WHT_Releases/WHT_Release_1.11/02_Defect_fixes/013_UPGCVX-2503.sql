...
BEGIN
  ...
  sys.dbms_job.submit(job => x,
                      ...
                      next_date => trunc(sysdate) + 00/24 + 00/1440,
                      interval => 'trunc(sysdate) + 1 + 00/24 + 00/1440',
					  no_parse  => FALSE);
  commit;
...
BEGIN
  ...
  sys.dbms_job.submit(job => x,
                      ...
                      next_date => trunc(sysdate) + 23/24 + 51/1440,
...
BEGIN
  ...
  sys.dbms_job.submit(job => x,
                      ...
                      next_date => trunc(sysdate) + 00/24 + 05/1440,
                      interval => 'trunc(sysdate) + 1 + 00/24 + 05/1440',
					  no_parse  => FALSE);
