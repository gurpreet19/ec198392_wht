...
DELETE FROM CLASS_ATTR_PROPERTY_CNFG WHERE CLASS_NAME='TANK_DAY_INV_OIL' and ATTRIBUTE_NAME='TANK_METER_FREQ' AND PROPERTY_CODE='SCREEN_SORT_ORDER' AND OWNER_CNTX=2500;
...
INSERT INTO class_attr_property_cnfg(CLASS_NAME,ATTRIBUTE_NAME,PROPERTY_CODE,OWNER_CNTX,PRESENTATION_CNTX,PROPERTY_TYPE,PROPERTY_VALUE ) VALUES( 'TANK_DAY_INV_OIL', 'CALC_CLOSING_OIL_VOL','SCREEN_SORT_ORDER',2500,'/EC', 'APPLICATION', 620);
