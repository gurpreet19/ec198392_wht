...
** 29-05-2019  gedv       Item_132674: ISWR02839: Added an update statement to recalculate the excess and callback once a request has been approved.
*****************************************************************/
  ...
  BEGIN
    ...
    update cntr_day_dp_forecast
       set text_2 = 'DG_DATA_WEEK_APP'
	     , record_status = 'A'--Item_131778: ISWR02658 : Included as approved DGWNE will be fetched in CPP NQM Weekly cycle
...
--Item_131778: ISWR02658 Start: DG daily data approval will kick daily cycle retrieval in CPP

       UE_CT_CPP_NQM.RETRIEVEFORECAST('NC_WST_CPP_DAY',p_from_date);

       UE_CT_CPP_NQM.RETRIEVEDOMGAS('NC_WST_CPP_DAY',p_from_date);

--Item_131778: ISWR02658 end
...
*****************************************************************/
  ...
  BEGIN
    ...
    update cntr_dp_event
     ...
     -- Item_132674/ISWR02839: Starts
     UPDATE DV_SCTR_DAY_RENOM
        SET CALLBACK_QTY =
               UE_CT_DG_NOMINATIONS.getCallback (
                  object_id,
                  GAS_DAY,
                  (  NVL (RE_NOM_QTY_OR, NVL (RE_NOM_QTY, 0))
                   + NVL (CRD_RENOM_QTY_OR, NVL (CRD_RENOM_QTY, 0))
                   + NVL (DEBIT_RENOM_QTY_OR, NVL (DEBIT_RENOM_QTY, 0))))
          , EXCESS_PROD_QTY =
               UE_CT_DG_NOMINATIONS.getRemainingExcess (object_id, GAS_DAY)
      WHERE     GAS_DAY = p_from_date
            AND CHNG_RENOM_TYPE = 'CR'
            AND RENOM_TYPE = 'INTRA'
            AND APPROVAL_STATUS = 'DG_DATA_SUB_DAY_ACC';
     -- Item_132674/ISWR02839: Ends.
...
--Item_131778: ISWR02658 Start: DG Intra day data approval will kick Intra day cycle retrieval in CPP

       UE_CT_CPP_NQM.RETRIEVEFORECAST('NC_WST_CPP_INTRA_DAY',p_from_date);

       UE_CT_CPP_NQM.RETRIEVEDOMGAS('NC_WST_CPP_INTRA_DAY',p_from_date);
