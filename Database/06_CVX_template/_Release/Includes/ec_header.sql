...
DEFINE description = '&context_code Template Update &major_version..&new_minor_version'
...
spool &&database_name._&&operation._ec_install_&&buildID..log
...
-- Uncomment this line to perform a check against a feature version. You may copy/paste as necessary
 exec UE_CT_INSTALL_HISTORY.assert_feature_version('&feature_id', to_number('&major_version'), to_number('&new_minor_version') - 1, '=')
