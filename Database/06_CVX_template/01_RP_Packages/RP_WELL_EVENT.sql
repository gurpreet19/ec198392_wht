 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:11/15/2018 07.10.07 AM
...
IS
   ...
   BEGIN
      ret_value := EC_WELL_EVENT.TIME_ZONE      (
         P_OBJECT_ID,
         P_EVENT_TYPE,
         P_DAYTIME,
         P_COMPARE_OPER,
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_WELL_EVENT TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:11/15/2018 07.10.49 AM
