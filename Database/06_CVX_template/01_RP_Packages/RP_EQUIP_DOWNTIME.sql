 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:05/07/2019 10.17.14 AM
...
IS
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_EQUIP_DOWNTIME.UTC_END_DATE      (
         P_EVENT_NO );
         RETURN ret_value;
   END UTC_END_DATE;
   FUNCTION VALUE_5(
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_EQUIP_DOWNTIME.UTC_DAYTIME      (
         P_EVENT_NO );
         RETURN ret_value;
   END UTC_DAYTIME;
   FUNCTION VALUE_6(
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_EQUIP_DOWNTIME TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:05/07/2019 10.17.25 AM
