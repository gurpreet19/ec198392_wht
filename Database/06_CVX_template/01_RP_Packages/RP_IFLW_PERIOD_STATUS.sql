 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:11/15/2018 09.07.11 AM
...
IS
   ...
   BEGIN
      ret_value := EC_IFLW_PERIOD_STATUS.TIME_ZONE      (
         P_OBJECT_ID,
         P_DAYTIME,
         P_TIME_SPAN,
         P_COMPARE_OPER,
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_IFLW_PERIOD_STATUS TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:11/15/2018 09.07.17 AM
