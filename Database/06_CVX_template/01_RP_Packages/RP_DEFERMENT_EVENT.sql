 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:11/15/2018 10.11.24 AM
...
IS
   ...
   BEGIN
      ret_value := EC_DEFERMENT_EVENT.TIME_ZONE      (
         P_EVENT_NO );
         RETURN ret_value;
   END TIME_ZONE;
   FUNCTION WATER_INJ_LOSS_RATE(
   ...
   IS
      ret_value   VARCHAR2 (65) ;
   BEGIN
      ret_value := EC_DEFERMENT_EVENT.END_TIME_ZONE      (
         P_EVENT_NO );
         RETURN ret_value;
   END END_TIME_ZONE;
   FUNCTION EVENT_TAG(
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_DEFERMENT_EVENT TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:11/15/2018 10.11.46 AM
