 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:11/15/2018 07.19.03 AM
...
IS
   ...
   IS
      ret_value   NUMBER ;
   BEGIN
      ret_value := EC_TRANS_INV_LI_PR_CNTRACC.ID      (
         P_OBJECT_ID,
         P_DAYTIME,
         P_LINE_TAG,
         P_PRODUCT_ID,
   ...
   BEGIN
      ret_value := EC_TRANS_INV_LI_PR_CNTRACC.ROW_BY_REL_OPERATOR      (
         P_OBJECT_ID,
         P_DAYTIME,
         P_LINE_TAG,
         P_PRODUCT_ID,
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_TRANS_INV_LI_PR_CNTRACC TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:11/15/2018 07.19.14 AM
