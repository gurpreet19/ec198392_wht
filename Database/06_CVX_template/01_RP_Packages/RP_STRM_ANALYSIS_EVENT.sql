 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:05/07/2019 07.11.21 AM
...
IS
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_STRM_ANALYSIS_EVENT.VALID_TO_DAY      (
         P_ANALYSIS_NO );
         RETURN ret_value;
   END VALID_TO_DAY;
   FUNCTION VALUE_2(
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_STRM_ANALYSIS_EVENT.VALID_FROM_DAY      (
         P_ANALYSIS_NO );
         RETURN ret_value;
   END VALID_FROM_DAY;
   FUNCTION VALID_FROM_UTC_DATE(
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_STRM_ANALYSIS_EVENT TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:05/07/2019 07.11.59 AM
