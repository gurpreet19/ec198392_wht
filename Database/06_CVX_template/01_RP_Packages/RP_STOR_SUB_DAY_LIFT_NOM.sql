 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:11/15/2018 07.48.11 AM
...
IS
   ...
   BEGIN
      ret_value := EC_STOR_SUB_DAY_LIFT_NOM.TIME_ZONE      (
         P_PARCEL_NO,
         P_DAYTIME,
         P_COMPARE_OPER,
         P_SUMMERTIME );
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_STOR_SUB_DAY_LIFT_NOM TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:11/15/2018 07.48.35 AM
