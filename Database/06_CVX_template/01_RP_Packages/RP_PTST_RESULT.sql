 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:05/07/2019 08.05.01 AM
...
IS
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_PTST_RESULT.UTC_END_DATE      (
         P_RESULT_NO );
         RETURN ret_value;
   END UTC_END_DATE;
   FUNCTION VALUE_5(
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_PTST_RESULT.UTC_DAYTIME      (
         P_RESULT_NO );
         RETURN ret_value;
   END UTC_DAYTIME;
   FUNCTION VALUE_6(
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_PTST_RESULT.VALID_FROM_DAY      (
         P_RESULT_NO );
         RETURN ret_value;
   END VALID_FROM_DAY;
   FUNCTION VALID_FROM_UTC_DATE(
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_PTST_RESULT.VALID_FROM_UTC_DATE      (
         P_RESULT_NO );
         RETURN ret_value;
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_PTST_RESULT.END_DAY      (
         P_RESULT_NO );
         RETURN ret_value;
   END END_DAY;
   FUNCTION PRODUCTION_DAY(
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_PTST_RESULT TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:05/07/2019 08.05.17 AM
