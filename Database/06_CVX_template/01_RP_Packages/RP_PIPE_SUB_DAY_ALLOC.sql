 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:11/15/2018 08.26.53 AM
...
IS
   ...
   BEGIN
      ret_value := EC_PIPE_SUB_DAY_ALLOC.TIME_ZONE      (
         P_OBJECT_ID,
         P_DAYTIME,
         P_COMPARE_OPER,
         P_SUMMERTIME );
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_PIPE_SUB_DAY_ALLOC TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:11/15/2018 08.27.02 AM
