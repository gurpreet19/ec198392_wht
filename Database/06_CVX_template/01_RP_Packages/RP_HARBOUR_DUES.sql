 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:11/15/2018 09.10.03 AM
...
IS
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_HARBOUR_DUES.START_DATE      (
         P_DUE_CODE );
         RETURN ret_value;
   END START_DATE;
   FUNCTION TEXT_3(
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_HARBOUR_DUES TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:11/15/2018 09.10.10 AM
