 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:05/07/2019 07.18.37 AM
...
IS
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_STOR_FCST_LIFT_NOM.DATE_9      (
         P_PARCEL_NO,
         P_FORECAST_ID );
         RETURN ret_value;
   END DATE_9;
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_STOR_FCST_LIFT_NOM.DATE_8      (
         P_PARCEL_NO,
         P_FORECAST_ID );
         RETURN ret_value;
   END DATE_8;
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_STOR_FCST_LIFT_NOM TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:05/07/2019 07.19.19 AM
