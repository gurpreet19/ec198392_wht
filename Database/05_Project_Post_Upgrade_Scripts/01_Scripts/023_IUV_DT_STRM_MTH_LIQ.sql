Creating or replacing trigger IUV_DT_STRM_MTH_LIQ definition
java.sql.SQLSyntaxErrorException: ORA-00942: table or view does not exist
	...
	at oracle.jdbc.driver.OracleStatement.executeInternal(OracleStatement.java:2814)
	at oracle.jdbc.driver.OracleStatement.execute(OracleStatement.java:2740)
	at oracle.jdbc.driver.OracleStatementWrapper.execute(OracleStatementWrapper.java:1203)
	at com.ec.upgrade.infrastructure.Database.executeStatement(Database.java:240)
	at com.ec.upgrade.deploy.DataModelDeltaStepExecutor.execute(DataModelDeltaStepExecutor.java:37)
	at com.ec.upgrade.batch.deploy.main.DeltaUtils.executeDbObjectDeltaSteps(DeltaUtils.java:80)
	at com.ec.upgrade.batch.deploy.main.PackageViewTriggerDelta.applyTriggersDelta(PackageViewTriggerDelta.java:210)
	at com.ec.upgrade.batch.deploy.main.DeployMain.deploy(DeployMain.java:495)
	at com.ec.upgrade.batch.deploy.main.DeploymentApplicationMain.deploy(DeploymentApplicationMain.java:81)
	at com.ec.upgrade.batch.deploy.main.DeploymentApplicationMain.execute(DeploymentApplicationMain.java:59)
	at com.ec.upgrade.batch.deploy.main.Launcher.main(Launcher.java:49)
2019-04-23 17:22:32,686 - com.ec.upgrade.batch.deploy.main.DeltaUtils - TRACE - CREATE OR REPLACE EDITIONABLE TRIGGER "IUV_DT_STRM_MTH_LIQ" 
