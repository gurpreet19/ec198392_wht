CREATE OR REPLACE TRIGGER "IUD_WELL_COMP_ANALYSIS" 
...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO ECKERNEL_WST.V_FLUID_ANALYSIS_COMP(OBJECT_ID,DAYTIME,ANALYSIS_TYPE,SAMPLING_METHOD,PHASE,ANALYSIS_NO,OBJECT_CLASS_NAME,COMPONENT_NO,WT_PCT,MOL_PCT,CREATED_BY,CREATED_DATE,LAST_UPDATED_BY,LAST_UPDATED_DATE,REV_NO,REV_TEXT,RECORD_STATUS)
  ...
  ELSIF UPDATING THEN 
    ...
    UPDATE ECKERNEL_WST.V_FLUID_ANALYSIS_COMP SET OBJECT_ID = n_OBJECT_ID,DAYTIME = n_DAYTIME,ANALYSIS_TYPE = n_ANALYSIS_TYPE,SAMPLING_METHOD = n_SAMPLING_METHOD,PHASE = n_PHASE,ANALYSIS_NO = n_ANALYSIS_NO,OBJECT_CLASS_NAME = n_OBJECT_CLASS_NAME,COMPONENT_NO = n_COMPONENT_NO,WT_PCT = n_WT_PCT,MOL_PCT = n_MOL_PCT,CREATED_BY = n_CREATED_BY, CREATED_DATE = n_CREATED_DATE , LAST_UPDATED_BY = n_LAST_UPDATED_BY,LAST_UPDATED_DATE = n_LAST_UPDATED_DATE ,REV_NO = n_rev_no, REV_TEXT = n_REV_TEXT,RECORD_STATUS = n_RECORD_STATUS
  ...
  ELSE -- Deleting 
     ...
     DELETE FROM ECKERNEL_WST.V_FLUID_ANALYSIS_COMP
     WHERE OBJECT_ID= o_OBJECT_ID AND DAYTIME= o_DAYTIME AND ANALYSIS_TYPE= o_ANALYSIS_TYPE AND SAMPLING_METHOD= o_SAMPLING_METHOD AND PHASE= o_PHASE AND COMPONENT_NO= o_COMPONENT_NO;
