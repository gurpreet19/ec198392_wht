CREATE OR REPLACE TRIGGER "IU_OBJ_TRAN_SUB_DAY_NOM_BOUND" 
BEFORE INSERT OR UPDATE ON OBJ_TRAN_SUB_DAY_NOM_BOUND
FOR EACH ROW
DECLARE
...
BEGIN
    -- Basis
    IF Inserting THEN
        lv_pday_object_id := EcDp_ContractDay.findProductionDayDefinition('CONTRACT',:NEW.OBJECT_ID, :new.daytime);
