CREATE OR REPLACE TRIGGER "IUD_CALC_OBJECT_FILTER" 
...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO ECKERNEL_WST.V_CALC_OBJECT_FILTER(OBJECT_ID,OBJECT_TYPE_CODE,IMPL_CLASS_NAME,SQL_SYNTAX,CALC_OBJ_ATTR_FILTER,PARAMETER_FILTER,CREATED_BY,CREATED_DATE,LAST_UPDATED_BY,LAST_UPDATED_DATE,REV_NO,REV_TEXT,RECORD_STATUS)
  ...
  ELSE -- Deleting 
     ...
     DELETE FROM ECKERNEL_WST.V_CALC_OBJECT_FILTER
     WHERE OBJECT_ID= o_OBJECT_ID AND OBJECT_TYPE_CODE= o_OBJECT_TYPE_CODE AND IMPL_CLASS_NAME= o_IMPL_CLASS_NAME AND SQL_SYNTAX= o_SQL_SYNTAX;
