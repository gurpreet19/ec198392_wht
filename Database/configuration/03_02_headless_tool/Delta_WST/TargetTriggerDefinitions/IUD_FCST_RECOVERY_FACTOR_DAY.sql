CREATE OR REPLACE TRIGGER "IUD_FCST_RECOVERY_FACTOR_DAY" 
...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO ECKERNEL_WST.V_FCST_RECOVERY_FACTOR(DAYTIME,CLASS_NAME,OBJECT_ID,FORECAST_ID,CREATED_BY,CREATED_DATE,LAST_UPDATED_BY,LAST_UPDATED_DATE,REV_NO,REV_TEXT,RECORD_STATUS,REC_ID)
  ...
  ELSIF UPDATING THEN 
    ...
    UPDATE ECKERNEL_WST.V_FCST_RECOVERY_FACTOR SET DAYTIME = n_DAYTIME,CLASS_NAME = n_CLASS_NAME,OBJECT_ID = n_NOM_LOC_ID,FORECAST_ID = n_FORECAST_ID,CREATED_BY = n_CREATED_BY, CREATED_DATE = n_CREATED_DATE , LAST_UPDATED_BY = n_LAST_UPDATED_BY,LAST_UPDATED_DATE = n_LAST_UPDATED_DATE ,REV_NO = n_rev_no, REV_TEXT = n_REV_TEXT,RECORD_STATUS = n_RECORD_STATUS,REC_ID = n_rec_id
