CREATE OR REPLACE TRIGGER "IU_SEPA_SUB_DAY_PC_ALLOC" 
BEFORE INSERT OR UPDATE ON sepa_sub_day_pc_alloc
FOR EACH ROW
DECLARE
...
BEGIN
    ...
    IF Inserting THEN
      ...
      IF :NEW.production_day IS NULL THEN
         :new.production_day := EcDp_ProductionDay.getProductionDay('SEPARATOR',:NEW.object_id, :NEW.daytime, :NEW.summer_time);
