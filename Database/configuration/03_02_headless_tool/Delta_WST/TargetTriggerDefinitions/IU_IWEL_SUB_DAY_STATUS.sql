CREATE OR REPLACE TRIGGER "IU_IWEL_SUB_DAY_STATUS" 
BEFORE INSERT OR UPDATE ON iwel_sub_day_status
FOR EACH ROW
DECLARE
...
BEGIN
    ...
    IF Inserting THEN
      ...
      IF :NEW.production_day IS NULL THEN
         :new.production_day := EcDp_ProductionDay.getProductionDay('WELL',:NEW.object_id, :NEW.daytime, :NEW.summer_time);
      END IF;
