CREATE OR REPLACE TRIGGER "IUD_METER_DAY_COMP_APPROVED" 
...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO ECKERNEL_WST.V_METER_COMPOSITION(ANALYSIS_NO,OBJECT_ID,DAYTIME,ANALYSIS_STATUS,COMPONENT_NO,COMPONENT_NAME,WT_PCT,SORT_ORDER,ANALYSIS_TYPE,CREATED_BY,CREATED_DATE,LAST_UPDATED_BY,LAST_UPDATED_DATE,REV_NO,REV_TEXT,RECORD_STATUS)
