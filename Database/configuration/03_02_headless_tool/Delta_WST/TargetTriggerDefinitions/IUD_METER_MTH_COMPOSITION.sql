CREATE OR REPLACE TRIGGER "IUD_METER_MTH_COMPOSITION" 
 INSTEAD OF INSERT OR UPDATE OR DELETE ON DV_METER_MTH_COMPOSITION
 FOR EACH ROW
...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    IF ecdp_objects.isValidOwnerReference('METER_MTH_COMPOSITION',n_OBJECT_ID) = 'N'  THEN 
...
ecdp_meter_measurement.setMeterCompStatus(n_analysis_no,n_last_updated_by);
 ...
 --*************************************************************************************
  ...
  END; -- TRIGGER IUD_METER_MTH_COMPOSITION
