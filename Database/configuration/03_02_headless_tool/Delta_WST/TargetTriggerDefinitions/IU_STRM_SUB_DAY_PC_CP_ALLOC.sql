CREATE OR REPLACE TRIGGER "IU_STRM_SUB_DAY_PC_CP_ALLOC" 
BEFORE INSERT OR UPDATE ON strm_sub_day_pc_cp_alloc
FOR EACH ROW
DECLARE
...
BEGIN
    ...
    IF Inserting THEN
      ...
      IF :NEW.production_day IS NULL THEN
         :new.production_day := EcDp_ProductionDay.getProductionDay('STREAM',:NEW.object_id, :NEW.daytime, :NEW.summer_time);
      END IF;
