CREATE OR REPLACE TRIGGER "IU_PIPE_SUB_DAY_PC_STATUS" 
BEFORE INSERT OR UPDATE ON pipe_sub_day_pc_status
FOR EACH ROW
DECLARE
...
BEGIN
    ...
    If Inserting THEN
      ...
      IF :NEW.production_day IS NULL THEN
         :new.production_day := EcDp_ProductionDay.getProductionDay('PIPELINE',:NEW.object_id, :NEW.daytime, :NEW.summer_time);
      END IF;
