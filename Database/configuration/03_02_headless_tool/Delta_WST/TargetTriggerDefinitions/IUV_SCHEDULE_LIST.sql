CREATE OR REPLACE TRIGGER "IUV_SCHEDULE_LIST" 
...
DECLARE
  ...
  n_FUNCTIONAL_AREA_ID VARCHAR2(4000) := EcDB_Utils.ConditionNVL(NOT Updating('FUNCTIONAL_AREA_ID'),:NEW.FUNCTIONAL_AREA_ID,:OLD.FUNCTIONAL_AREA_ID);
   ...
   n_rec_id          VARCHAR2(32) := Nvl(:OLD.rec_id, SYS_GUID());
BEGIN
  ...
  IF n_FUNCTIONAL_AREA_ID IS NULL THEN Raise_Application_Error(-20103,'Missing value for FUNCTIONAL_AREA_ID'); END IF;
   ...
   IF INSERTING THEN
      ...
      INSERT INTO ECKERNEL_WST.V_SCHEDULE(NAME,DESCRIPTION,PIN_TO,enabled_ind,SCHEDULE_NO,Schedule_group,CREATED_BY,CREATED_DATE,LAST_UPDATED_BY,LAST_UPDATED_DATE,REV_NO,REV_TEXT,RECORD_STATUS,REC_ID)
   ...
   END IF;
      ...
      UPDATE ECKERNEL_WST.V_SCHEDULE
   ...
   ELSE -- deleting
     ...
     DELETE FROM ECKERNEL_WST.V_SCHEDULE
     WHERE SCHEDULE_NO= o_SCHEDULE_NO;
