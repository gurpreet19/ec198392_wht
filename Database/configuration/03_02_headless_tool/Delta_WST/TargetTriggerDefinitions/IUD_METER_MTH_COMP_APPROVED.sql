CREATE OR REPLACE TRIGGER "IUD_METER_MTH_COMP_APPROVED" 
 INSTEAD OF INSERT OR UPDATE OR DELETE ON DV_METER_MTH_COMP_APPROVED
 FOR EACH ROW
...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    IF ecdp_objects.isValidOwnerReference('METER_MTH_COMP_APPROVED',n_OBJECT_ID) = 'N'  THEN 
 ...
 --*************************************************************************************
  ...
  END; -- TRIGGER IUD_METER_MTH_COMP_APPROVED
