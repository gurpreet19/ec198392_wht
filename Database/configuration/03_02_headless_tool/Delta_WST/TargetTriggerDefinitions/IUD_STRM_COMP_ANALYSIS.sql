CREATE OR REPLACE TRIGGER "IUD_STRM_COMP_ANALYSIS" 
...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO ECKERNEL_WST.V_FLUID_ANALYSIS_COMP(OBJECT_ID,DAYTIME,ANALYSIS_TYPE,SAMPLING_METHOD,PHASE,ANALYSIS_NO,OBJECT_CLASS_NAME,WT_PCT,MOL_PCT,COMPONENT_NO,CREATED_BY,CREATED_DATE,LAST_UPDATED_BY,LAST_UPDATED_DATE,REV_NO,REV_TEXT,RECORD_STATUS)
    VALUES(n_OBJECT_ID,n_DAYTIME,n_ANALYSIS_TYPE,n_SAMPLING_METHOD,n_PHASE,n_ANALYSIS_NO,n_OBJECT_CLASS_NAME,n_WT_PCT,n_MOL_PCT,n_COMPONENT_NO,n_CREATED_BY,n_CREATED_DATE,n_LAST_UPDATED_BY,n_LAST_UPDATED_DATE,n_REV_NO,n_REV_TEXT,n_RECORD_STATUS) ;
  ...
  ELSIF UPDATING THEN 
    ...
    UPDATE ECKERNEL_WST.V_FLUID_ANALYSIS_COMP SET OBJECT_ID = n_OBJECT_ID,DAYTIME = n_DAYTIME,ANALYSIS_TYPE = n_ANALYSIS_TYPE,SAMPLING_METHOD = n_SAMPLING_METHOD,PHASE = n_PHASE,ANALYSIS_NO = n_ANALYSIS_NO,OBJECT_CLASS_NAME = n_OBJECT_CLASS_NAME,WT_PCT = n_WT_PCT,MOL_PCT = n_MOL_PCT,COMPONENT_NO = n_COMPONENT_NO,CREATED_BY = n_CREATED_BY, CREATED_DATE = n_CREATED_DATE , LAST_UPDATED_BY = n_LAST_UPDATED_BY,LAST_UPDATED_DATE = n_LAST_UPDATED_DATE ,REV_NO = n_rev_no, REV_TEXT = n_REV_TEXT,RECORD_STATUS = n_RECORD_STATUS
