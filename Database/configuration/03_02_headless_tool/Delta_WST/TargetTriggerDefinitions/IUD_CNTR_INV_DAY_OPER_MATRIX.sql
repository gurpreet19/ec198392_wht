CREATE OR REPLACE TRIGGER "IUD_CNTR_INV_DAY_OPER_MATRIX" 
...
ecdp_contract_inventory.checkTransSign(n_debit_qty, n_credit_qty);
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO ECKERNEL_WST.V_CNTR_INV_OPER_MATRIX(TRANSACTION_SEQ,DAYTIME,CONTRACT_ID,LOCATION_ID,INVENTORY_TYPE,OBJECT_ID,DEBIT_QTY,CREDIT_QTY,CREATED_BY,CREATED_DATE,LAST_UPDATED_BY,LAST_UPDATED_DATE,REV_NO,REV_TEXT,RECORD_STATUS)
