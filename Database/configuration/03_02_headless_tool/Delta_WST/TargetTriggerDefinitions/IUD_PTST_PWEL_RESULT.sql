CREATE OR REPLACE TRIGGER "IUD_PTST_PWEL_RESULT" 
...
BEGIN
 ...
 IF INSERTING OR UPDATING THEN 
   ...
   IF n_class_name IS NOT NULL AND rtrim(upper(n_class_name)) <> rtrim(upper('PTST_PWEL_RESULT')) THEN Raise_Application_Error(-20104,'Given class_name do not correspond to view class name.'); END IF;
