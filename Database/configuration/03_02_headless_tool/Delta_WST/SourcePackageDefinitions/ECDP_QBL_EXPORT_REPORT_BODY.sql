    ...
    LOOP
      ...
      INSERT INTO QBL_EXPORT_COLUMNS
        (OBJECT_ID,
         ...
         created_date)
      VALUES
        (p_object_id, Ecdp_Timestamp.getCurrentSysdate, null, lv_attribute, 'N', p_qbl_query_no, EcDp_User_Session.getUserSessionParameter('USERNAME'), Ecdp_Timestamp.getCurrentSysdate);
