...
BEGIN
		...
		*/
		...
		THEN
			...
			END LOOP;
			EcDp_DynSql.WriteDebugText('EcDp_Matrix.display', row_contents, 'DEBUG' );
		END IF;
		/*
		...
		*/
		...
		LOOP
			...
			THEN
				...
				FOR col_index IN start_col .. end_col
				LOOP
				  EcDp_DynSql.WriteDebugText('EcDp_Matrix.display', cellDescription (row_index, col_index), 'DEBUG' );
				END LOOP;
			END IF;
		END LOOP;
END display;
