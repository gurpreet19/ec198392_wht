...
---------------------------------------------------------------------------------------------------
   ...
   BEGIN
      ...
      IF ln_exists = 0 THEN
         ...
         lv_rev_text := 'Verified at ' || TO_CHAR(Ecdp_Timestamp.getCurrentSysdate, 'YYYY-MM-DD"T"HH24:MI:SS');
...
---------------------------------------------------------------------------------------------------
   ...
   BEGIN
      ...
      lv_rev_text := 'Approved at ' || TO_CHAR(Ecdp_Timestamp.getCurrentSysdate, 'YYYY-MM-DD"T"HH24:MI:SS');
