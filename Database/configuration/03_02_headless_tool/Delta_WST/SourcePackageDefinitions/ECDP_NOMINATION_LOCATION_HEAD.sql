...
** 21.08.2014  leeeewei		ECPD-28347: Modified getFcstSumFracCompRecFac to sum by either nomination location or both nominaiton location and product
**************************************************************************************************************/
...
FUNCTION getFcstSumFracCompRecFac(p_class_name VARCHAR2,p_object_id VARCHAR2,p_daytime DATE,p_forecast_id VARCHAR2, p_dim1_key VARCHAR2 DEFAULT NULL)RETURN NUMBER;
