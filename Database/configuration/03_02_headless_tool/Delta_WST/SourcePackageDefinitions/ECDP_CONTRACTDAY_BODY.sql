...
BEGIN
  -- redirect all calls to Ecdp_Productionday
  RETURN Ecdp_Productionday.findProductionDayDefinition(p_class_name, p_object_id, p_daytime);
...
BEGIN
  -- move the logic to Ecdp_Timestamp
  RETURN Ecdp_Timestamp.getProductionDay(p_class_name, p_object_id, p_daytime);
...
BEGIN
  RETURN Ecdp_Productionday.getProductionDayStartTime(p_class_name, p_object_id, p_day);
...
BEGIN
  ...
  RETURN Ecdp_Productionday.getProductionDayFraction(p_class_name, p_object_id, p_day, p_from_daytime, p_from_summer_time, p_to_daytime, p_to_summer_time);
