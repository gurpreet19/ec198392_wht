...
**	    	08.08.12  limmmchu	ECPD-20371: Modified isCondensateProducer, isGasProducer, isWaterProducer to support all the well type
*****************************************************************/
