...
** 07.04.15 chaudgau  Fixed invalid code at line 42 and 177 with closing parenthesis and single quote
...
BEGIN
	...
	LagKodeServer.Laglogg('-- Generated by EC_GENERATE : $Revision: 1.4 $ ' || To_Char(Ecdp_Timestamp.getCurrentSysdate, 'DD.MM.YYYY HH24:MI'));
	LagKodeServer.Laglogg('------------------------------------------------------------------------------------');
	LagKodeServer.Laglogg('  ');
