...
** 05-04-2012  leongwen   ECPD-19936: Use the Oracle Collection for Shift Object enhancements with Versioning.
** 01-10-2015  leongwen   ECPD-30939: Modified getWorkingShiftCode() to loop thru the array only when its count >= 1 to avoid error looping the null array
*****************************************************************/
