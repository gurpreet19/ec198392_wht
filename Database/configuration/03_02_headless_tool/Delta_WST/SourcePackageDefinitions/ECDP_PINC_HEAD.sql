...
**************************************************************/
  /*
   * Set install mode tag and return NULL. This functions should only be used in sqlldr ctl files.
   */
  FUNCTION enableInstallModeSqlLdr(p_tag VARCHAR2) RETURN VARCHAR2;
