...
BEGIN
   ...
   FOR mycur IN c_prev_daytime_rec LOOP
      ...
      INSERT INTO strm_orf_component (OBJECT_ID, DAYTIME, ORF_TYPE, COMPONENT_NO, ORF_FACTOR, COMMENTS, CREATED_BY) VALUES (p_object_id, p_daytime, p_orf_type, mycur.component_no, mycur.orf_factor, mycur.comments, p_user_id);
   ...
   IF (ln_count = 0)  THEN
     ...
     FOR cur_orf_comp IN c_orf_component LOOP
       ...
       INSERT INTO strm_orf_component (OBJECT_ID, DAYTIME, ORF_TYPE, COMPONENT_NO, CREATED_BY) VALUES (p_object_id, p_daytime, p_orf_type, cur_orf_comp.component_no, p_user_id);
