...
** 04.05.12  limmmchu    ECPD-20155: - Modified function getYfromX
** 30.08.12  limmmchu    ECPD-21325: - Modified function getYfromX
** 25.08.14  shindani    ECPD-27724: - Modified function getProductionRate
********************************************************************/
...
BEGIN
   ...
   ld_cur_sysdate := Ecdp_Timestamp.getCurrentSysdate();
