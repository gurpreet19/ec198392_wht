...
** 27.05.2016  thotesan     ECPD-34016: Modified Function getCargoParcel to extract correct values from Forecast tables
...
BEGIN
    ...
    FOR curCargoParcel IN c_cargo_parcel(p_storage_id, p_forecast_id, p_daytime) LOOP
        ...
        lv_stor_fcst_lvl := ec_stor_fcst_lift_nom.GRS_VOL_NOMINATED(ln_parcel_no,p_forecast_id) || ' ' || EcDP_Unit.GetUnitLabel(EcBp_Storage_Lift_Nomination.getNomUnit(p_storage_id,0));
        ...
        lv_tooltip := '<b>'||ecdp_objects.GetObjName(p_forecast_id,p_daytime)||'</b><br><b>Forecast :</b> ' || lv_stor_fcst_lvl || '<br><b>Actual :</b> ' || lv_stor_lvl ;
    END LOOP;
...
--
---------------------------------------------------------------------------------------------------
FUNCTION getStorageDipDate(p_startdate  DATE,
