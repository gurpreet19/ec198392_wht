...
** 16.06.2017 leongwen ECPD-26180: Modified procedure run_child_process and run_tasks to support reversible process in Status Process. Added failChkRecStsLevel to support status process validation.
...
p_process_id VARCHAR2, p_from_rs_level VARCHAR2, p_to_rs_level VARCHAR2, p_from_daytime DATE, p_to_daytime DATE, p_total_rows_upd IN OUT NUMBER, p_user_id VARCHAR2 DEFAULT NULL, p_reversible_process VARCHAR2 DEFAULT NULL);
PROCEDURE run_tasks(--p_sysnam VARCHAR2,
p_process_id VARCHAR2, p_from_rs_level VARCHAR2, p_to_rs_level VARCHAR2, p_from_daytime DATE, p_to_daytime DATE, p_rows_updated IN OUT NUMBER, p_user_id VARCHAR2 DEFAULT NULL, p_reversible_process VARCHAR2 DEFAULT NULL);
