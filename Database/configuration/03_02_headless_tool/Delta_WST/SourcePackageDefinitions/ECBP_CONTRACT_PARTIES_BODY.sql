...
** 19/09/2012  sharawan     ECPD-20980: Modified updateDelShareEndDate. If more records exist with same daytime, exit the update that nullifies the end date.
** 08/01/2013  sharawan     ECPD-20847: Modified ValidateShare to check UOM for party_share attribute.
********************************************************************/
--<EC-DOC>
---------------------------------------------------------------------------------------------------
