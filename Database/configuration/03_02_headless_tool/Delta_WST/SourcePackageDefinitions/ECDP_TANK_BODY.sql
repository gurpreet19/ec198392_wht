...
--<EC-DOC>
---------------------------------------------------------------------------------------------------
-- Procedure    : updateTankUsageEndDate
-- Description  : When End Date in Tank is updated, update Tank Usage's end date.
--
--
--
-- Preconditions:
...
-- required:
--
-- Behaviour: Whenever there is update on tank.end_date, sync value to tank_usage.end_date.
--
--
---------------------------------------------------------------------------------------------------
...
BEGIN
      ...
      UPDATE dv_tank_usage SET end_date = p_daytime where tank_id = p_object_id;

END updateTankUsageEndDate;
