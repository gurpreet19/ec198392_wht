...
** 14.05.2014  deshpadi  ECPD-26763: Modified cursor in function getShipperPhaseFraction to access RESB_BLOCK_FORMATION_ID, that has been moved to
...
FROM webo_interval_gor w, webo_interval i, resv_block_formation r, rbf_version rbfv, webo_bore wb, perf_interval pi, perf_interval_gor pis, perf_interval_version piv
--WHERE i.resv_block_formation_id = r.object_id
--WHERE pi.resv_block_formation_id = r.object_id
WHERE piv.object_id = pi.object_id
AND piv.resv_block_formation_id = r.object_id
