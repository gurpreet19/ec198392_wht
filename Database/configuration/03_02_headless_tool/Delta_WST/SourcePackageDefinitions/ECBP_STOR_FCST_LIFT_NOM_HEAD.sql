...
**			18.12.2013	chooysie	ECPD-26100: Added function getLiftedVolByIncoterm
...
FUNCTION calcNomSplitQty(p_forecast_id VARCHAR2, p_parcel_no NUMBER, p_company_id VARCHAR2,p_lifting_account_id VARCHAR2, p_xtra_qty NUMBER DEFAULT 0) RETURN NUMBER;

FUNCTION getDefSplit(p_forecast_id VARCHAR2, p_parcel_no NUMBER, p_lifting_account_id VARCHAR2) RETURN NUMBER;
