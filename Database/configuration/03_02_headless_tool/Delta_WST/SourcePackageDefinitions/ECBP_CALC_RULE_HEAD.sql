...
** -------  ------   ----- --------------------------------------
** 1.1.1.2  11.05.2005  Linda B?eim Copied EcTrgPck_objects_attribute_row and use for node_type table. Only specified columns.
...
** 1.1.1.5  15.06.2007  Olav N?and Renamed package to EcBp_calc_rule
*****************************************************************/
