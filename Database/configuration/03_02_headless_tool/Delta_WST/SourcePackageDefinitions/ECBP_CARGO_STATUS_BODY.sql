...
BEGIN
  ...
  ELSIF p_old_cargo_status = 'A' THEN
    IF p_new_cargo_status IN ('T', 'O', 'D', 'R') THEN
      Raise_Application_Error(-20303,'The Cargo Status cannot change from Approved to Tentative, Official, Ready for Harbour or Cancelled');
    END IF;
