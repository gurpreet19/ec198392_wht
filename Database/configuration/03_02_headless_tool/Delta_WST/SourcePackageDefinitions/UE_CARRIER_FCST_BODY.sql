CREATE OR REPLACE PACKAGE BODY ue_carrier_fcst IS
/******************************************************************************
** Package        :  ue_carrier_fcst, body part
**
** $Revision: 1.1 $
**
...
FUNCTION isUnavailable( p_carrier_id VARCHAR2,
						p_daytime DATE, p_forecast_id VARCHAR2)
RETURN VARCHAR2
--</EC-DOC>
IS
...
BEGIN
  ...
  lv_ind := ecdp_carrier_fcst.isUnavailable(p_carrier_id,p_daytime,p_forecast_id);
...
BEGIN
  ...
  lv_reason := ecdp_carrier_fcst.getUnavailableReason(p_carrier_id, p_daytime, p_forecast_id);
...
BEGIN
	...
	ld_avail_date:= ecdp_carrier_fcst.getNextAvailDate(p_carrier_id,p_daytime,p_forecast_id);
