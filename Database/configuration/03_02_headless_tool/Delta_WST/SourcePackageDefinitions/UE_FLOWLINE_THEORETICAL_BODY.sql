...
-- Description    : Returns Water Gas Ratio for flowline on a given day at standard conditions, source method specified
---------------------------------------------------------------------------------------------------
FUNCTION findWaterGasRatio(
   p_object_id   flowline.object_id%TYPE,
   p_daytime     DATE )
...
-- Description    : Returns injection volume for flowline on a given day, source method specified
---------------------------------------------------------------------------------------------------
FUNCTION getInjectedStdRateDay(
   p_object_id   flowline.object_id%TYPE,
   p_inj_type    VARCHAR2,
