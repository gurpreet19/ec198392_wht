...
** 06.06.2017  jainnraj     ECPD-46078 : Modified getSortOrder to enable pattern searching on column stream_set.
** 27.09.2017  mishrdha     ECPD-48000 : Edit validateBalancingFlag to updateBalancingFlag to allow only one balancing flag per stream.
   ...
   ln_sort_order 	NUMBER;
    ...
    CURSOR c_strm_set_list (cp_date DATE) IS
     ...
     WHERE t.object_id = p_object_id
       AND t.stream_set LIKE p_stream_set
