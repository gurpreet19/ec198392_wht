...
** ------      -----    -----------------------------------------------------------------------------------------------
** 06-06-2012  farhaann ECPD-20493: Added checkNomPoint and validateAllocMethod procedure
** 12-07-2012  farhaann ECPD-21455: Added validateMeterLoc and validateOverlappingPeriod
** 31-07-2012  sharawan ECPD-19482: Added getMeterFromCntrInv to get meter id that is connected to the contract inventory
** 01-08-2012  farhaann ECPD-21455: Modified validateMeterLoc and validateOverlappingPeriod
*/
...
IS
  ...
  CURSOR c_meter(cp_location VARCHAR2) IS
   SELECT *
    FROM meter_alloc_method a
     WHERE (a.end_date >= p_daytime OR a.end_date IS NULL)
