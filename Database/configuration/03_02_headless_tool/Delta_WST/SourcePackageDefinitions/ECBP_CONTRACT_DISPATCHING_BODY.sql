...
** 13.08.13	  muhammah		ECPD-24691: update procedure aggregateSubDaily to call ue function
******************************************************************/
...
BEGIN
  ...
  ue_Contract_Dispatching.aggregateSubDaily(p_class_name, p_stream_mapping, p_profitcentre_id, p_stream_id, p_production_day, p_user);
