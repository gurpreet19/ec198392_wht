...
-- Description    : Returns type for product
--
-- Preconditions  :
-- Postconditions :
--
...
--
---------------------------------------------------------------------------------------------------
FUNCTION getProductType (p_product_object_id IN VARCHAR2,
                         p_daytime           IN DATE DEFAULT NULL)
RETURN VARCHAR2
--</EC-DOC>
IS
...
BEGIN
   ...
   lv2_retval := ec_chem_product_version.product_type(p_product_object_id, ld_date, '<=');
   RETURN lv2_retval;
END getProductType;
