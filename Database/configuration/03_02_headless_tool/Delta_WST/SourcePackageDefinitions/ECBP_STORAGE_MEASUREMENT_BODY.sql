...
**			22.01.2013 kumarsur ECPD-23051: Remove NVL(xxxxx,0) to return NULL values for the values which are NULL.
**			27.11.2013 abdulmaw ECPD-25999: Remove else statement to return NULL instead of 0 for monthly function
**			31.12.2013 wonggkai ECPD-26212: Modified getStorageDayClosingDiluent, added NVL() to ecbp_tank.findClosingDiluentVol()
*****************************************************************/
...
BEGIN
	ln_return_val := 0;
	FOR mycur IN cur_tanks(p_object_id, p_daytime,p_exclude_out_of_service) LOOP
		ln_return_val := ln_return_val + nvl(ecbp_tank.findClosingDiluentVol(mycur.tank_id, 'DAY_CLOSING', p_daytime), 0);
	END LOOP;
	RETURN ln_return_val;
...
BEGIN
	...
	ln_return_val:= ecdp_if_tran_cargo.GETLIFTEDNETVOLSM3(p_object_id, p_daytime);
	RETURN ln_return_val;
...
ln_return_val NUMBER;
BEGIN
	ln_return_val:= ecdp_if_tran_cargo.GETLIFTEDNETVOLBBLS(p_object_id, p_daytime);
	RETURN ln_return_val;
...
BEGIN
	ln_return_val:= ecdp_if_tran_cargo.GETLIFTEDGRSVOLSM3(p_object_id, p_daytime);
	RETURN ln_return_val;
...
BEGIN
	ln_return_val:= ecdp_if_tran_cargo.GETLIFTEDGRSVOLBBLS(p_object_id, p_daytime);
	RETURN ln_return_val;
...
BEGIN
	ln_return_val:= ecdp_if_tran_cargo.GETDAYEXPNOTLIFTEDNETBBLS(p_object_id, p_daytime);
	RETURN ln_return_val;
...
BEGIN
	ln_return_val:= ecdp_if_tran_cargo.GETMTHEXPNOTLIFTEDNETBBLS(p_object_id, p_daytime);
	RETURN ln_return_val;
...
BEGIN
	ln_return_val:= ecdp_if_tran_cargo.GETDAYEXPNOTLIFTEDNETSM3(p_object_id, p_daytime);
	RETURN ln_return_val;
...
BEGIN
	ln_return_val:= ecdp_if_tran_cargo.GETMTHEXPNOTLIFTEDNETSM3(p_object_id, p_daytime);
	RETURN ln_return_val;
...
BEGIN
	ln_return_val:= ecdp_if_tran_cargo.GETDAYEXPNOTLIFTEDGRSSM3(p_object_id, p_daytime);
	RETURN ln_return_val;
...
BEGIN
	ln_return_val:= ecdp_if_tran_cargo.GETMTHEXPNOTLIFTEDGRSSM3(p_object_id, p_daytime);
	RETURN ln_return_val;
...
BEGIN
	ln_return_val:= ecdp_if_tran_cargo.GETDAYEXPNOTLIFTEDGRSBBLS(p_object_id, p_daytime);
	RETURN ln_return_val;
...
BEGIN
	ln_return_val:= ecdp_if_tran_cargo.GETMTHEXPNOTLIFTEDGRSBBLS(p_object_id, p_daytime);
