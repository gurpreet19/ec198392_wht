...
BEGIN
  ...
  LOOP
      ...
      VALUES(p_std_copy_code,cs_row.START_DATE,cs_row.END_DATE,cs_row.COMMENTS,p_user_id,Ecdp_Timestamp.getCurrentSysdate);
  ...
  LOOP
     ...
     INSERT
      ...
      VALUES(ec_constant_standard.object_id_by_uk(p_std_copy_code),csv_row.DAYTIME,csv_row.END_DATE,p_std_copy_name,csv_row.REF_PRESSURE,p_user_id,Ecdp_Timestamp.getCurrentSysdate);
  ...
  LOOP
     ...
     VALUES (ec_constant_standard.object_id_by_uk(p_std_copy_code),cc_row.DAYTIME,cc_row.COMPONENT_NO,cc_row.MOL_WT,cc_row.MOL_VOL,cc_row.COMP_FACTOR,cc_row.IDEAL_DENSITY,cc_row.SUM_FACTOR,cc_row.IDEAL_GCV,cc_row.IDEAL_NCV,cc_row.OIL_DENSITY,cc_row.NCV,cc_row.GCVM,cc_row.NCVM,p_user_id,Ecdp_Timestamp.getCurrentSysdate);
  ...
  LOOP
      ...
      VALUES (ec_constant_standard.object_id_by_uk(p_std_copy_code),csf_row.DAYTIME,csf_row.COMPONENT_NO,csf_row.METER_TEMP,csf_row.Z_FACTOR,csf_row.SQRTB_FACTOR,csf_row.COMMENTS,p_user_id,Ecdp_Timestamp.getCurrentSysdate);
  ...
  LOOP
      ...
      VALUES (ec_constant_standard.object_id_by_uk(p_std_copy_code),cim_row.DAYTIME,cim_row.METHOD,cim_row.COMPONENT_NO,cim_row.COMB_TEMP,cim_row.SUPERIOR,cim_row.INFERIOR,cim_row.COMMENTS,p_user_id,Ecdp_Timestamp.getCurrentSysdate);
  ...
  LOOP
      ...
      INSERT
        INTO const_std_cv_ideal(OBJECT_ID,DAYTIME,METHOD,COMPONENT_NO,COMB_TEMP,SUPERIOR,INFERIOR,COMMENTS,CREATED_BY,CREATED_DATE)
      VALUES (ec_constant_standard.object_id_by_uk(p_std_copy_code),cimol_row.DAYTIME,cimol_row.METHOD,cimol_row.COMPONENT_NO,cimol_row.COMB_TEMP,cimol_row.SUPERIOR,cimol_row.INFERIOR,cimol_row.COMMENTS,p_user_id,Ecdp_Timestamp.getCurrentSysdate);
  ...
  LOOP
      ...
      VALUES (ec_constant_standard.object_id_by_uk(p_std_copy_code),civ_row.DAYTIME,civ_row.COMPONENT_NO,civ_row.COMB_TEMP,civ_row.METER_TEMP,civ_row.SUPERIOR,civ_row.INFERIOR,civ_row.COMMENTS,p_user_id,Ecdp_Timestamp.getCurrentSysdate);
  ...
  LOOP
      ...
      VALUES (ec_constant_standard.object_id_by_uk(p_std_copy_code),ki_row.DAYTIME,ki_row.MOL_WT,ki_row.GAS_TEMP,ki_row.K1_FACTOR,ki_row.K2_FACTOR,ki_row.COMMENTS,p_user_id,Ecdp_Timestamp.getCurrentSysdate);
  ...
  LOOP
      ...
      VALUES (ec_constant_standard.object_id_by_uk(p_std_copy_code),vi_row.DAYTIME,vi_row.COMPONENT_NO,vi_row.GAS_TEMP,vi_row.VI_FACTOR,vi_row.COMMENTS,p_user_id,Ecdp_Timestamp.getCurrentSysdate);
