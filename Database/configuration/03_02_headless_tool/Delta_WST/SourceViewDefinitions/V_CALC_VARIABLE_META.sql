...
SELECT
   ...
   cv.rev_no,
   cv.rev_text
  from calc_variable cv, calc_var_read_mapping cvr, class_cnfg c
...
SELECT
   ...
   cv.rev_no,
   cv.rev_text
  from calc_variable cv, calc_var_write_mapping cvw, class_cnfg c
