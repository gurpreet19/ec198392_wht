CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_FCST_SUMM_VAR_DAY" ("FORECAST_ID", "SCENARIO_ID", "DAYTIME", "VARIABLE_CODE", "VARIABLE_NAME", "SORT_ORDER", "OIL", "GAS", "WAT", "COND", "GL", "DL", "WI", "GI", "SI", "CI", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
