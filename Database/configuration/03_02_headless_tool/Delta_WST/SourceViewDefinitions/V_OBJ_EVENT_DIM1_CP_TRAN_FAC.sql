CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_OBJ_EVENT_DIM1_CP_TRAN_FAC" ("OBJECT_ID", "DAYTIME", "COMPONENT_NO", "COMPONENT_NAME", "FRAC", "CLASS_NAME", "DIM1_KEY", "SORT_ORDER", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REC_ID", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
...
-- ---------- --------  ----------------------------------------------------------------------------
-- 13.09.2013 leeeewei  ECPD-19504: Initial version
----------------------------------------------------------------------------------------------------
SELECT o.object_id,
       o.daytime,
       o.component_no,
