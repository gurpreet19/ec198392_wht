CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_CARRIER_DAY" ("DAYTIME", "OBJECT_ID", "PRODUCT_GROUP", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT", "APPROVAL_BY", "APPROVAL_DATE", "APPROVAL_STATE", "REC_ID", "RECORD_STATUS") AS 
  (
/**************************************************************
