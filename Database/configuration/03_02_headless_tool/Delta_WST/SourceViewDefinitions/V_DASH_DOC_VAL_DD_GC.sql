CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_DASH_DOC_VAL_DD_GC" ("SORT_ORDER", "PERIOD_CHAR", "PERIOD_DATE", "DOC_VALUE", "FIN_CODE_TEXT", "CO_NAME", "GROUP_CURRENCY_CODE", "CO_ID") AS 
  select
