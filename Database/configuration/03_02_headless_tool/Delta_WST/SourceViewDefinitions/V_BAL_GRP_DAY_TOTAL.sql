CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_BAL_GRP_DAY_TOTAL" ("DAYTIME", "OBJECT_ID", "FACILITY_ID", "IN_OUT_FLAG", "NAME", "PRODUCT_ID", "PRODUCT_BALANCE", "ACTIVITY_CODE", "TOTAL_VOL", "NET_ADJ_VOL", "DILUENT_VOL", "SHRINKAGE_VOL", "BITUMEN_VOL", "ALLOC_ENERGY", "NET_ADJ_ALLOC_ENERGY", "BALANCE_GROUP_CODE", "PRODUCT_BALANCE_GROUP", "URL", "PRORATION_FACTOR", "METERING_DIFF", "SORT_ORDER", "TRUCK_TICKET_FLAG", "PARENT_OBJECT_ID", "STRM_BAL_CATEGORY", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  SELECT daytime,
