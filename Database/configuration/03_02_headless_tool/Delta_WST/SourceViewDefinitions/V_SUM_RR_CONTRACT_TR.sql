CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_SUM_RR_CONTRACT_TR" ("OBJECT_ID", "CLASS_NAME", "LINE_ITEM_VALUE", "QTY1", "QTY2", "QTY3", "QTY4", "PRICING_VALUE", "PRICING_VAT_VALUE", "PRICING_TOTAL", "MEMO_VALUE", "MEMO_VAT_VALUE", "MEMO_TOTAL", "BOOKING_VALUE", "BOOKING_VAT_VALUE", "BOOKING_TOTAL", "DAYTIME", "REPORT_REF_TYPE", "REF_TAG", "REV_TEXT", "APPROVAL_STATE", "APPROVAL_BY", "APPROVAL_DATE", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REC_ID", "REV_NO", "RECORD_STATUS") AS 
  select object_id,
