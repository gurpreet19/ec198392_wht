CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_DASH_DOC_VAL_DD_BC" ("SORT_ORDER", "PERIOD_CHAR", "PERIOD_DATE", "DOC_VALUE", "FIN_CODE_TEXT", "CO_NAME", "CO_ID", "BOOKING_CURRENCY_CODE", "BOOKING_CURRENCY_ID") AS 
  select
