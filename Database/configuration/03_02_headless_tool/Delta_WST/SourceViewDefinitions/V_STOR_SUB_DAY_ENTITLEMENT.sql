...
SELECT fc.object_id,
  ...
  FROM stor_sub_day_forecast fc,
       (SELECT n.object_id,
          ...
          FROM storage_lift_nomination n, cargo_transport t, stor_sub_day_lift_nom sn, cargo_status_mapping csm
