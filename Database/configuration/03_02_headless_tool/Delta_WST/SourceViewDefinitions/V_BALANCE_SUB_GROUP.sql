CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_BALANCE_SUB_GROUP" ("DAYTIME", "OBJECT_ID", "IN_OUT_FLAG", "FACILITY_ID", "STRM_BAL_CATEGORY", "PRODUCT_BALANCE_GROUP", "PRODUCT_ID", "PRODUCT_BALANCE", "ACTIVITY_CODE", "TOTAL_VOL", "NET_ADJ_VOL", "DILUENT_VOL", "SHRINKAGE_VOL", "BITUMEN_VOL", "ALLOC_ENERGY", "NET_ADJ_ALLOC_ENERGY", "NET_MASS", "BALANCE_GROUP_CODE", "URL", "PARENT_OBJECT_ID", "SORT_ORDER", "TRUCK_TICKET_FLAG", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  SELECT daytime,
       NULL object_id,
       NULL in_out_flag,
