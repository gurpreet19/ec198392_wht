CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_CNTR_MTH_EXP_FCST" ("OBJECT_ID", "DAYTIME", "CATEGORY_CODE", "EXP", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
/**************************************************************
