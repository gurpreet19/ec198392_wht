CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_DSHBD_AREA_T5_GAS_MTH" ("MTH_FIRST_DAY", "MTH_GAS_SUM", "WELL_OBJECT_ID", "OBJECT_ID", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
-- File name: V_DSHBD_AREA_T5_GAS_MTH.sql
-- View name: V_DSHBD_AREA_T5_GAS_MTH
--
-- $Revision: 1.3 $
--
-- Purpose  : The monthly top 5 gas producers at area
--
...
FROM V_DAY_ALLOC_GAS_SUM_MTH a, WELL_VERSION wv, GEOGRAPHICAL_AREA ga
