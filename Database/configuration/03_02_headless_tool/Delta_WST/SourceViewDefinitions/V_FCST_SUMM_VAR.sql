CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_FCST_SUMM_VAR" ("FORECAST_ID", "SCENARIO_ID", "FROM_MONTH", "TO_MONTH", "VARIABLE_CODE", "VARIABLE_NAME", "SORT_ORDER", "OIL", "GAS", "WAT", "COND", "GL", "DL", "WI", "GI", "SI", "CI", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
...
GROUP BY a.FORECAST_ID, a.SCENARIO_ID, a.VARIABLE_CODE, a.VARIABLE_NAME, a.SORT_ORDER, m1.MTH, m2.MTH
