CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_CALC_OBJECT_FILTER" ("OBJECT_ID", "OBJECT_TYPE_CODE", "IMPL_CLASS_NAME", "SQL_SYNTAX", "CALC_OBJ_ATTR_FILTER", "PARAMETER_FILTER", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
--
