CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_FCST_SUMM_PHASE_MTH" ("FORECAST_ID", "OBJECT_ID", "MONTH", "PHASE_CODE", "PHASE_NAME", "SORT_ORDER", "POT_UNCONSTR", "CONSTR", "POT_CONSTR", "S1P_SHORTFALL", "S1U_SHORTFALL", "S2_SHORTFALL", "INT_CONSUMPT", "LOSSES", "COMPENSATION", "AVAIL_EXPORT", "INJ", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
...
GROUP BY a.FORECAST_ID, a.OBJECT_ID,TRUNC(DAYTIME,'MONTH'),PHASE_CODE,PHASE_NAME,SORT_ORDER
UNION ALL
SELECT a.FORECAST_ID AS FORECAST_ID,
       a.OBJECT_ID AS OBJECT_ID,
       TRUNC(DAYTIME,'MONTH') AS MONTH,
