...
,t.SORT_ORDER
,LTRIM(Nvl(t.task_description,' ')||' '||Nvl(EcDp_ClassMeta_Cnfg.getLabel(c.class_name), c.class_name) ||' ('||TO_CHAR(count(*))||' records )') description
...
,t.APPROVAL_STATE
,t.REC_ID
FROM  TASK T, TASK_DETAIL td, class_cnfg c, V_APPROVALRECORDS ar
...
,td.class_name
,t.task_description
,Nvl(EcDp_ClassMeta_Cnfg.getLabel(c.class_name),c.class_name)
,t.SORT_ORDER
,td.class_name
,t.BUSINESS_FUNCTION_NO
,t.TASK_DUE_DATE
