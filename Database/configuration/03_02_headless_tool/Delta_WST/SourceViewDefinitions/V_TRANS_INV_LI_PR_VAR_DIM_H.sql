CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_TRANS_INV_LI_PR_VAR_DIM_H" ("OBJECT_ID", "DAYTIME", "LINE_TAG", "VARIABLE_EXEC_ORDER", "PRODUCT_ID", "COST_TYPE", "CONFIG_VARIABLE_ID", "END_DATE", "NAME", "KEY", "DIMENSION", "CONFIG_VARIABLE_PARAM_ID", "PROD_STREAM_ID", "TRANS_PARAM_SOURCE_ID", "TEXT", "TEXT_1", "TEXT_2", "TEXT_3", "TEXT_4", "TEXT_5", "TEXT_6", "TEXT_7", "TEXT_8", "TEXT_9", "TEXT_10", "VALUE_1", "VALUE_2", "VALUE_3", "VALUE_4", "VALUE_5", "DATE_1", "DATE_2", "DATE_3", "DATE_4", "DATE_5", "REF_OBJECT_ID_1", "REF_OBJECT_ID_2", "REF_OBJECT_ID_3", "REF_OBJECT_ID_4", "REF_OBJECT_ID_5", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT", "APPROVAL_BY", "APPROVAL_DATE", "APPROVAL_STATE", "REC_ID", "COPY_IND", "JN_DATETIME") AS 
  SELECT tilpvp.OBJECT_ID,
       ...
       ,'N' COPY_IND
       ,JN_DATETIME
  from V_TRANS_INV_LI_PR_VAR_DIM_HIST tilpvp
union
select tips.INVENTORY_ID,
  ...
  from v_trans_inv_li_pr_var_hist     tilpv,
       ...
       v_trans_inventory_version_hist tiv,
       v_trans_inv_prod_stream_hist   tips_template,
       V_TRANS_INV_LI_PR_VAR_DIM_HIST tilpvp
 where tips_template.inventory_id = tilpv.object_id --Inventory Template
   ...
   and not exists (select object_id from v_trans_inv_li_pr_var_hist v1
