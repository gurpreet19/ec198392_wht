...
-- 20.04.2012 rajarsar  ECPD-20230:Updated function call for unassigned vol and unassigned mass to return abs value
-- 18.07.2012 rajarsar  ECPD-21437:Updated to support configuration from strm_day_stream_loss
----------------------------------------------------------------------------------------------------
select
event_no
      ,object_id
