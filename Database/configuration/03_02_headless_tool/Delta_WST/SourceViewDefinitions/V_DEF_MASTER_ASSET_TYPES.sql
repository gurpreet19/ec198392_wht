CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_DEF_MASTER_ASSET_TYPES" ("CLASS_NAME", "CLASS_LABEL", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------
SELECT class_name,
EcDp_ClassMeta_Cnfg.getLabel(class_name) class_label,
record_status,
created_by,
created_date,
last_updated_by,
