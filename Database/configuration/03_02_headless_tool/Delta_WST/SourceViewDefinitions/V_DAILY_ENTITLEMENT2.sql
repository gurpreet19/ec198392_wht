...
FROM stor_day_forecast fc,
     (SELECT n.object_id,
      ...
      FROM storage_lift_nomination n, cargo_transport t, cargo_status_mapping csm,
      ...
      AND (t.cargo_no IS NULL OR csm.ec_cargo_status <> 'D')) l
