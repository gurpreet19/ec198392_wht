CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_STREAM_NODE_DIAGRAM_META" ("NAME", "FULL_NAME", "IMPLEMENTING_CLASS", "EC_DATA_CLASS", "OBJECT_TYPE", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
SELECT
