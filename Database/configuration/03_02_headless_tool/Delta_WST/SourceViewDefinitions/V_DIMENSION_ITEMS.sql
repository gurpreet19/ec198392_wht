CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_DIMENSION_ITEMS" ("DIM_OBJECT_ID", "DIM_ITEM_1", "DIM_ITEM_2", "DIM_ITEM_ID_1", "DIM_ITEM_ID_2", "DIM_SET_1", "DIM_SET_2", "END_DATE", "EXEC_ORDER", "DEFAULT_EXEC", "GROUP_ID", "DAYTIME", "CONTRACT_ID", "OBJECT_ID", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT", "COMMENTS") AS 
