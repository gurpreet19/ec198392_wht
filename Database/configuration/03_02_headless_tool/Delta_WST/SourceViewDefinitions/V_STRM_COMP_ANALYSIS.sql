CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_STRM_COMP_ANALYSIS" ("OBJECT_ID", "DAYTIME", "VALID_FROM_DATE", "SAMPLING_METHOD", "OFA_DENSITY", "COMPONENT_NO", "WT_PCT", "MOL_PCT", "DENSITY", "MEAS_MOL_WT", "MEAS_SPECIFIC_GRAVITY", "VOL_PCT", "VALUE_1", "VALUE_2", "VALUE_3", "VALUE_4", "VALUE_5", "VALUE_6", "VALUE_7", "VALUE_8", "VALUE_9", "VALUE_10", "TEXT_1", "TEXT_2", "TEXT_3", "TEXT_4", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
-------------------------------------------------------------------------------------
