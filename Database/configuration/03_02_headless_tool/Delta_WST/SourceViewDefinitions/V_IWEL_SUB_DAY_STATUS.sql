CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_IWEL_SUB_DAY_STATUS" ("OBJECT_ID", "DAYTIME", "PRODUCTION_DAY", "SUMMER_TIME", "INJ_TYPE", "CODE", "NAME", "CURRENT_WELL_TYPE", "ON_STREAM_HRS", "AVG_CHOKE_SIZE", "CHOKE_MM", "AVG_WH_PRESS_BARG", "AVG_WH_TEMP_C", "AVG_WH_USC_PRESS_BARG", "AVG_WH_USC_TEMP_C", "AVG_WH_DSC_PRESS_BARG", "AVG_WH_DSC_TEMP_C", "AVG_BH_PRESS_BARG", "AVG_BH_TEMP_C", "AVG_ANNULUS_PRESS_BARG", "INJ_RATE_M3PERDAY", "ISGASINJECTOR", "ISWATERINJECTOR", "ISSCO2INJECTOR", "ISSTEAMINJECTOR", "CALC_GAS_INJ_METHOD", "CALC_WATER_INJ_METHOD", "CALC_CO2_INJ_METHOD", "CALC_STEAM_INJ_METHOD", "THEOR_CALC_METHOD", "OFFICIAL_NAME", "WELL_CLASS", "OBJECT_START_DATE", "OBJECT_END_DATE", "DESCRIPTION", "FLOWLINE", "COMMENTS", "WELL_METER_FREQ", "INSTRUMENTRION_TYPE", "PR_RESDATA_CLASS", "CALC_METHOD", "CALC_GAS_METHOD", "CALC_WATER_METHOD", "CALC_COND_METHOD", "CALC_METHOD_MASS", "CHOKE_UOM", "CHOKE_ID", "CHOKE_CODE", "COMMERCIAL_ENTITY_ID", "COMMERCIAL_ENTITY_CODE", "OP_FCTY_1_ID", "OP_FCTY_1_CODE", "OP_WELL_HOOKUP_ID", "OP_WELL_HOOKUP_CODE", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT", "APPROVAL_STATE", "APPROVAL_BY", "APPROVAL_DATE") AS 
  (
----------------------------------------------------------------------------------------------------------------
--  V_IWEL_SUB_DAY_STATUS
--
-- $Revision: 1.0 $
--
...
SELECT
      ...
      ,ids.daytime                                                                           DAYTIME
      ,ids.PRODUCTION_DAY                                                                    PRODUCTION_DAY
      ,ids.SUMMER_TIME                                                                       SUMMER_TIME
      ...
      ,ids.avg_annulus_press                                                                 AVG_ANNULUS_PRESS_BARG
      ,ids.inj_rate                                                                          INJ_RATE_M3PERDAY
...
FROM iwel_sub_day_status ids, well o, well_version oa
