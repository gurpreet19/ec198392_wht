...
--         06.02.2007 SRA   Migrated version
----------------------------------------------------------------------------------------------------
SELECT  stim.month_no                                                                                                                                                                                                     MONTH                   -- STIM_MTH_BOOKED.DAYTIME
        ...
        ,stim.net_energy_jo*DECODE(across_node.node_object_id,Ecdp_Stream_Item.GetNode('FROM_NODE', smv.object_id, smv.daytime),1,-1)                                                                                                                               NET_ENERGY_JO           -- STIM_MTH_BOOKED.NET_ENERGY_JO
        ,stim.net_energy_th*DECODE(across_node.node_object_id,Ecdp_Stream_Item.GetNode('FROM_NODE', smv.object_id, smv.daytime),1,-1)                                                                                                                               NET_ENERGY_TH           -- STIM_MTH_BOOKED.NET_ENERGY_TH
        ,stim.net_energy_wh*DECODE(across_node.node_object_id,Ecdp_Stream_Item.GetNode('FROM_NODE', smv.object_id, smv.daytime),1,-1)                                                                                                                               NET_ENERGY_WH           -- STIM_MTH_BOOKED.NET_ENERGY_WH
        ,stim.net_energy_be*DECODE(across_node.node_object_id,Ecdp_Stream_Item.GetNode('FROM_NODE', smv.object_id, smv.daytime),1,-1)                                                                                                                               NET_ENERGY_BE           -- STIM_MTH_BOOKED.NET_ENERGY_BE
        ,stim.net_mass_ma  *DECODE(across_node.node_object_id,Ecdp_Stream_Item.GetNode('FROM_NODE', smv.object_id, smv.daytime),1,-1)                                                                                                                               NET_MASS_MA             -- STIM_MTH_BOOKED.NET_MASS_MA
        ,stim.net_mass_mv  *DECODE(across_node.node_object_id,Ecdp_Stream_Item.GetNode('FROM_NODE', smv.object_id, smv.daytime),1,-1)                                                                                                                               NET_MASS_MV             -- STIM_MTH_BOOKED.NET_MASS_MV
        ,stim.net_mass_ua  *DECODE(across_node.node_object_id,Ecdp_Stream_Item.GetNode('FROM_NODE', smv.object_id, smv.daytime),1,-1)                                                                                                                               NET_MASS_UA             -- STIM_MTH_BOOKED.NET_MASS_UA
        ,stim.net_mass_uv  *DECODE(across_node.node_object_id,Ecdp_Stream_Item.GetNode('FROM_NODE', smv.object_id, smv.daytime),1,-1)                                                                                                                               NET_MASS_UV             -- STIM_MTH_BOOKED.NET_MASS_UV
        ,stim.net_volume_bi*DECODE(across_node.node_object_id,Ecdp_Stream_Item.GetNode('FROM_NODE', smv.object_id, smv.daytime),1,-1)                                                                                                                               NET_VOLUME_BI           -- STIM_MTH_BOOKED.NET_VOLUME_BI
        ,stim.net_volume_bm*DECODE(across_node.node_object_id,Ecdp_Stream_Item.GetNode('FROM_NODE', smv.object_id, smv.daytime),1,-1)                                                                                                                               NET_VOLUME_BM           -- STIM_MTH_BOOKED.NET_VOLUME_BM
        ,stim.net_volume_sf*DECODE(across_node.node_object_id,Ecdp_Stream_Item.GetNode('FROM_NODE', smv.object_id, smv.daytime),1,-1)                                                                                                                               NET_VOLUME_SF           -- STIM_MTH_BOOKED.NET_VOLUME_SF
        ,stim.net_volume_nm*DECODE(across_node.node_object_id,Ecdp_Stream_Item.GetNode('FROM_NODE', smv.object_id, smv.daytime),1,-1)                                                                                                                               NET_VOLUME_NM           -- STIM_MTH_BOOKED.NET_VOLUME_NM
        ,stim.net_volume_sm*DECODE(across_node.node_object_id,Ecdp_Stream_Item.GetNode('FROM_NODE', smv.object_id, smv.daytime),1,-1)                                                                                                                               NET_VOLUME_SM           -- STIM_MTH_BOOKED.NET_VOLUME_SM
...
AND     b_si.stream_item_id = smv.object_id
