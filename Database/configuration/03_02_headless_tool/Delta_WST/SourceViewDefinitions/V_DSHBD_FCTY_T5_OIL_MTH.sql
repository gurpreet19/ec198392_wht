CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_DSHBD_FCTY_T5_OIL_MTH" ("MTH_FIRST_DAY", "MTH_OIL_SUM", "WELL_OBJECT_ID", "OBJECT_ID", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
-- File name: V_DSHBD_FCTY_T5_OIL_MTH.sql
-- View name: V_DSHBD_FCTY_T5_OIL_MTH
--
-- $Revision: 1.3 $
--
-- Purpose  : The monthly top 5 oil producers at facility
--
...
FROM V_DAY_ALLOC_OIL_SUM_MTH a, WELL_VERSION wv, PRODUCTION_FACILITY pf
