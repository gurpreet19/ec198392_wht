CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_DASH_DOC_VAL_BP_GC_BU" ("SORT_ORDER", "PERIOD_CHAR", "PERIOD_DATE", "DOC_VALUE", "FIN_CODE_TEXT", "GROUP_CURRENCY_CODE", "CO_NAME", "BU_NAME", "BU_ID", "CO_ID") AS 
  select
