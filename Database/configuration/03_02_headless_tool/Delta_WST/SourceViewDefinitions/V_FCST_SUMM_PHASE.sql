CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_FCST_SUMM_PHASE" ("FORECAST_ID", "SCENARIO_ID", "FROM_MONTH", "TO_MONTH", "SORT_ORDER", "PHASE_CODE", "PHASE_NAME", "POT_UNCONSTR", "CONSTR", "POT_CONSTR", "S1P_SHORTFALL", "S1U_SHORTFALL", "S2_SHORTFALL", "INT_CONSUMPT", "LOSSES", "COMPENSATION", "AVAIL_EXPORT", "INJ", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
...
GROUP BY a.FORECAST_ID, a.SCENARIO_ID, a.PHASE_CODE, a.PHASE_NAME,a.SORT_ORDER, m1.MTH, m2.MTH
