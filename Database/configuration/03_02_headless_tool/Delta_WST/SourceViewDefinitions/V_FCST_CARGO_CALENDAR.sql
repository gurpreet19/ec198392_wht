CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_FCST_CARGO_CALENDAR" ("DAYTIME", "BERTH_ID", "CARGO_NAME", "FORECAST_ID", "LIFTING_ACCOUNT_ID", "COUNT_BERTH", "DETAIL_CODE", "COLOR_CODE", "TEXTCOLOR_CODE", "TOOLTIP", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
...
SELECT cc.daytime AS DAYTIME,
       ...
       nvl(ue_Stor_Fcst_Lift_Nom.getCalendarTooltip(cc.daytime, cc.berth_id, cc.forecast_id), tt.cargo_name) AS TOOLTIP,
