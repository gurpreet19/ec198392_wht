CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_STRM_DAY_NR_WELL_DATA" ("OBJECT_ID", "DAYTIME", "DAILY_RELEASE", "NON_ROU_REL_OVERRIDE", "WELL_ID", "WELL_VOL_NR_OVERRIDE", "WELL_VOL_DAILY_RELEASE", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "RECORD_STATUS", "REV_NO", "REV_TEXT") AS 
  (
-------------------------------------------------------------------------------------
...
-- 12.09.2012 leongwen ECPD-21534: Fixed the error causes the incorrect value in WELL_VOL_NR_OVERRIDE attribute, added the optimer hint to use INDEX_JOIN,
