CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_FCST_RECOVERY_FACTOR" ("OBJECT_ID", "DAYTIME", "FORECAST_ID", "COMPONENT_NO", "COMPONENT_NAME", "FRAC", "CLASS_NAME", "SORT_ORDER", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REC_ID", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
