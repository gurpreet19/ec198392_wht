CREATE OR REPLACE FORCE EDITIONABLE VIEW "RV_VALUE_PART_RECEIVER_VAT" ("DOCUMENT_KEY", "VENDOR_ID", "LABEL", "RECEIVER", "GIVER", "GIVER1", "RECEIVER_ID", "VALUE_PART", "AMOUNT_RECEIVED", "TOTAL_INVOICED") AS 
  ...
  ecdp_document.concatVendorNames(cdc.document_key,'VAT') giver1,
  cdc.vat_receiver_id receiver_id,
  'VAT' value_part,
  clic.booking_vat_value amount_received,
  0 total_invoiced
