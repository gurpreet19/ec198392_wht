CREATE OR REPLACE FORCE EDITIONABLE VIEW "RV_CARGO_QTY_LINE_ITEM" ("LINE_ITEM_KEY", "FIELD_CODE", "CONT_LI_NAME", "PRODUCT_NAME", "DELIVERY_PT_NAME", "QTY1", "QTY2", "QTY3", "QTY4", "PRINT_UOM2_IND", "PRINT_UOM3_IND", "PRINT_UOM4_IND", "UOM1_DECIMAL_SEQ", "UOM2_DECIMAL_SEQ", "UOM3_DECIMAL_SEQ", "UOM4_DECIMAL_SEQ", "PRICE_DECIMAL_SEQ", "UOM1_CODE", "UOM2_CODE", "UOM3_CODE", "UOM4_CODE", "FREE_UNIT_QTY", "VAT_RATE", "UNIT_PRICE_100", "UNIT_PRICE_UNIT", "LI_BASED_TYPE", "PRICING_VALUE", "BOOKING_VALUE", "USE_CURRENCY_100_IND", "CURR_UOM", "CURR_FREE_UOM", "CURR_UOM_100", "CURR_FREE_UOM_100", "BOOKING_CURRENCY_CODE", "PRICING_CURRENCY_CODE", "LI_SORT_ORDER", "TRANS_SORT_ORDER", "DOCUMENT_KEY", "VENDOR_ID", "DISCHARGE_PORT_NAME", "LOADING_PORT_NAME", "CARGO_NAME", "CARRIER_ID", "BL_DATE", "UNIT_PRICE", "DAYTIME", "DOCUMENT_DATE", "MOVE_QTY_TO_VO_IND") AS 
  select max(lic.line_item_key) line_item_key,
       ...
       MAX(t.pricing_currency_code) pricing_currency_code,
