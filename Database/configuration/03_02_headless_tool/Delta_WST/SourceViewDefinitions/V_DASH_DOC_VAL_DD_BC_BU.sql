CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_DASH_DOC_VAL_DD_BC_BU" ("SORT_ORDER", "PERIOD_CHAR", "PERIOD_DATE", "DOC_VALUE", "FIN_CODE_TEXT", "CO_NAME", "BU_NAME", "BU_ID", "CO_ID", "BOOKING_CURRENCY_CODE", "BOOKING_CURRENCY_ID") AS 
  select
