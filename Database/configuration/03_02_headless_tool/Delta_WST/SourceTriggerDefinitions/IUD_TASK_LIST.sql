...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO  V_TASK_LIST(TASK_NO, TASK_DUE_DATE, TASK_TYPE, SORT_ORDER, DESCRIPTION, BUSINESS_FUNCTION_NO, TASK_PROCESS_ID, TASK_STATUS, RESPONSIBLE, COMMENTS, TASK_CLASS,  CREATED_BY, CREATED_DATE, LAST_UPDATED_BY, LAST_UPDATED_DATE, REV_NO, REV_TEXT, RECORD_STATUS, REC_ID)
