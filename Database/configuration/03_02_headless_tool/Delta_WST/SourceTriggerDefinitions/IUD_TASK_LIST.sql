CREATE OR REPLACE EDITIONABLE TRIGGER "IUD_TASK_LIST" 
...
DECLARE
  ...
  n_daytime  DATE := Ecdp_Timestamp.getCurrentSysdate;
...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO ECKERNEL_EC12SRC.V_TASK_LIST(TASK_NO, TASK_DUE_DATE, TASK_TYPE, SORT_ORDER, DESCRIPTION, BUSINESS_FUNCTION_NO, TASK_PROCESS_ID, TASK_STATUS, RESPONSIBLE, COMMENTS, TASK_CLASS,  CREATED_BY, CREATED_DATE, LAST_UPDATED_BY, LAST_UPDATED_DATE, REV_NO, REV_TEXT, RECORD_STATUS, REC_ID)
