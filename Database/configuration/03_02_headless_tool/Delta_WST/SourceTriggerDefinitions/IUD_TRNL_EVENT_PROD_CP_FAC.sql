...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO  V_OBJ_EVENT_DIM1_CP_TRAN_FAC(CLASS_NAME, OBJECT_ID, DIM1_KEY, DAYTIME, COMPONENT_NO, COMPONENT_NAME, FRAC, SORT_ORDER,  CREATED_BY, CREATED_DATE, LAST_UPDATED_BY, LAST_UPDATED_DATE, REV_NO, REV_TEXT, RECORD_STATUS, REC_ID)
  ...
  ELSE -- Deleting 
     ...
     DELETE FROM  V_OBJ_EVENT_DIM1_CP_TRAN_FAC
     WHERE CLASS_NAME='TRNL_EVENT_PROD_CP_FAC' AND OBJECT_ID= o_OBJECT_ID AND DIM1_KEY= o_PRODUCT_ID AND DAYTIME= o_DAYTIME AND COMPONENT_NO= o_COMPONENT_ID;
