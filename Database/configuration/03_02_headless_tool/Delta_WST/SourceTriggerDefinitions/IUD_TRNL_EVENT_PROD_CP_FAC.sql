CREATE OR REPLACE EDITIONABLE TRIGGER "IUD_TRNL_EVENT_PROD_CP_FAC" 
...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO ECKERNEL_EC12SRC.V_OBJ_EVENT_DIM1_CP_TRAN_FAC(CLASS_NAME, OBJECT_ID, DIM1_KEY, DAYTIME, COMPONENT_NO, COMPONENT_NAME, FRAC, SORT_ORDER,  CREATED_BY, CREATED_DATE, LAST_UPDATED_BY, LAST_UPDATED_DATE, REV_NO, REV_TEXT, RECORD_STATUS, REC_ID)
