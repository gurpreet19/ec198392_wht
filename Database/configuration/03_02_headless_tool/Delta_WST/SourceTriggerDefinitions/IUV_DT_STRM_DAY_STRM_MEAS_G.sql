CREATE OR REPLACE EDITIONABLE TRIGGER "IUV_DT_STRM_DAY_STRM_MEAS_G" 
 INSTEAD OF INSERT OR UPDATE OR DELETE ON TV_DT_STRM_DAY_STRM_MEAS_G
FOR EACH ROW
...
BEGIN
  ...
  IF n_LAST_TRANSFER IS NULL THEN Raise_Application_Error(-20103,'Missing value for LAST_TRANSFER'); END IF;
   ...
   IF INSERTING THEN
      ...
      INSERT INTO ECKERNEL_EC.V_TRANS_CONFIG(ATTRIBUTE, DATA_CLASS, PK_VAL_1, PK_ATTR_1, MAPPING_NO, SOURCE_ID, TAG_ID, TEMPLATE_CODE, FROM_UNIT, TO_UNIT, LAST_TRANSFER, ACTIVE, FROM_TIME, DESCRIPTION, TO_TIME, CREATED_BY, CREATED_DATE, LAST_UPDATED_BY, LAST_UPDATED_DATE, REV_NO, REV_TEXT, RECORD_STATUS)
