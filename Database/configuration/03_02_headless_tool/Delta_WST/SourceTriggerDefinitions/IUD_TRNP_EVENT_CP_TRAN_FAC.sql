...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO ECKERNEL_EC.V_OBJ_EVENT_CP_TRAN_FACTOR(CLASS_NAME, OBJECT_ID, DAYTIME, COMPONENT_NO, COMPONENT_NAME, FRAC, SORT_ORDER,  CREATED_BY, CREATED_DATE, LAST_UPDATED_BY, LAST_UPDATED_DATE, REV_NO, REV_TEXT, RECORD_STATUS, REC_ID)
