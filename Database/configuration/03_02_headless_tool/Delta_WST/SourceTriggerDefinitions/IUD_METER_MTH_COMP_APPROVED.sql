CREATE OR REPLACE EDITIONABLE TRIGGER "IUD_METER_MTH_COMP_APPROVED" 
...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO ECKERNEL_EC12SRC.V_METER_COMPOSITION(ANALYSIS_NO, OBJECT_ID, DAYTIME, ANALYSIS_STATUS, COMPONENT_NO, COMPONENT_NAME, WT_PCT, SORT_ORDER, ANALYSIS_TYPE,  CREATED_BY, CREATED_DATE, LAST_UPDATED_BY, LAST_UPDATED_DATE, REV_NO, REV_TEXT, RECORD_STATUS)
