CREATE OR REPLACE EDITIONABLE TRIGGER "AIU_STIM_MTH_BOOKED" 
...
begin
    ...
    IF EcTrgPck_stim_mth_booked.ptab IS NOT NULL THEN

      -- empty the table
      EcTrgPck_stim_mth_booked.ptab.DELETE;

   END IF;

end AIU_STIM_MTH_BOOKED;
