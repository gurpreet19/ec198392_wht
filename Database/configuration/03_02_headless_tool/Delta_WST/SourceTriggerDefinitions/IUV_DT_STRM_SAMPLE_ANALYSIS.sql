CREATE OR REPLACE EDITIONABLE TRIGGER "IUV_DT_STRM_SAMPLE_ANALYSIS" 
 INSTEAD OF INSERT OR UPDATE OR DELETE ON TV_DT_STRM_SAMPLE_ANALYSIS
FOR EACH ROW
...
DECLARE
  ...
  o_SOURCE_ID VARCHAR2(4000) := :OLD.SOURCE_ID;
  n_TAG_ID VARCHAR2(4000) := EcDB_Utils.ConditionNVL(NOT Updating('TAG_ID'),:NEW.TAG_ID,:OLD.TAG_ID);
  o_TAG_ID VARCHAR2(4000) := :OLD.TAG_ID;
  n_TEMPLATE_CODE VARCHAR2(4000) := EcDB_Utils.ConditionNVL(NOT Updating('TEMPLATE_CODE'),:NEW.TEMPLATE_CODE,:OLD.TEMPLATE_CODE);
  o_TEMPLATE_CODE VARCHAR2(4000) := :OLD.TEMPLATE_CODE;
  n_PK_ATTR_2 VARCHAR2(4000) := EcDB_Utils.ConditionNVL(NOT Updating('PK_ATTR_2'),:NEW.PK_ATTR_2,:OLD.PK_ATTR_2);
  n_PK_VAL_2 VARCHAR2(4000) := EcDB_Utils.ConditionNVL(NOT Updating('PK_VAL_2'),:NEW.PK_VAL_2,:OLD.PK_VAL_2);
  n_PK_ATTR_3 VARCHAR2(4000) := EcDB_Utils.ConditionNVL(NOT Updating('PK_ATTR_3'),:NEW.PK_ATTR_3,:OLD.PK_ATTR_3);
  n_PK_VAL_3 VARCHAR2(4000) := EcDB_Utils.ConditionNVL(NOT Updating('PK_VAL_3'),:NEW.PK_VAL_3,:OLD.PK_VAL_3);
  n_PK_ATTR_4 VARCHAR2(4000) := EcDB_Utils.ConditionNVL(NOT Updating('PK_ATTR_4'),:NEW.PK_ATTR_4,:OLD.PK_ATTR_4);
  n_PK_VAL_4 VARCHAR2(4000) := EcDB_Utils.ConditionNVL(NOT Updating('PK_VAL_4'),:NEW.PK_VAL_4,:OLD.PK_VAL_4);
  n_PK_ATTR_5 VARCHAR2(4000) := EcDB_Utils.ConditionNVL(NOT Updating('PK_ATTR_5'),:NEW.PK_ATTR_5,:OLD.PK_ATTR_5);
  n_PK_VAL_5 VARCHAR2(4000) := EcDB_Utils.ConditionNVL(NOT Updating('PK_VAL_5'),:NEW.PK_VAL_5,:OLD.PK_VAL_5);
  n_PK_ATTR_6 VARCHAR2(4000) := EcDB_Utils.ConditionNVL(NOT Updating('PK_ATTR_6'),:NEW.PK_ATTR_6,:OLD.PK_ATTR_6);
  n_PK_VAL_6 VARCHAR2(4000) := EcDB_Utils.ConditionNVL(NOT Updating('PK_VAL_6'),:NEW.PK_VAL_6,:OLD.PK_VAL_6);
...
BEGIN
  ...
  IF n_PK_ATTR_2 IS NULL THEN Raise_Application_Error(-20103,'Missing value for PK_ATTR_2'); END IF;
  IF n_PK_VAL_2 IS NULL THEN Raise_Application_Error(-20103,'Missing value for PK_VAL_2'); END IF;
  IF n_PK_ATTR_3 IS NULL THEN Raise_Application_Error(-20103,'Missing value for PK_ATTR_3'); END IF;
  IF n_PK_VAL_3 IS NULL THEN Raise_Application_Error(-20103,'Missing value for PK_VAL_3'); END IF;
  IF n_PK_ATTR_4 IS NULL THEN Raise_Application_Error(-20103,'Missing value for PK_ATTR_4'); END IF;
  IF n_PK_VAL_4 IS NULL THEN Raise_Application_Error(-20103,'Missing value for PK_VAL_4'); END IF;
  IF n_PK_ATTR_5 IS NULL THEN Raise_Application_Error(-20103,'Missing value for PK_ATTR_5'); END IF;
  IF n_PK_VAL_5 IS NULL THEN Raise_Application_Error(-20103,'Missing value for PK_VAL_5'); END IF;
  IF n_LAST_TRANSFER IS NULL THEN Raise_Application_Error(-20103,'Missing value for LAST_TRANSFER'); END IF;

   IF INSERTING THEN

      INSERT INTO ECKERNEL_EC12SRC.V_TRANS_CONFIG(ATTRIBUTE, DATA_CLASS, PK_VAL_1, PK_ATTR_1, MAPPING_NO, SOURCE_ID, TAG_ID, TEMPLATE_CODE, PK_ATTR_2, PK_VAL_2, PK_ATTR_3, PK_VAL_3, PK_ATTR_4, PK_VAL_4, PK_ATTR_5, PK_VAL_5, PK_ATTR_6, PK_VAL_6, FROM_UNIT, TO_UNIT, LAST_TRANSFER, ACTIVE, FROM_TIME, TO_TIME, CREATED_BY, CREATED_DATE, LAST_UPDATED_BY, LAST_UPDATED_DATE, REV_NO, REV_TEXT, RECORD_STATUS)
      VALUES(n_ATTRIBUTE, n_DATA_CLASS, n_PK_VAL_1, n_PK_ATTR_1, n_MAPPING_NO, n_SOURCE_ID, n_TAG_ID, n_TEMPLATE_CODE, n_PK_ATTR_2, n_PK_VAL_2, n_PK_ATTR_3, n_PK_VAL_3, n_PK_ATTR_4, n_PK_VAL_4, n_PK_ATTR_5, n_PK_VAL_5, n_PK_ATTR_6, n_PK_VAL_6, n_FROM_UNIT, n_TO_UNIT, n_LAST_TRANSFER, n_ACTIVE, n_FROM_TIME, n_TO_TIME, n_CREATED_BY, n_CREATED_DATE, n_LAST_UPDATED_BY, n_LAST_UPDATED_DATE, n_REV_NO, n_REV_TEXT, n_RECORD_STATUS);
   ELSIF UPDATING THEN
      ...
      UPDATE ECKERNEL_EC12SRC.V_TRANS_CONFIG
      SET ATTRIBUTE = n_ATTRIBUTE, DATA_CLASS = n_DATA_CLASS, PK_VAL_1 = n_PK_VAL_1, PK_ATTR_1 = n_PK_ATTR_1, MAPPING_NO = n_MAPPING_NO, SOURCE_ID = n_SOURCE_ID, TAG_ID = n_TAG_ID, TEMPLATE_CODE = n_TEMPLATE_CODE, PK_ATTR_2 = n_PK_ATTR_2, PK_VAL_2 = n_PK_VAL_2, PK_ATTR_3 = n_PK_ATTR_3, PK_VAL_3 = n_PK_VAL_3, PK_ATTR_4 = n_PK_ATTR_4, PK_VAL_4 = n_PK_VAL_4, PK_ATTR_5 = n_PK_ATTR_5, PK_VAL_5 = n_PK_VAL_5, PK_ATTR_6 = n_PK_ATTR_6, PK_VAL_6 = n_PK_VAL_6, FROM_UNIT = n_FROM_UNIT, TO_UNIT = n_TO_UNIT, LAST_TRANSFER = n_LAST_TRANSFER, ACTIVE = n_ACTIVE, FROM_TIME = n_FROM_TIME, TO_TIME = n_TO_TIME, CREATED_BY = n_CREATED_BY, CREATED_DATE = n_CREATED_DATE , LAST_UPDATED_BY = n_LAST_UPDATED_BY,LAST_UPDATED_DATE = n_LAST_UPDATED_DATE ,REV_NO = n_rev_no, REV_TEXT = n_REV_TEXT,RECORD_STATUS = n_RECORD_STATUS
      WHERE MAPPING_NO= o_MAPPING_NO AND SOURCE_ID= o_SOURCE_ID AND TAG_ID= o_TAG_ID AND TEMPLATE_CODE= o_TEMPLATE_CODE;

   ELSE -- deleting

     DELETE FROM ECKERNEL_EC12SRC.V_TRANS_CONFIG
     WHERE MAPPING_NO= o_MAPPING_NO AND SOURCE_ID= o_SOURCE_ID AND TAG_ID= o_TAG_ID AND TEMPLATE_CODE= o_TEMPLATE_CODE;
