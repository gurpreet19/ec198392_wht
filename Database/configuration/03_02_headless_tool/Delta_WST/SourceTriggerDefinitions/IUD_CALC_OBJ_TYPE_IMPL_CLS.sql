...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO ECKERNEL_EC.V_CALC_OBJ_TYPE_IMPL_CLS(OBJECT_ID, OBJECT_TYPE_CODE, EXCLUDED_IND, CLASS_NAME, CLASS_LABEL,  CREATED_BY, CREATED_DATE, LAST_UPDATED_BY, LAST_UPDATED_DATE, REV_NO, REV_TEXT, RECORD_STATUS)
  ...
  ELSE -- Deleting 
     ...
     DELETE FROM ECKERNEL_EC.V_CALC_OBJ_TYPE_IMPL_CLS
     WHERE OBJECT_ID= o_OBJECT_ID AND OBJECT_TYPE_CODE= o_OBJECT_TYPE_CODE AND EXCLUDED_IND= o_EXCLUDED_IND AND CLASS_NAME= o_CLASS_NAME AND CLASS_LABEL= o_CLASS_LABEL;
