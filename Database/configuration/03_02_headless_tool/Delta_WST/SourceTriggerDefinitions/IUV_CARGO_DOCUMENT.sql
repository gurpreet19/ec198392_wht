...
BEGIN
  ...
  IF n_DOC_CODE IS NULL THEN Raise_Application_Error(-20103,'Missing value for DOC_CODE'); END IF;
   ...
   IF INSERTING THEN
      ...
      INSERT INTO  V_CARGO_DOCUMENT(REPORT_NO, PARCEL_NO, DOC_CODE, RECEIVER, ORIGINAL, RUN_DATE, UPLOAD, FORMAT_CODE, CREATED_BY, CREATED_DATE, LAST_UPDATED_BY, LAST_UPDATED_DATE, REV_NO, REV_TEXT, RECORD_STATUS)
