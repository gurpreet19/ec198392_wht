...
BEGIN
  ...
  IF n_DAYTIME < EcDp_System_Constants.Earliest_date THEN  Raise_Application_Error(-20104,'Cannot set DAYTIME before system earliest date: 01.01.1900'); END IF;
   ...
   IF INSERTING THEN
      ...
      INSERT INTO ECKERNEL_EC12SRC.V_MSG_GENERATION(TO_PARAM_SET, MSG_TYPE_ID, MESSAGE_TYPE, MESSAGE_DISTRIBUTION_NO, FREQUENCY, DAYTIME, MESSAGE_NAME, CREATED_BY, CREATED_DATE, LAST_UPDATED_BY, LAST_UPDATED_DATE, REV_NO, REV_TEXT, RECORD_STATUS)
   ...
   END IF;
      ...
      UPDATE ECKERNEL_EC12SRC.V_MSG_GENERATION
   ...
   ELSE -- deleting
     ...
     DELETE FROM ECKERNEL_EC12SRC.V_MSG_GENERATION
     WHERE TO_PARAM_SET= o_TO_PARAM_SET;
