CREATE OR REPLACE EDITIONABLE TRIGGER "AIU_STIM_MTH_ACTUAL" 
...
begin
    ...
    IF EcTrgPck_stim_mth_actual.ptab IS NOT NULL THEN

      -- empty the table
      EcTrgPck_stim_mth_actual.ptab.DELETE;

   END IF;

end AIU_STIM_MTH_ACTUAL;
