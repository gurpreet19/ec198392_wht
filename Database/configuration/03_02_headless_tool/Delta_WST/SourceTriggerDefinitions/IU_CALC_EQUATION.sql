CREATE OR REPLACE EDITIONABLE TRIGGER "IU_CALC_EQUATION" 
BEFORE INSERT OR UPDATE ON CALC_EQUATION
FOR EACH ROW
DECLARE
    lc_iterations  CLOB;
    lc_condition   CLOB;
...
BEGIN
    ...
    IF Inserting THEN
      IF :new.seq_no IS NULL THEN
         EcDp_System_Key.assignNextNumber('CALC_EQUATION', :new.seq_no);
      END IF;
      -- Initialise CLOBs
