...
BEGIN
    ...
    IF Inserting THEN
      ...
      EcDp_Timestamp_Utils.syncUtcDate('PIPELINE', :NEW.object_id, :NEW.utc_daytime, :NEW.time_zone, :NEW.daytime, :NEW.summer_time);
      EcDp_Timestamp_Utils.setProductionDay('PIPELINE', :NEW.object_id, :NEW.utc_daytime, :NEW.production_day);
