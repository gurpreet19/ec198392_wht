CREATE OR REPLACE EDITIONABLE TRIGGER "IU_NOMPNT_DAY_NOMINATION" 
BEFORE INSERT OR UPDATE ON NOMPNT_DAY_NOMINATION
FOR EACH ROW
BEGIN
    IF Inserting THEN
      ...
      IF :new.NOMINATION_SEQ IS NULL THEN
         EcDp_System_Key.assignNextNumber('NOMPNT_DAY_NOMINATION', :new.NOMINATION_SEQ);
      END IF;
