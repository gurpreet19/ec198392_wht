...
BEGIN
  ...
  IF n_FUNCTIONAL_AREA_ID IS NULL THEN Raise_Application_Error(-20103,'Missing value for FUNCTIONAL_AREA_ID'); END IF;
   ...
   IF INSERTING THEN
      ...
      INSERT INTO  V_SCHEDULE(NAME, DESCRIPTION, PIN_TO, enabled_ind, SCHEDULE_NO, Schedule_group, CREATED_BY, CREATED_DATE, LAST_UPDATED_BY, LAST_UPDATED_DATE, REV_NO, REV_TEXT, RECORD_STATUS, REC_ID)
