CREATE OR REPLACE EDITIONABLE TRIGGER "IUD_V_ACTION_PARAM_VALUE" 
...
END IF;
   ...
   VALUES
      (lv2_operation, lv2_last_updated_by, Ecdp_Timestamp.getCurrentSysdate, EcDp_User_Session.getUserSessionParameter('JN_NOTES')
