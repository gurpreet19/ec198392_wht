...
BEGIN
 ...
 IF INSERTING THEN
  ...
  ELSE -- Deleting 
     ...
     DELETE FROM ECKERNEL_EC.V_OBJECT_FLUID_ANALYSIS
     WHERE OBJECT_ID= o_OBJECT_ID AND DAYTIME= o_DAYTIME AND ANALYSIS_TYPE= o_ANALYSIS_TYPE AND SAMPLING_METHOD= o_SAMPLING_METHOD AND PHASE= o_PHASE;
