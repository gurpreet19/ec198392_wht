...
BEGIN
 ...
 IF INSERTING THEN
  ...
  -- Start Insert relation block ---------------------------------------
    ...
    INSERT INTO  V_FLUID_ANALYSIS_COMP(OBJECT_ID, DAYTIME, ANALYSIS_TYPE, SAMPLING_METHOD, PHASE, ANALYSIS_NO, OBJECT_CLASS_NAME, COMPONENT_NO, WT_PCT, MOL_PCT,  CREATED_BY, CREATED_DATE, LAST_UPDATED_BY, LAST_UPDATED_DATE, REV_NO, REV_TEXT, RECORD_STATUS)
  ...
  ELSE -- Deleting 
     ...
     DELETE FROM  V_FLUID_ANALYSIS_COMP
     WHERE OBJECT_ID= o_OBJECT_ID AND DAYTIME= o_DAYTIME AND ANALYSIS_TYPE= o_ANALYSIS_TYPE AND SAMPLING_METHOD= o_SAMPLING_METHOD AND PHASE= o_PHASE AND COMPONENT_NO= o_COMPONENT_NO;
