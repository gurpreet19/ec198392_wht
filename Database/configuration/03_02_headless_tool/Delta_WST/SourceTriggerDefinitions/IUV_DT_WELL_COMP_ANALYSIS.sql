CREATE OR REPLACE EDITIONABLE TRIGGER "IUV_DT_WELL_COMP_ANALYSIS" 
 INSTEAD OF INSERT OR UPDATE OR DELETE ON TV_DT_WELL_COMP_ANALYSIS
FOR EACH ROW
...
BEGIN
  ...
  IF n_LAST_TRANSFER IS NULL THEN Raise_Application_Error(-20103,'Missing value for LAST_TRANSFER'); END IF;
   ...
   ELSIF UPDATING THEN
      ...
      SET ATTRIBUTE = n_ATTRIBUTE, DATA_CLASS = n_DATA_CLASS, PK_VAL_1 = n_PK_VAL_1, PK_ATTR_1 = n_PK_ATTR_1, MAPPING_NO = n_MAPPING_NO, SOURCE_ID = n_SOURCE_ID, TAG_ID = n_TAG_ID, TEMPLATE_CODE = n_TEMPLATE_CODE, PK_ATTR_2 = n_PK_ATTR_2, PK_VAL_2 = n_PK_VAL_2, PK_ATTR_3 = n_PK_ATTR_3, PK_VAL_3 = n_PK_VAL_3, PK_ATTR_4 = n_PK_ATTR_4, PK_VAL_4 = n_PK_VAL_4, PK_ATTR_5 = n_PK_ATTR_5, PK_VAL_5 = n_PK_VAL_5, FROM_UNIT = n_FROM_UNIT, TO_UNIT = n_TO_UNIT, LAST_TRANSFER = n_LAST_TRANSFER, ACTIVE = n_ACTIVE, FROM_TIME = n_FROM_TIME, TO_TIME = n_TO_TIME, CREATED_BY = n_CREATED_BY, CREATED_DATE = n_CREATED_DATE , LAST_UPDATED_BY = n_LAST_UPDATED_BY,LAST_UPDATED_DATE = n_LAST_UPDATED_DATE ,REV_NO = n_rev_no, REV_TEXT = n_REV_TEXT,RECORD_STATUS = n_RECORD_STATUS
