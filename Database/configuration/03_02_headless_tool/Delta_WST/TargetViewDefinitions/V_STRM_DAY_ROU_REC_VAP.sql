CREATE OR REPLACE FORCE VIEW "V_STRM_DAY_ROU_REC_VAP" ("ASSET_ID", "OBJECT_ID", "ASSET_CLASS", "DAYTIME", "PARENT_GROUP_TYPE", "START_DATE", "RUN_HOURS", "RECOVERY_CAPACITY", "SEQUENCE", "SHARES", "PROCESS_UNIT_RUN", "ROUTINE", "PARENT_OBJECT_ID", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
-------------------------------------------------------------------------------------
