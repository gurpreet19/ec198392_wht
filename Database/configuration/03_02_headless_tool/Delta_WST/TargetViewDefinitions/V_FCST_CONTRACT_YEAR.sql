CREATE OR REPLACE FORCE VIEW "V_FCST_CONTRACT_YEAR" ("DAYTIME", "CLASS_NAME", "OBJECT_ID", "FORECAST_ID", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
---------------------------------------------------------------------------------------------------
...
-- 	--------- 	--------  	----------------------------------------------------------------------------
--	16.12.2013 	muhammah	ECPD-26389: New business function: Forecast Contract KPI Monitoring
----------------------------------------------------------------------------------------------------
select
