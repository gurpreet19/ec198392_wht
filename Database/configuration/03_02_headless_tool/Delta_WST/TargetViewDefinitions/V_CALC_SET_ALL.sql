CREATE OR REPLACE FORCE VIEW "V_CALC_SET_ALL" ("OBJECT_ID", "DAYTIME", "CALC_CONTEXT_ID", "CALC_SET_NAME", "CALC_SET_TYPE_CODE", "CALC_SET_TYPE_TEXT", "CALC_OBJECT_TYPE_CODE", "CALC_OBJECT_TYPE_NAME", "SCOPE_NAME", "INHERITED_FROM_ID", "INHERITED_FROM_NAME", "DESCRIPTION", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
--
...
select s.object_id,
       ...
       NVL(ec_calc_object_type.label_override(s.calc_context_id, s.calc_object_type_code), Nvl(Ec_Class.Label(s.calc_object_type_code),s.calc_object_type_code)) calc_object_type_name,
       'Local' as scope_name,
       NULL as inherited_from_id,
       '' as inherited_from_name,
