...
SELECT f.object_id,
  ...
  FROM LIFT_ACC_SUB_DAY_FORECAST f,
       (SELECT n.object_id,
               NVL(ecbp_storage_lift_nomination.calcSplitQty(sl.parcel_no, sl.company_id, sl.lifting_account_id, sn.production_day, nvl(ecbp_storage_lift_nomination.getLiftedVolSubDay(n.parcel_no, sn.daytime, sn.summer_time), sn.grs_vol_nominated)),
               ...
               NVL(ecbp_storage_lift_nomination.calcSplitQty(sl.parcel_no, sl.company_id, sl.lifting_account_id, sn.production_day, nvl(ecbp_storage_lift_nomination.getLiftedVolSubDay(n.parcel_no, sn.daytime, sn.summer_time, 1), sn.grs_vol_nominated2)),
               ...
               NVL(ecbp_storage_lift_nomination.calcSplitQty(sl.parcel_no, sl.company_id, sl.lifting_account_id, sn.production_day, nvl(ecbp_storage_lift_nomination.getLiftedVolSubDay(n.parcel_no, sn.daytime, sn.summer_time, 2), sn.grs_vol_nominated3)),
         ...
         FROM storage_lift_nomination n, cargo_transport t, storage_lift_nom_split sl, stor_sub_day_lift_nom sn
