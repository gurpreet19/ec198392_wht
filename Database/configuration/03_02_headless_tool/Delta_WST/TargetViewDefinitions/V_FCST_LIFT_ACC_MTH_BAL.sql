CREATE OR REPLACE FORCE VIEW "V_FCST_LIFT_ACC_MTH_BAL" ("OBJECT_ID", "DAYTIME", "FORECAST_ID", "BALANCE_QTY", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
