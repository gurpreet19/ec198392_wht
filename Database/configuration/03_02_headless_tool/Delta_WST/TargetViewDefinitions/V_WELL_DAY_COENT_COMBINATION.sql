CREATE OR REPLACE FORCE VIEW "V_WELL_DAY_COENT_COMBINATION" ("OBJECT_ID", "DAYTIME", "COMMERCIAL_ENTITY_ID", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
SELECT DISTINCT
	w.object_id,
