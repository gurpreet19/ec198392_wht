CREATE OR REPLACE FORCE VIEW "V_DAILY_DEFERMENT_SUMMARY" ("DAYTIME", "CLASS_NAME", "OBJECT_ID", "SUMMARY_TYPE", "SORT_ORDER", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT", "OIL", "GAS", "COND", "WATER_INJ", "GAS_INJ", "STEAM_INJ", "WATER", "OIL_MASS", "GAS_MASS", "WATER_INJ_MASS", "GAS_INJ_MASS", "WATER_MASS", "COND_MASS", "STEAM_INJ_MASS", "GAS_ENERGY") AS 
  SELECT
sd.daytime,
o.class_name,
o.object_id,
