CREATE OR REPLACE FORCE VIEW "V_CURVE" ("PERF_CURVE_ID", "CURVE_OBJECT_ID", "DAYTIME", "CURVE_PURPOSE", "CURVE_PARAMETER_CODE", "PERF_CURVE_STATUS", "PLANE_INTERSECT_CODE", "POTEN_2ND_VALUE", "POTEN_3RD_VALUE", "COMMENTS", "CGR", "GOR", "MAX_ALLOW_WH_PRESS", "MIN_ALLOW_WH_PRESS", "WGR", "WATERCUT_PCT", "CLASS_NAME", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT", "APPROVAL_BY", "APPROVAL_DATE", "APPROVAL_STATE", "REC_ID", "CURVE_Z_VALUE", "CURVE_PHASE", "CURVE_FORMULA_TYPE", "CURVE_C0", "CURVE_C1", "CURVE_C2", "CURVE_C3", "CURVE_Y_VALID_FROM", "CURVE_Y_VALID_TO", "CURVE_COMMENTS", "CURVE_VALUE_1", "CURVE_VALUE_2", "CURVE_VALUE_3", "CURVE_VALUE_4", "CURVE_VALUE_5", "CURVE_VALUE_6", "CURVE_VALUE_7", "CURVE_VALUE_8", "CURVE_VALUE_9", "CURVE_VALUE_10", "CURVE_TEXT_1", "CURVE_TEXT_2", "CURVE_TEXT_3", "CURVE_TEXT_4", "CURVE_RECORD_STATUS", "CURVE_CREATED_BY", "CURVE_CREATED_DATE", "CURVE_LAST_UPDATED_BY", "CURVE_LAST_UPDATED_DATE", "CURVE_REV_NO", "CURVE_REV_TEXT", "CURVE_APPROVAL_BY", "CURVE_APPROVAL_DATE", "CURVE_APPROVAL_STATE", "CURVE_REC_ID") AS 
  (
-------------------------------------------------------------------------------------
--  v_curve
--
