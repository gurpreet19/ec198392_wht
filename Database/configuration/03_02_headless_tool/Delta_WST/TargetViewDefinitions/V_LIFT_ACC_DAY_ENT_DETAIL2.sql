...
SELECT la.object_id,
  ...
  FROM LIFT_ACC_DAY_FORECAST la,
       (SELECT n.object_id,
          ...
          FROM storage_lift_nomination n, cargo_transport t, storage_lift_nom_split sl,
