CREATE OR REPLACE FORCE VIEW "V_STREAM_DAY_COMBINATION" ("OBJECT_ID", "DAYTIME", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
-------------------------------------------------------------------------------------
...
--  limmmchu – 2012-06-25  Jira 21359 : Added nvl() funtion in strm_meter_freq
-------------------------------------------------------------------------------------
SELECT s.object_id,
       sd.daytime,
       s.record_status,
