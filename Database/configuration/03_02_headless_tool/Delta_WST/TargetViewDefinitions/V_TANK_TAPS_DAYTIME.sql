CREATE OR REPLACE FORCE VIEW "V_TANK_TAPS_DAYTIME" ("DAYTIME", "OBJECT_ID", "END_DATE", "TANK_HEIGHT", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
------------------------------------------------------------------------------------
--  v_tank_taps_daytime
--
