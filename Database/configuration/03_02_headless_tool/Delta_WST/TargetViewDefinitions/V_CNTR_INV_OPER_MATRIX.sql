CREATE OR REPLACE FORCE VIEW "V_CNTR_INV_OPER_MATRIX" ("OBJECT_ID", "DAYTIME", "CONTRACT_ID", "LOCATION_ID", "INVENTORY_TYPE", "DEBIT_QTY", "CREDIT_QTY", "TRANSACTION_SEQ", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
...
-- ---------- ----      --------------------------------------------------------------------------------
-- 13-08-2012 leeeewei  Created view for daily contract inventory matrix
----------------------------------------------------------------------------------------------------
select d.object_id,
       d.daytime,
       c.contract_id,
