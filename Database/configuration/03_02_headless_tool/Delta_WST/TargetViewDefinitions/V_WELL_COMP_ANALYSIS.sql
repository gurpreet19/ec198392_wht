CREATE OR REPLACE FORCE VIEW "V_WELL_COMP_ANALYSIS" ("OBJECT_ID", "DAYTIME", "PHASE", "ANALYSIS_TYPE", "COMPONENT_NO", "WT_PCT", "MOL_PCT", "MEAS_MOL_WT", "MEAS_SPECIFIC_GRAVITY", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
-------------------------------------------------------------------------------------
