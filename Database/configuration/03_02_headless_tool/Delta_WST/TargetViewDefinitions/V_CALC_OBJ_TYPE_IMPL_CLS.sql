CREATE OR REPLACE FORCE VIEW "V_CALC_OBJ_TYPE_IMPL_CLS" ("OBJECT_ID", "OBJECT_TYPE_CODE", "EXCLUDED_IND", "CLASS_NAME", "CLASS_LABEL", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
--
