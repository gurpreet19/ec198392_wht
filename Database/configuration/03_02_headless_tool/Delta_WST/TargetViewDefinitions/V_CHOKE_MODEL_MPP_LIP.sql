CREATE OR REPLACE FORCE VIEW "V_CHOKE_MODEL_MPP_LIP" ("OBJECT_ID", "DAYTIME", "LIP_INC", "MPP_QTY", "MPP_LIP", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
