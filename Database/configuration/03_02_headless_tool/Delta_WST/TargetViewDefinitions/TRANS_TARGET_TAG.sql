...
SELECT --'EC',
        ...
        T.TARGET_FUNCTION,
        T.TARGET_DATATYPE,
        Ec_Class_Db_Mapping.db_object_name(M.DATA_CLASS),
        transfer_web_util.getPrimKey(m.mapping_no),
        transfer_web_util.getPrimKeyValues(m.mapping_no),
        Ec_Class_Attr_Db_Mapping.db_sql_syntax(M.DATA_CLASS,M.ATTRIBUTE),
        T.TARGET_DATETIME,
        T.TARGET_WHERE,
        T.USE_DAYTIME,
        T.USE_SUMMERTIME,
        ...
        Ec_Class.owner_class_name(m.data_class),
        'INSERT',
        NULL,
        NULL,
        NULL,
