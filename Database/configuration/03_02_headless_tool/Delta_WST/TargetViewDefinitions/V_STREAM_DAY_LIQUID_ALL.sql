CREATE OR REPLACE FORCE VIEW "V_STREAM_DAY_LIQUID_ALL" ("DAYTIME", "OBJECT_ID", "OBJECT_CODE", "GRS_VOL", "GRS_MASS", "NET_VOL", "NET_MASS", "STD_DENSITY", "ALLOC_NET_VOL", "ALLOC_NET_MASS", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
-------------------------------------------------------------------------------------
