CREATE OR REPLACE FORCE VIEW "V_CARGO_DOCUMENT" ("REPORT_NO", "FORMAT_CODE", "PARCEL_NO", "DOC_CODE", "RECEIVER", "ORIGINAL", "RUN_DATE", "UPLOAD", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
...
WHERE 			r.report_no = p.report_no
          		and p.parameter_name = 'PARCEL_NO'
