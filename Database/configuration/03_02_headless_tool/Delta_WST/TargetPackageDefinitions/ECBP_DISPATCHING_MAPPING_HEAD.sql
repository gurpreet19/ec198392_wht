...
******************************************************************/
    ...
    PRAGMA RESTRICT_REFERENCES(getCellValue, WNDS, WNPS, RNPS);
    ...
    PRAGMA RESTRICT_REFERENCES(getColumnValueByName, WNDS, WNPS, RNPS);
    ...
    PRAGMA RESTRICT_REFERENCES(getConvertedValue, WNDS, WNPS, RNPS);
    ...
    PRAGMA RESTRICT_REFERENCES(getCellValueInViewUnit, WNDS, WNPS, RNPS);
