...
PRAGMA RESTRICT_REFERENCES(calcFlowlineTypeFracDay, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES(getFlwlEquipmentId, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES(getFlowlineType, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES (calcPflwUptime, WNPS, RNPS, WNDS);
...
PRAGMA RESTRICT_REFERENCES (calcIflwUptime, WNPS, RNPS, WNDS);
