...
** 9.3      29.08.2007  kaurrnar  ECPD6294: Added PRAGMA RESTRICT_REFERENCES to getAttribute and getAttributeValue function
*****************************************************************/
...
FUNCTION getAttribute (
   ...
   p_daytime        DATE)
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES (getAttribute, WNDS, WNPS, RNPS);
