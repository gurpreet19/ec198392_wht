...
RETURN VARCHAR2;
PRAGMA RESTRICT_REFERENCES(getAttributeParentTable, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES(get_table_colums, WNDS, WNPS, RNPS);

FUNCTION table_exist(p_table_name VARCHAR2) RETURN BOOLEAN;
PRAGMA RESTRICT_REFERENCES(table_exist, WNDS, WNPS, RNPS);

FUNCTION has_table_constraint(p_table_name VARCHAR2, p_constraint_type VARCHAR2) RETURN BOOLEAN;
PRAGMA RESTRICT_REFERENCES(has_table_constraint, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES(getFunctionName, WNDS, WNPS, RNPS);
