...
PROCEDURE updateLiftingQty(p_parcel_no NUMBER, p_old_qty NUMBER, p_new_qty NUMBER, p_old_date DATE, p_new_date DATE, p_nom_type VARCHAR2, p_prod_meas_no NUMBER DEFAULT NULL, p_user VARCHAR2 DEFAULT NULL);
