...
** 30.07.2012  abdulmaw  ECPD-21630: Updated function evaluateFormula to fix Monthly Stream calculation
** 22.10.2013  musthram  ECPD-25803: Updated function evaluateFormula to fix formula calculation for Monthly
*****************************************************************/
...
BEGIN
	...
	-- Find this streams strm_meter_freq and alloc_data_freq
