...
FUNCTION findDiluentRate(p_result_no eqpm_result.result_no%TYPE,
                      p_object_id VARCHAR2,
                      p_daytime DATE)
RETURN NUMBER;

FUNCTION findWellWetGasRate(p_result_no eqpm_result.result_no%TYPE,
                      p_object_id VARCHAR2,
                      p_daytime DATE)
RETURN NUMBER;

FUNCTION findNetRate(p_result_no eqpm_result.result_no%TYPE,
				             p_phase VARCHAR2,
				             p_object_id VARCHAR2,
				             p_daytime DATE)
RETURN NUMBER;
...
FUNCTION findStdNetRate(p_result_no eqpm_result.result_no%TYPE,
						         p_phase VARCHAR2,
						         p_object_id VARCHAR2,
						         p_daytime DATE)
RETURN NUMBER;

FUNCTION findGrsLiqVolume(p_result_no eqpm_result.result_no%TYPE,
						         p_object_id VARCHAR2,
						         p_daytime DATE)
RETURN NUMBER;

FUNCTION findGrsGasVolume(p_result_no eqpm_result.result_no%TYPE,
						         p_object_id VARCHAR2,
						         p_daytime DATE)
RETURN NUMBER;

FUNCTION findGrsGasLiftVolume(p_result_no eqpm_result.result_no%TYPE,
						         p_object_id VARCHAR2,
						         p_daytime DATE)
RETURN NUMBER;

FUNCTION findGrsWaterVolume(p_result_no eqpm_result.result_no%TYPE,
						         p_object_id VARCHAR2,
						         p_daytime DATE)
RETURN NUMBER;

FUNCTION getMeterFactor(p_result_no eqpm_result.result_no%TYPE,
						         p_object_id VARCHAR2,
						         p_daytime DATE)
RETURN NUMBER;

FUNCTION findGOR(p_result_no eqpm_result.result_no%TYPE,
						         p_object_id VARCHAR2,
						         p_daytime DATE)
RETURN NUMBER;

FUNCTION findGLR(p_result_no eqpm_result.result_no%TYPE,
						         p_object_id VARCHAR2,
						         p_daytime DATE)
RETURN NUMBER;

FUNCTION findCGR(p_result_no eqpm_result.result_no%TYPE,
						         p_object_id VARCHAR2,
						         p_daytime DATE)
RETURN NUMBER;

FUNCTION findWOR(p_result_no eqpm_result.result_no%TYPE,
						         p_object_id VARCHAR2,
						         p_daytime DATE)
RETURN NUMBER;

FUNCTION findWGR(p_result_no eqpm_result.result_no%TYPE,
						         p_object_id VARCHAR2,
						         p_daytime DATE)
RETURN NUMBER;

FUNCTION findBswVol(p_result_no eqpm_result.result_no%TYPE,
						         p_object_id VARCHAR2,
						         p_daytime DATE)
RETURN NUMBER;
