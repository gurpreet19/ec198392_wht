...
**
** Created  : 21.01.2000  Carl-Fredrik Sørensen
**
...
PRAGMA RESTRICT_REFERENCES (interpolateLinearBoundary, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES (findFunctionValueFromCurve, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES (interpolateLinear, WNDS, WNPS, RNPS);
...
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES (quadraticCurve, WNDS, WNPS, RNPS);
...
FUNCTION  getYFromXPolynom2(p_x NUMBER,
                            ...
                            p_c0 NUMBER)
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES (getYFromXPolynom2, WNDS, WNPS, RNPS);
...
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES (getYFromXPolynom2Inv, WNDS, WNPS, RNPS);
