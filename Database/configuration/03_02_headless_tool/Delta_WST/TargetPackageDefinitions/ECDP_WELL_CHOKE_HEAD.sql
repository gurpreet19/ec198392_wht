...
**
** Created  : 12.05.2000  Carl-Fredrik Sørensen
**
...
PRAGMA RESTRICT_REFERENCES (criticalOpening, WNDS, WNPS, RNPS);
...
FUNCTION FindMostRecentConfigDate(
        ...
        p_daytime DATE)
RETURN DATE ;
PRAGMA RESTRICT_REFERENCES (FindMostRecentConfigDate, WNDS, WNPS, RNPS);
...
FUNCTION FindMostRecentChokeCode(
  ...
  p_daytime DATE)
RETURN VARCHAR2;
PRAGMA RESTRICT_REFERENCES (FindMostRecentChokeCode, WNDS, WNPS, RNPS);
