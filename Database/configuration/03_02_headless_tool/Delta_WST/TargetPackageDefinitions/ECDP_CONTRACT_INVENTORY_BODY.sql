CREATE OR REPLACE PACKAGE BODY EcDp_Contract_Inventory IS
    ...
    ** 19.07.2012  sharawan     ECPD-21464: Add new function getAllocQty for GD.0047 : Monthly OBA Status screen
	** 25.07.2012  muhammah		ECPD-21464: Monthly OBA Status screen - Added new functions getAccumulatedBalDay and getAccumulatedBalMth
	** 25.09.2013  leeeewei		ECPD-25539: Added procedure checkTransSign
    ********************************************************************/
