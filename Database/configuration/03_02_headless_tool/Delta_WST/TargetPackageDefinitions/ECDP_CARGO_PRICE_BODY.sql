 ...
 WHERE object_id = p_object_id
   ...
   AND ppv.parcel_key = p_parcel_key;
    ...
    IF  (ln_inserted = 0)  THEN
      ...
      INSERT
      INTO     product_price_value (parcel_key,object_id,price_concept_code,price_element_code,daytime,calc_price_value,adj_price_value,comments,created_by)
      VALUES   (p_parcel_key, p_object_id,p_price_concept_code, c_val.price_element_code,p_daytime,lrec_pp_value.calc_price_value,lrec_pp_value.adj_price_value,lrec_pp_value.comments,lrec_pp_value.created_by);
    END IF;
