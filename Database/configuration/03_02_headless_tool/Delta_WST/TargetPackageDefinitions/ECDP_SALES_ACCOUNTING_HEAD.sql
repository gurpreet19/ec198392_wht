...
PRAGMA RESTRICT_REFERENCES(getNumberOfProcessedAccounts, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES(getNumberOfApprovedAccounts, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES(getAccountCalcOrder, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES(getHourlyOffSpecFraction, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES(getDailyOffSpecFraction, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES(isAccountEditable, WNDS, WNPS, RNPS);
