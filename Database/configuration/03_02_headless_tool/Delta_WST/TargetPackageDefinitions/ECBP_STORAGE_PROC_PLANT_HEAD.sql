...
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES(getStorageDayGrsTransactionVol, WNDS, WNPS, RNPS);

FUNCTION getStorageDayGrsSellVol (
    p_object_id storage.object_id%TYPE,
    p_daytime   DATE)
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES(getStorageDayGrsSellVol, WNDS, WNPS, RNPS);

FUNCTION getStorageDayGrsBuyVol (
    p_object_id storage.object_id%TYPE,
    p_daytime   DATE)
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES(getStorageDayGrsBuyVol, WNDS, WNPS, RNPS);

FUNCTION getStorageDayDiffVol (
    p_object_id storage.object_id%TYPE,
    p_daytime   DATE)
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES(getStorageDayDiffVol, WNDS, WNPS, RNPS);
...
FUNCTION getTotalTankVol (
    ...
    p_daytime   DATE)
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES(getTotalTankVol, WNDS, WNPS, RNPS);
...
FUNCTION getProdTransVol (
    ...
    p_trans_type VARCHAR2)
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES(getProdTransVol, WNDS, WNPS, RNPS);
...
FUNCTION getCompDayVol (
    ...
    p_daytime   DATE)
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES(getCompDayVol, WNDS, WNPS, RNPS);
...
FUNCTION getActualVolume(
   ...
   p_event_no NUMBER)
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES(getActualVolume, WNDS, WNPS, RNPS);
...
FUNCTION getTotalProdTransVol (
    ...
    p_trans_type VARCHAR2)
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES(getTotalProdTransVol, WNDS, WNPS, RNPS);
...
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES(getTotalProdGrsOpeningVol, WNDS, WNPS, RNPS);
...
FUNCTION getTotalProdGrsClosingVol(
    ...
    p_to_daytime DATE DEFAULT NULL)
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES(getTotalProdGrsClosingVol, WNDS, WNPS, RNPS);
...
FUNCTION calcBlendContentMass(
    ...
    p_event_no NUMBER)
RETURN NUMBER;
PRAGMA RESTRICT_REFERENCES(calcBlendContentMass, WNDS, WNPS, RNPS);
