...
-- Description    : This function aggregates record for a given well bore interval and
...
-- Description    : This function aggregates record for a given facility's well bore interval objects and
--                  production day using specified aggregation method and based on user access level vs record status.
--
-- Preconditions  :
-- Postcondition  :
