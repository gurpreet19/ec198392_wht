create or replace PACKAGE UE_CT_STREAM_FLUID is
/****************************************************************
...
FUNCTION evaluateFormula(p_formula_id VARCHAR2, p_formula VARCHAR2, p_daytime DATE, p_stream_id VARCHAR2 DEFAULT NULL) RETURN VARCHAR2;

FUNCTION getStreamFormulaStream(p_object_id VARCHAR2, p_daytime DATE, p_method VARCHAR2) RETURN VARCHAR2;
...
** 02.11.2018  KAJY      ISWR02794: Logic to handle first day of tank storage
*****************************************************************/
