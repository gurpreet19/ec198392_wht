create or replace PACKAGE UE_CT_WELL_EQPM_DOWNTIME IS
/***************************************************************
...
END;
/
create or replace PACKAGE BODY UE_CT_WELL_EQPM_DOWNTIME IS
/***************************************************************
** Package:                UE_WELL_EQPM_DOWNTIME
**
...
** 20080507 HNKO      Changed the package to point to the new deferment table deferment_event in 9.3
***************************************************************/
--<EC-DOC>
FUNCTION calcLossByDayFromChildren(p_event_no VARCHAR2,
                                   p_start_date  DATE,
...
BEGIN
  ...
  ELSE
   ...
   -- Handle different combinations of injectors/producers and phases
         ...
         THEN
            ln_retval := (ecbp_well_eqpm_deferment.geteventlossrate
                                          (p_event_no,
                                           'OIL'
                                          )) * ln_durationfrac;
