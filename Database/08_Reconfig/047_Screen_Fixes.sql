...
Insert into CLASS_ATTRIBUTE_CNFG (CLASS_NAME,ATTRIBUTE_NAME,APP_SPACE_CNTX,IS_KEY,DATA_TYPE,DB_MAPPING_TYPE,DB_SQL_SYNTAX) values ('TANK_DAY_INV_OIL','BSW_VOL','WST','N','NUMBER','COLUMN','BSW_VOL');
SET ESCAPE ON;
...
Insert into CLASS_ATTR_PROPERTY_CNFG (CLASS_NAME,ATTRIBUTE_NAME,PROPERTY_CODE,OWNER_CNTX,PRESENTATION_CNTX,PROPERTY_TYPE,PROPERTY_VALUE) values ('TANK_DAY_INV_OIL','BSW_VOL','DB_SORT_ORDER',2500,'/','VIEWLAYER',350);
...
Insert into CLASS_ATTR_PROPERTY_CNFG (CLASS_NAME,ATTRIBUTE_NAME,PROPERTY_CODE,OWNER_CNTX,PRESENTATION_CNTX,PROPERTY_TYPE,PROPERTY_VALUE) values ('TANK_DAY_INV_OIL','BSW_VOL','UOM_CODE',2500,'/','VIEWLAYER','BSW_VOL');
