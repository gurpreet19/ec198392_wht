create or replace 
PACKAGE Ue_Tank_Calculation IS
...
create or replace 
PACKAGE BODY Ue_Tank_Calculation IS
/****************************************************************
...
--  This conversion is being done on the tank measurement
    ...
    v_density_unit := ecdp_unit.getunitfromlogical(EC_CLASS_ATTR_PROPERTY_CNFG.property_value('TANK_OIL_BATCH_EXP_DET', 'CORR_DENSITY','UOM_CODE','VIEWLAYER',2500,'/'));
    v_target_mass_unit := ecdp_unit.getunitfromlogical(EC_CLASS_ATTR_PROPERTY_CNFG.property_value('TANK_OIL_BATCH_EXP_DET', 'STD_GRS_LIQ_MASS','UOM_CODE','VIEWLAYER',2500,'/'));
