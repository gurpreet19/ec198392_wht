 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:05/07/2019 06.55.32 AM
...
IS
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_STRM_EVENT.UTC_END_DATE      (
         P_OBJECT_ID,
         P_EVENT_TYPE,
         P_DAYTIME,
         P_COMPARE_OPER );
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_STRM_EVENT.UTC_DAYTIME      (
         P_OBJECT_ID,
         P_EVENT_TYPE,
         P_DAYTIME,
         P_COMPARE_OPER );
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_STRM_EVENT.END_DAY      (
         P_OBJECT_ID,
         P_EVENT_TYPE,
         P_DAYTIME,
         P_COMPARE_OPER );
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_STRM_EVENT TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:05/07/2019 06.56.58 AM
