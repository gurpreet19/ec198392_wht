 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:05/07/2019 05.11.33 AM
...
IS
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_WELL_TRANSPORT_EVENT.UTC_DAYTIME      (
         P_OBJECT_ID,
         P_EVENT_NO );
         RETURN ret_value;
   END UTC_DAYTIME;
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_WELL_TRANSPORT_EVENT TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:05/07/2019 05.11.50 AM
