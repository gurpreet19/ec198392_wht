 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:05/07/2019 09.23.33 AM
...
IS
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_HARBOUR_DUE_ITEMS.NEXT_DAYTIME      (
         P_DAYTIME,
         P_DUE_CODE,
         P_DUE_ITEM_CODE,
         P_NUM_ROWS );
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_HARBOUR_DUE_ITEMS.PREV_EQUAL_DAYTIME      (
         P_DAYTIME,
         P_DUE_CODE,
         P_DUE_ITEM_CODE,
         P_NUM_ROWS );
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_HARBOUR_DUE_ITEMS.NEXT_EQUAL_DAYTIME      (
         P_DAYTIME,
         P_DUE_CODE,
         P_DUE_ITEM_CODE,
         P_NUM_ROWS );
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_HARBOUR_DUE_ITEMS.PREV_DAYTIME      (
         P_DAYTIME,
         P_DUE_CODE,
         P_DUE_ITEM_CODE,
         P_NUM_ROWS );
   ...
   BEGIN
      ret_value := EC_HARBOUR_DUE_ITEMS.ROW_BY_REL_OPERATOR      (
         P_DAYTIME,
         P_DUE_CODE,
         P_DUE_ITEM_CODE,
         P_COMPARE_OPER );
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_HARBOUR_DUE_ITEMS TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:05/07/2019 09.23.41 AM
