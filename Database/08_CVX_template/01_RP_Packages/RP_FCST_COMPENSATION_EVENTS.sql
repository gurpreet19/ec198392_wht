 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:05/07/2019 10.12.07 AM
...
IS
   ...
   IS
      ret_value   VARCHAR2 (32) ;
   BEGIN
      ret_value := EC_FCST_COMPENSATION_EVENTS.SCENARIO_ID      (
         P_EVENT_NO );
         RETURN ret_value;
   END SCENARIO_ID;
   FUNCTION VALUE_13(
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_FCST_COMPENSATION_EVENTS TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:05/07/2019 10.12.22 AM
