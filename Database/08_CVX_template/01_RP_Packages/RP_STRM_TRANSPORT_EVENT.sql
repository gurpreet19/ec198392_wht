 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:05/07/2019 06.19.20 AM
...
IS
   ...
   IS
      ret_value    DATE ;
   BEGIN
      ret_value := EC_STRM_TRANSPORT_EVENT.UTC_DAYTIME      (
         P_EVENT_NO );
         RETURN ret_value;
   END UTC_DAYTIME;
   FUNCTION VALUE_6(
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_STRM_TRANSPORT_EVENT TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:05/07/2019 06.20.08 AM
