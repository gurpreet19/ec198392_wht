 ...
 -- START PKG_GEN_PKGS.sf_get_functions at:05/07/2019 09.36.45 AM
...
IS
   ...
   IS
      ret_value   VARCHAR2 (32) ;
   BEGIN
      ret_value := EC_FCST_WELL_EVENT.SCENARIO_ID      (
         P_EVENT_NO );
         RETURN ret_value;
   END SCENARIO_ID;
   FUNCTION STEAM_INJ_LOSS_VOLUME(
...
--GRANT EXECUTE ON ECKERNEL_WST.RP_FCST_WELL_EVENT TO REPORT_ROLE_XXX;
 ...
 -- FINISH PKG_GEN_PKGS.sf_get_functions at:05/07/2019 09.37.01 AM
