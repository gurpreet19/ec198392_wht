...
FUNCTION findParentObjectId(p_find_item_type VARCHAR2,
                            ...
                            p_item_id objects.object_id%TYPE,
                            p_daytime DATE)
RETURN objects.object_id%TYPE
--</EC-DOC>
IS

   CURSOR c_parents (p_group VARCHAR2,p_item VARCHAR2,p_id objects.object_id%TYPE,p_daytime DATE) IS
   ...
   ln_parent_id objects.object_id%TYPE;
