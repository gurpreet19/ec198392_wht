...
PRAGMA RESTRICT_REFERENCES (getWellPerformanceCurveId, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES (getNextWellPerformanceCurveId, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES (getPrevWellPerformanceCurveId, WNDS, WNPS, RNPS);
--
...
PRAGMA RESTRICT_REFERENCES (getStdRateFromParamValue, WNDS, WNPS, RNPS);
...
PRAGMA RESTRICT_REFERENCES (getCurveIdPhase, WNDS, WNPS, RNPS);
