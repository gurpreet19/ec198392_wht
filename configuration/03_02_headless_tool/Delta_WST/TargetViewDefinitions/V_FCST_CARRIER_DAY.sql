CREATE OR REPLACE FORCE VIEW "V_FCST_CARRIER_DAY" ("DAYTIME", "CLASS_NAME", "FORECAST_ID", "OBJECT_CODE", "OBJECT_ID", "CARRIER_CODE", "PRODUCT_GROUP", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT", "APPROVAL_BY", "APPROVAL_DATE", "APPROVAL_STATE", "REC_ID", "RECORD_STATUS") AS 
  (
/**************************************************************
