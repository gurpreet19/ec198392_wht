CREATE OR REPLACE FORCE VIEW "V_FCST_CARGO_PLAN_NAVIGATOR" ("CARGO_NO", "CARGO_NAME", "FORECAST_ID", "OBJECT_ID", "DELETED_IND", "CARGO_STATUS", "CARRIER_ID", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
/**************************************************************
