CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_DOCUMENT_INSTR_TEMPLATE" ("LA_CPY_ID", "TEMPLATE_CODE", "TEMPLATE_NAME", "DEFAULT_IND", "CARGO_DOC_TEMPLATE_CODE", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
----------------------------------------------------------------------------------------------------
...
-- ---------- ----      --------------------------------------------------------------------------------
--22 Nov 2012 muhammah	ECPD-21877: Document Instruction Template without relation to Lifting Account
----------------------------------------------------------------------------------------------------
select
