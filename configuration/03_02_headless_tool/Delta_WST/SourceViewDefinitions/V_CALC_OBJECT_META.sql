CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_CALC_OBJECT_META" ("CLASS_NAME", "CLASS_TYPE", "OBJECT_TYPE", "DATA_TYPE", "SOURCE_NAME", "DATE_HANDLING_PROPS", "TIME_SCOPE_CODE", "CALC_CONTEXT_ID", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT") AS 
  (
------------------------------------------------------------------------------------
--  v_calc_object_meta
--
...
select
    ...
    cot.record_status,
   	...
   	cot.REV_NO,
   	cot.REV_TEXT
from calc_object_type cot, class_cnfg c
