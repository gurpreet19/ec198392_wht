CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_STRM_DAY_DATA" ("OBJECT_ID", "OBJECT_CODE", "DAYTIME", "ON_STREAM_HRS", "GRS_MASS", "GRS_VOL", "GRS_VOL_M3", "NET_MASS", "NET_VOL", "NET_VOL_M3", "WATER_MASS", "WATER_VOL", "WATER_VOL_M3", "AVG_TEMP", "AVG_PRESS", "MIN_PRESS", "AVG_PL_PRESS", "DENSITY", "DENSITY_KGM3", "AVG_DIFF_PRESS", "RUN_SIZE", "ENERGY", "ENERGY_2", "ENERGY_CONTENT", "BS_W", "BS_W_WT", "WATER_WT", "H2S", "H2S_2", "CO2", "SALT", "SALT_MASS", "RVP", "TVP", "WDP", "GCV", "TOTALIZER", "SP_GRAV", "BOTTOM_STRIP_TEMP", "K_FACTOR", "ORIFICE_SIZE", "AVG_RATE_HR", "STEAM_QUALITY", "POWER_CONSUMPTION", "EGM_IND", "TOTALIZER_RESET_IND", "METER_PROVED_IND", "COMMENTS", "SALT_WT", "THEOR_GRS_MASS", "VALUE_1", "VALUE_2", "VALUE_3", "VALUE_4", "VALUE_5", "VALUE_6", "VALUE_7", "VALUE_8", "VALUE_9", "VALUE_10", "TEXT_1", "TEXT_2", "TEXT_3", "TEXT_4", "RECORD_STATUS", "CREATED_BY", "CREATED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REV_NO", "REV_TEXT", "APPROVAL_BY", "APPROVAL_DATE", "APPROVAL_STATE", "REC_ID") AS 
  (
 SELECT s.OBJECT_ID AS OBJECT_ID,
  ...
  WHERE STRM_DAY_STREAM.object_id = oa.object_id
	...
	AND (NVL(oa.alloc_data_freq,'DAY') = 'DAY' and oa.stream_type = 'M' and (oa.strm_meter_freq='DAY' OR oa.AGGREGATE_FLAG='Y'))
)