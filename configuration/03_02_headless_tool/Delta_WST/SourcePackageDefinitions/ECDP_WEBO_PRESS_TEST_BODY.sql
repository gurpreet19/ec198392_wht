...
** 08.10.2014   sohalran   ECPD-27402: Remove Commit statement from assignNextGradientSeq procedure.
   ...
   where a.event_no =
         (select a.event_no
           ...
           where a.object_id = p_object_id
             and a.press_type = p_press_type
             and a.daytime =
                 (select max(b.daytime)
                    from webo_press_test b
                   where b.object_id = p_object_id and b.press_type = p_press_type and b.event_no != p_event_no and b.daytime < p_daytime));
