...
--
FUNCTION agaStaticPress(p_result_no test_device_result.result_no%TYPE, p_object_id VARCHAR2, p_phase VARCHAR2)
RETURN NUMBER;

--
FUNCTION agaDiffPress(p_result_no test_device_result.result_no%TYPE, p_object_id VARCHAR2, p_phase VARCHAR2)
RETURN NUMBER;
